...
GO
SELECT
	[SKU], [Product Description], [Discontinued/Phase Out Product  or  Replacement SKU?]
INTO #temp
FROM (VALUES
('02-03-06-003', 'Maxxam Intensive Conditioning Unifier 6oz. ', 'Discontinued Product'),
...
('06-05-33-001/', 'Maxx Polyfuse+ 33oz. ', 'Discontinued SKU'))
[vdata] ([SKU], [Product Description], [Discontinued/Phase Out Product  or  Replacement SKU?])
