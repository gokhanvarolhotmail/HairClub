...
SELECT DISTINCT
     ...
     , NULL AS [DNIS]
     , NULL AS [Referrer]
     , NULL AS [ReferralFlag]
     , NULL AS [DWH_LoadDate]
     , NULL AS [DWH_LastUpdateDate]
     , NULL AS [IsActive]
     , NULL AS [SourceSystem]
     , NULL AS [CampaignDeviceType]
     , NULL AS [CampaignDNIS]
     , NULL AS [CampaignTactic]
     , NULL AS [CampaignPromoDescription]
     , NULL AS [SourceCode]
     , NULL AS [TollFreeName]
     , NULL AS [TollFreeMobileName]
     , NULL AS [TollFreeNumber]
     , NULL AS [ExternalID]
     , NULL AS [IsDeleted]
INTO [#DimCampaign]
FROM [DimCampaign]
