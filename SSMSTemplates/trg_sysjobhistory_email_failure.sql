...
IF @@ROWCOUNT = 1
    BEGIN
        -- SET @email_address = CASE WHEN @email_address LIKE '%@%' THEN @email_address ELSE 'gvarol@hairclub.com;MKunchum@hairclub.com' END ;
		SET @email_address = 'gvarol@hairclub.com;MKunchum@hairclub.com' 
