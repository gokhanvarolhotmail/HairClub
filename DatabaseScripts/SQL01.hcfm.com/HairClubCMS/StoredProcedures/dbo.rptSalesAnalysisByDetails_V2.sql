/* CreateDate: 03/15/2022 12:27:45.757 , ModifyDate: 03/15/2022 12:29:16.527 */
GO
/*
==============================================================================
...
IF @GenderID = 0
    BEGIN
        ...
        SELECT
          ...
          , CASE WHEN [sc].[SalesCodeDescriptionShort] = '100' THEN ISNULL([sod].[GenericSalesCodeDescription], 'Retail Product Generic')ELSE [sc].[SalesCodeDescription] END AS [SalesCodeDescription]
