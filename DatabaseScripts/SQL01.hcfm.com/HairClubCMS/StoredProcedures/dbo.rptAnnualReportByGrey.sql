/* CreateDate: 04/24/2012 13:04:17.220 , ModifyDate: 02/27/2017 09:49:25.017 */
GO
/*
==============================================================================
PROCEDURE:				[rptAnnualReportByGrey]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [rptAnnualReportByGrey] '9/1/09', '9/16/09'
==============================================================================
*/

CREATE PROCEDURE [dbo].[rptAnnualReportByGrey]
	@StartDate DATETIME
,	@EndDate DATETIME
AS
BEGIN
