/* CreateDate: 10/05/2015 14:25:32.780 , ModifyDate: 12/07/2018 09:45:40.033 */
GO
/*===============================================================================================
 Procedure Name:            rptTVProgressReviewAudit
 Procedure Description:     This stored procedure provides client information such as Last Visit,
								...
								appointment where progress reviews were due.
...
================================================================================================
Change History:
11/12/2015 - RH - Added CREATE TABLE #Final for the UPDATE statement that follows.  This was causing a datatype error occasionally. (#120312)
01/27/2016 - RH - Changed to reflect only the prior day's appointments where progress reviews were due
08/16/2017 - RH - Changed to use one center per the parameter; Pull ONLY EXT
10/12/2017 - RH - Changed to use the logic from the [rptTVProgressReviewAuditByDate] (#143342)
12/06/2018 - RH - Removed Haircuts, color or checkup appointments (Case 6238)
================================================================================================
Sample Execution:

EXEC [rptTVProgressReviewAudit] 805
================================================================================================*/

CREATE PROCEDURE [dbo].[rptTVProgressReviewAudit](
	@CenterID INT
)
AS
BEGIN
...
WHERE AP.CenterID = @CenterID
	...
	AND CLT.ClientFullNameCalc NOT LIKE 'Lunch%'
	AND CLT.ClientFullNameCalc NOT LIKE 'Off%'
