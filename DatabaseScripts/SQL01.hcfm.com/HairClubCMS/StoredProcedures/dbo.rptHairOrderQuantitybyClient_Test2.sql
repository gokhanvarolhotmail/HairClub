/* CreateDate: 02/03/2022 15:47:49.147 , ModifyDate: 02/03/2022 15:47:49.147 */
GO
/*===============================================================================================
...
================================================================================================
*/
CREATE PROCEDURE [dbo].[rptHairOrderQuantitybyClient_Test2]
(
    @CenterID INT,
...
BEGIN
    ...
    select tmpData.*, gms.membershipGroup, ABS(round(( (CAST(tmpData.InitialQuantity AS float) / 12.0)*8.0)-(tmpData.QaNeeded+ tmpData.InCenter + tmpData.OnOrder),0))
          /** case
