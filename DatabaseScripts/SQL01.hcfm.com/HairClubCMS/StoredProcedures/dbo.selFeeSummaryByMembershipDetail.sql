/* CreateDate: 05/14/2012 17:40:58.023 , ModifyDate: 03/16/2021 09:44:16.303 */
GO
/***********************************************************************

PROCEDURE:				selFeeSummaryByMembershipDetail
...
NOTES: 	Return EFT summary by Membership for the specified Pay Cycle, Month, Year, and Center for the specified month.
		...
		04/02/3019 - JLM: Update the logic for add-on amount. (TFS #12202)
...
selFeeSummaryByMembershipDetail 2, 02, 2019, 201

***********************************************************************/
CREATE PROCEDURE [dbo].[selFeeSummaryByMembershipDetail]
...
BEGIN
	...
	INSERT INTO @ClientEFTStatus (ClientEFTGUID, Amount, AddOnAmount, FreezeStartDate, FreezeEndDate, AccountExpirationDate, MembershipBeginDate, MembershipEndDate, MembershipID,
					 MembershipDescription, IsProfileExpired, IsProfileFrozen, IsCreditCardExpired, IsMembershipExpired, IsFeeAmountZero, IsAutoRenew)
		SELECT
			c.ClientEFTGUID,
