/* CreateDate: 03/10/2022 12:41:35.977 , ModifyDate: 03/10/2022 12:41:35.977 */
GO
/***********************************************************************

PROCEDURE: 	[vw_datSalesOrderDetailv2]
...
-------------------------------------------------------------------------------------------------------------
***********************************************************************/
CREATE VIEW [dbo].[vw_datSalesOrderDetailv2]
AS
...
FROM    [datSalesOrder] with (NOLOCK)
        INNER JOIN [cfgCenter] with (NOLOCK)
