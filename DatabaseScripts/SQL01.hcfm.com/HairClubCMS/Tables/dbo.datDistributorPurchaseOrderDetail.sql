...
GO
ALTER TABLE [dbo].[datDistributorPurchaseOrderDetail]  WITH CHECK ADD  CONSTRAINT [FK_datDistributorPurchaseOrderDetail_cfgSalesCodeDistributor] FOREIGN KEY([SalesCodeDistributorID])
...
GO
ALTER TABLE [dbo].[datDistributorPurchaseOrderDetail]  WITH CHECK ADD  CONSTRAINT [FK_datDistributorPurchaseOrderDetail_datDistributorPurchaseOrder] FOREIGN KEY([DistributorPurchaseOrderID])
...
GO
ALTER TABLE [dbo].[datDistributorPurchaseOrderDetail]  WITH CHECK ADD  CONSTRAINT [FK_datDistributorPurchaseOrderDetail_lkpUnitOfMeasure] FOREIGN KEY([UnitOfMeasureID])
