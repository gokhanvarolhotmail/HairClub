...
GO
ALTER TABLE [dbo].[datNonSerializedInventoryAuditBatch]  WITH NOCHECK ADD  CONSTRAINT [FK_datNonSerializedInventoryAuditBatch_cfgCenter] FOREIGN KEY([CenterID])
...
GO
ALTER TABLE [dbo].[datNonSerializedInventoryAuditBatch]  WITH NOCHECK ADD  CONSTRAINT [FK_datNonSerializedInventoryAuditBatch_datEmployee_CompletedByEmployee] FOREIGN KEY([CompletedByEmployeeGUID])
...
GO
ALTER TABLE [dbo].[datNonSerializedInventoryAuditBatch]  WITH NOCHECK ADD  CONSTRAINT [FK_datNonSerializedInventoryAuditBatch_datEmployee_ReviewedByEmployee] FOREIGN KEY([ReviewCompletedByEmployeeGUID])
REFERENCES [dbo].[datEmployee] ([EmployeeGUID])
GO
...
GO
ALTER TABLE [dbo].[datNonSerializedInventoryAuditBatch]  WITH NOCHECK ADD  CONSTRAINT [FK_datNonSerializedInventoryAuditBatch_datNonSerializedInventoryAuditSnapshot] FOREIGN KEY([NonSerializedInventoryAuditSnapshotID])
...
GO
ALTER TABLE [dbo].[datNonSerializedInventoryAuditBatch]  WITH NOCHECK ADD  CONSTRAINT [FK_datNonSerializedInventoryAuditBatch_lkpInventoryAuditBatchStatus] FOREIGN KEY([InventoryAuditBatchStatusID])
