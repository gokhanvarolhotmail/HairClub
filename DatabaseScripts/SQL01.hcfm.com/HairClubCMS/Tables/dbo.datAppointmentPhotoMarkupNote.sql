...
GO
ALTER TABLE [dbo].[datAppointmentPhotoMarkupNote]  WITH CHECK ADD  CONSTRAINT [FK_datAppointmentPhotoMarkupNote_datAppointmentPhotoMarkup] FOREIGN KEY([AppointmentPhotoMarkupID])
...
GO
ALTER TABLE [dbo].[datAppointmentPhotoMarkupNote]  WITH CHECK ADD  CONSTRAINT [FK_datAppointmentPhotoMarkupNote_lkpFlakingLevel] FOREIGN KEY([FlakingLevelID])
...
GO
ALTER TABLE [dbo].[datAppointmentPhotoMarkupNote]  WITH CHECK ADD  CONSTRAINT [FK_datAppointmentPhotoMarkupNote_lkpSebumLevel] FOREIGN KEY([SebumLevelID])
...
GO
ALTER TABLE [dbo].[datAppointmentPhotoMarkupNote]  WITH CHECK ADD  CONSTRAINT [FK_datAppointmentPhotoMarkupNote_lkpSorenessLevel] FOREIGN KEY([SorenessLevelID])
