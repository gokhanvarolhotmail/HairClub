/* CreateDate: 04/14/2009 07:33:55.273 , ModifyDate: 05/26/2020 10:49:40.313 */
GO
...
GO
ALTER TABLE [dbo].[cfgSecurityGroup]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgSecurityGroup_lkpEmployeePosition] FOREIGN KEY([EmployeePositionID])
...
GO
ALTER TABLE [dbo].[cfgSecurityGroup]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgSecurityGroup_lkpSecurityElement] FOREIGN KEY([SecurityElementID])
