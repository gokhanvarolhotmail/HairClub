/* CreateDate: 08/10/2019 06:47:45.000 , ModifyDate: 08/10/2019 06:47:45.000 */
GO
/***********************************************************************
PROCEDURE:				spSvc_STY_MDPSales_Step03_ValidateDetails
DESTINATION SERVER:		SQL06
DESTINATION DATABASE:	HC_Commission
AUTHOR:					Dominic Leiba
IMPLEMENTOR:			Dominic Leiba
DATE IMPLEMENTED:		3/23/2019
DESCRIPTION:			Used to validate the commission detail records for MP MDP Services
------------------------------------------------------------------------
NOTES:
...
EXEC spSvc_MP_MDPService_Step03_ValidateDetails
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_MP_MDPService_Step03_ValidateDetails]
AS
BEGIN
