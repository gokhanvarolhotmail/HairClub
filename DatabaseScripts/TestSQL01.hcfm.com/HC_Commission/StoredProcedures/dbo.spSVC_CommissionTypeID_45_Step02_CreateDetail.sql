/* CreateDate: 10/07/2016 14:36:08.873 , ModifyDate: 02/24/2017 08:52:17.323 */
GO
/***********************************************************************
PROCEDURE:				spSVC_CommissionTypeID_45_Step02_CreateDetail
...
EXEC spSVC_CommissionTypeID_45_Step02_CreateDetail
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_45_Step02_CreateDetail]
AS
BEGIN
...
INSERT  INTO #Details (
		...
		WHERE   ( FST.NB_ExtCnt > 0 OR FST.NB_ExtAmt <> 0 OR SC.SalesCodeKey IN ( 387, 469, 637, 638, 1685, 1731, 1804, 1805, 1822, 1823 ) OR FST.NB_BIOConvCnt <> 0 )
