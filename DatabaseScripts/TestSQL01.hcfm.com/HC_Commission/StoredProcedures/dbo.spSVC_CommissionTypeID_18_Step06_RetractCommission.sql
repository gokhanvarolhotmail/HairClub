/* CreateDate: 11/01/2012 16:33:34.127 , ModifyDate: 02/15/2013 16:11:16.923 */
GO
/*
==============================================================================

PROCEDURE:				[spSVC_CommissionTypeID_18_Step06_RetractCommission]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_18_Step06_RetractCommission]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_18_Step06_RetractCommission] AS
BEGIN
	SET NOCOUNT ON
	...
	BEGIN
		...
		SET @CurrentMembershipCommission = CASE WHEN @CurrentMembershipCommission = 25 THEN 0 ELSE @CurrentMembershipCommission END
