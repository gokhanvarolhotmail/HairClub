/* CreateDate: 02/10/2020 12:02:29.493 , ModifyDate: 02/17/2020 07:38:48.147 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
PROCEDURE:				spSvc_IC_HaloSales_Step03_CalculateCommission
DESTINATION SERVER:		SQL06
DESTINATION DATABASE:	HC_Commission
AUTHOR:					Dominic Leiba
IMPLEMENTOR:			Dominic Leiba
DATE IMPLEMENTED:		3/23/2019
DESCRIPTION:			Used to calculate commissions for IC Halo Sales
------------------------------------------------------------------------
NOTES:
...
EXEC spSvc_IC_HaloSales_Step03_CalculateCommission
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_IC_HaloSales_Step03_CalculateCommission]
AS
BEGIN
...
/********************************** Get Total Payments associated with Halo sale *************************************/
INSERT	INTO #Payments
		...
		WHERE   sc.SalesCodeDescriptionShort IN ( 'HALO2LINES', 'HALO5LINES', 'HALO20' )
