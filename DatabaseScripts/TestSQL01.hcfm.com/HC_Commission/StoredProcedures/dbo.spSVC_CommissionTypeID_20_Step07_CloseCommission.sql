/* CreateDate: 11/02/2012 10:18:15.620 , ModifyDate: 03/16/2017 16:34:33.757 */
GO
SET ANSI_NULLS ON
GO
...
PROCEDURE:				[spSVC_CommissionTypeID_20_Step07_CloseCommission]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_20_Step07_CloseCommission]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_20_Step07_CloseCommission] AS
BEGIN
	SET NOCOUNT ON
	...
	WHERE FCH.CommissionTypeID = @CommissionTypeID
		...
		AND FCD.SalesCodeKey IN (600, 601, 1733)
		AND FCH.IsClosed = 0
