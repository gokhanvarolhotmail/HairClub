/* CreateDate: 10/29/2012 15:09:19.513 , ModifyDate: 02/18/2013 16:33:21.083 */
GO
SET ANSI_NULLS ON
GO
...
PROCEDURE:				[spSVC_CommissionTypeID_07_Step08_TerminatedEmployee]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_07_Step08_TerminatedEmployee]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_07_Step08_TerminatedEmployee] AS
BEGIN
	SET NOCOUNT ON
