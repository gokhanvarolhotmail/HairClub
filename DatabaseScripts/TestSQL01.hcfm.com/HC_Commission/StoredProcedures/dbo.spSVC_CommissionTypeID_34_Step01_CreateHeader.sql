/* CreateDate: 11/21/2014 09:06:37.593 , ModifyDate: 10/24/2019 14:01:58.220 */
GO
/***********************************************************************
PROCEDURE:				spSVC_CommissionTypeID_34_Step01_CreateHeader
...
EXEC spSVC_CommissionTypeID_34_Step01_CreateHeader
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_34_Step01_CreateHeader]
AS
BEGIN
...
INSERT  INTO #Header (
        ...
        WHERE   C.CenterTypeKey = 2
                ...
                AND SC.SalesCodeDescriptionShort IN ( 'MEMPMT', 'POSTEXTPMT', 'POSTEXTPMTUS' )
