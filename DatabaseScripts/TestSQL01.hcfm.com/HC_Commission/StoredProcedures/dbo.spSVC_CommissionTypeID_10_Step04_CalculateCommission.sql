/* CreateDate: 10/30/2012 15:19:54.607 , ModifyDate: 07/24/2017 15:10:56.450 */
GO
/*
==============================================================================

PROCEDURE:				[spSVC_CommissionTypeID_10_Step04_CalculateCommission]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_10_Step04_CalculateCommission]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_10_Step04_CalculateCommission] AS
BEGIN
	SET NOCOUNT ON
	...
	BEGIN
		...
		IF @CurrentConversionRenewDate IS NOT NULL
			BEGIN
				...
				SET CalculatedCommission = CASE WHEN @CurrentMembershipKey IN ( 132, 133 ) THEN 75 ELSE 50 END
				,	UpdateDate = GETDATE()
