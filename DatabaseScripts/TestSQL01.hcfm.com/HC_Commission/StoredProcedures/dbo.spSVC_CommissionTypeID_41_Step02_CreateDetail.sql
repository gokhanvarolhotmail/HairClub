/* CreateDate: 10/08/2015 11:09:10.610 , ModifyDate: 10/08/2015 12:21:42.633 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
PROCEDURE:				spSVC_CommissionTypeID_41_Step02_CreateDetail
...
EXEC spSVC_CommissionTypeID_41_Step02_CreateDetail
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_41_Step02_CreateDetail]
AS
BEGIN
...
INSERT  INTO #Details (
        ...
        WHERE   DD.FullDate BETWEEN @TransactionStartDate AND @TransactionEndDate
				...
				AND ( FST.NB_XTRCnt >= 1 OR SC.SalesCodeKey = 1724 )
