/* CreateDate: 10/07/2016 14:36:03.587 , ModifyDate: 02/23/2017 14:12:24.250 */
GO
/***********************************************************************
PROCEDURE:				spSVC_CommissionTypeID_45_Step03_ValidateDetails
...
EXEC spSVC_CommissionTypeID_45_Step03_ValidateDetails
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_45_Step03_ValidateDetails]
AS
BEGIN
...
WHILE @CurrentCount <= @TotalCount
      BEGIN
            ...
            FROM    FactCommissionDetail
            WHERE   CommissionHeaderKey = @CommissionHeaderKey
                    AND SalesCodeKey IN ( 622, 387, 627, 1734, 1756 )
            ...
            WHILE @CurrentDetailsCount <= @TotalDetailsCount
                  BEGIN
						...
						------------------------------------------------------------------------------------------
                        IF @CurrentDetailsSalesCodeKey IN ( 469, 637, 638, 1685, 1731, 1804, 1805, 1822, 1823 )
						...
						------------------------------------------------------------------------------------------
                        IF @CurrentDetailsSalesCodeKey IN ( 387, 1734 )
                        ...
                        WHERE   CommissionDetailKey = @CommissionDetailKey
                                ...
                                AND @CurrentDetailsSalesCodeKey IN ( 469, 637, 638, 1685, 1731, 1804, 1805, 1822, 1823 )
                                AND @CurrentIsRefund = 1
                                AND @CurrentDetailsOrderDateDate > @InitialServiceDate
