/* CreateDate: 07/26/2016 16:12:31.833 , ModifyDate: 04/07/2017 10:02:16.250 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
PROCEDURE:				spSVC_CommissionTypeID_42_Step02_CreateDetail
...
EXEC spSVC_CommissionTypeID_42_Step02_CreateDetail
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_42_Step02_CreateDetail]
AS
BEGIN
...
INSERT  INTO #Details (
        ...
        FROM    HC_BI_CMS_DDS.bi_cms_dds.FactSalesTransaction FST
                ...
                INNER JOIN HC_BI_CMS_DDS.bi_cms_dds.DimClientMembership CM
                    ON CM.ClientMembershipKey = FST.ClientMembershipKey
        ...
        WHERE   SC.SalesCodeDescriptionShort IN ( 'NB1A', 'APP', 'APPSOL' )
