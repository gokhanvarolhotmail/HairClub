/* CreateDate: 10/04/2012 15:27:42.050 , ModifyDate: 08/12/2019 14:10:24.613 */
GO
/*
==============================================================================

PROCEDURE:				[spSVC_CommissionTypeID_13_Step01_CreateHeader]
...
05/08/2014 - DL - Joined on DimSalesOrder instead of on FactSalesTransactions for the ClientMembershipKey
09/02/2014 - DL - Changed join on DimSalesOrder to use SalesOrderKey instead of ClientMembershipKey
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_13_Step01_CreateHeader]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_13_Step01_CreateHeader] AS
BEGIN
	SET NOCOUNT ON
