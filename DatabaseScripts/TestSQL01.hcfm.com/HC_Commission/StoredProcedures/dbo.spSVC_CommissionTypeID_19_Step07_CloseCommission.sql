/* CreateDate: 11/01/2012 16:38:28.643 , ModifyDate: 01/17/2013 17:06:28.013 */
GO
SET ANSI_NULLS ON
GO
...
PROCEDURE:				[spSVC_CommissionTypeID_19_Step07_CloseCommission]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_19_Step07_CloseCommission]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_19_Step07_CloseCommission] AS
BEGIN
	SET NOCOUNT ON
