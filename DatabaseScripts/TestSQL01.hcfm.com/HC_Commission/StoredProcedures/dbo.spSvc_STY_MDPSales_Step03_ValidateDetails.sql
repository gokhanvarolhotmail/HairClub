/* CreateDate: 07/30/2019 10:11:16.037 , ModifyDate: 07/30/2019 10:11:16.037 */
GO
SET ANSI_NULLS ON
GO
...
DESCRIPTION:			Used to validate the commission detail records for STY MDP Sales
------------------------------------------------------------------------
NOTES:
...
EXEC spSvc_STY_MDPSales_Step03_ValidateDetails
***********************************************************************/
CREATE PROCEDURE [dbo].spSvc_STY_MDPSales_Step03_ValidateDetails
AS
BEGIN
