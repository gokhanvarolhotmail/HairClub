...
DESCRIPTION:			Used to generate a commission detail record for IC Laser Sales
------------------------------------------------------------------------
NOTES:
...
EXEC spSvc_IC_LaserSales_Step02_CreateDetail
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_IC_LaserSales_Step02_CreateDetail]
AS
BEGIN
