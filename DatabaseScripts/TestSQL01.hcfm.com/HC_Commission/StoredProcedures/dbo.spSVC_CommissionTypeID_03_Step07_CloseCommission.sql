/* CreateDate: 10/23/2012 16:26:17.160 , ModifyDate: 09/02/2014 16:28:57.770 */
GO
SET ANSI_NULLS ON
GO
...
PROCEDURE:				[spSVC_CommissionTypeID_03_Step07_CloseCommission]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_03_Step07_CloseCommission]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_03_Step07_CloseCommission] AS
BEGIN
	SET NOCOUNT ON
	...
	WHERE FCH.CommissionTypeID = @CommissionTypeID
		...
		AND FCD.SalesCodeKey IN (507, 622, 387, 627)
		AND FCH.IsClosed = 0
