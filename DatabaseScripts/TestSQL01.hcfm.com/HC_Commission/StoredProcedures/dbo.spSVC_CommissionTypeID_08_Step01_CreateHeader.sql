/* CreateDate: 10/04/2012 11:34:15.487 , ModifyDate: 10/24/2019 13:49:28.200 */
GO
SET ANSI_NULLS ON
GO
...
PROCEDURE:				[spSVC_CommissionTypeID_08_CreateHeader]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_08_CreateHeader]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_08_Step01_CreateHeader] AS
BEGIN
	SET NOCOUNT ON
	...
	WHERE C.CenterTypeKey=2
		...
		AND m.MembershipDescriptionShort NOT IN ( 'CRYSTL', 'CRYSTLPLUS', 'XTRANDMEM', 'XTDMEMSOL', 'XTDMEM1000', 'XTDMSO1000', 'EMPLOYEE', 'EMPLOYEXT', 'EMPLOYXTR', 'EMPLOYMDP' )
