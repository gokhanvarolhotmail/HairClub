/* CreateDate: 10/07/2016 14:35:48.937 , ModifyDate: 02/23/2017 14:12:49.930 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
PROCEDURE:				spSVC_CommissionTypeID_45_Step06_RetractCommission
...
EXEC spSVC_CommissionTypeID_45_Step06_RetractCommission
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_45_Step06_RetractCommission]
AS
BEGIN
...
DECLARE @EXTBeforeSvcPercentage NUMERIC(3, 2)
,       @EXTAfterSvcPercentage NUMERIC(3, 2)
,       @EXTPercentageLow NUMERIC(3, 2)
