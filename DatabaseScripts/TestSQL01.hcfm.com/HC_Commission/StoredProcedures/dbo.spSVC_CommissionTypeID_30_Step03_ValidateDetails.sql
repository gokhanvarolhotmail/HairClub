/* CreateDate: 05/05/2014 17:19:16.200 , ModifyDate: 05/08/2020 14:43:58.643 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
PROCEDURE:				spSVC_CommissionTypeID_30_Step03_ValidateDetails
...
EXEC spSVC_CommissionTypeID_30_Step03_ValidateDetails
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_30_Step03_ValidateDetails]
AS
BEGIN
      ...
      BEGIN
            ...
            WHILE @CurrentDetailsCount <= @TotalDetailsCount
                  BEGIN
						...
						------------------------------------------------------------------------------------------
                        IF @CurrentDetailsSalesCodeKey IN ( 469, 1683, 1684, 1685, 1729, 637, 638, 1731, 1804, 1805 )
                        ...
                        WHERE   CommissionDetailKey = @CommissionDetailKey
                                ...
                                AND @CurrentDetailsSalesCodeKey IN ( 469, 1683, 1684, 1685, 1729, 637, 638, 1731, 1804, 1805 )
                                AND @CurrentIsRefund = 1
                                AND @CurrentDetailsOrderDateDate > @CurrentInitialServiceDate
