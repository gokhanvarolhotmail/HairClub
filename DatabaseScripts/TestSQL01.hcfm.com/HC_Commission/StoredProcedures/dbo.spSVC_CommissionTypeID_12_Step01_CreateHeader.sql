/* CreateDate: 10/04/2012 15:25:47.797 , ModifyDate: 10/24/2019 13:53:06.927 */
GO
SET ANSI_NULLS ON
GO
...
PROCEDURE:				[spSVC_CommissionTypeID_12_Step01_CreateHeader]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_12_Step01_CreateHeader]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_12_Step01_CreateHeader] AS
BEGIN
	SET NOCOUNT ON
	...
	WHERE C.CenterTypeKey=2
		...
		AND SC.SalesCodeDepartmentSSID IN ( 5035 )
		AND ( M.BusinessSegmentKey IN ( 3 ) OR M.MembershipSSID IN ( 14, 70, 71, 75, 76 ) )
