/* CreateDate: 02/10/2020 12:19:09.223 , ModifyDate: 03/17/2021 09:20:07.373 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
PROCEDURE:				spSvc_IC_HaloSales_Step05_RetractCommission
DESTINATION SERVER:		SQL06
DESTINATION DATABASE:	HC_Commission
AUTHOR:					Dominic Leiba
IMPLEMENTOR:			Dominic Leiba
DATE IMPLEMENTED:		3/23/2019
DESCRIPTION:			Used to retract commissions for IC Halo Sales
------------------------------------------------------------------------
NOTES:

08/27/2020	KMurdoch	Added index on Open Commissions for SalesOrderDetailSSID
------------------------------------------------------------------------
SAMPLE EXECUTION:

EXEC spSvc_IC_HaloSales_Step05_RetractCommission
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_IC_HaloSales_Step05_RetractCommission]
AS
BEGIN
...
CREATE NONCLUSTERED INDEX IDXX_Opencommissions_SalesorderDetailSSID ON #OpenCommissions ( SalesOrderDetailSSID );
...
-- Refunds must be within 90 days of the original sale of the Halo
INSERT	INTO #Refunds
