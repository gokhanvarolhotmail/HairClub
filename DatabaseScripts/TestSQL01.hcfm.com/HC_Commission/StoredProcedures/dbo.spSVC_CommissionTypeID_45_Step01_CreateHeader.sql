/* CreateDate: 10/07/2016 14:36:13.427 , ModifyDate: 10/24/2019 14:05:10.347 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
PROCEDURE:				spSVC_CommissionTypeID_45_Step01_CreateHeader
...
EXEC spSVC_CommissionTypeID_45_Step01_CreateHeader
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_45_Step01_CreateHeader]
AS
BEGIN
...
INSERT  INTO #Header
		...
		FROM    HC_BI_CMS_DDS.bi_cms_dds.FactSalesTransaction FST
				...
				OUTER APPLY ( SELECT TOP 1
							  ...
							  WHERE     FST_SVC.ClientMembershipKey = DCM.ClientMembershipKey
										AND FST_SVC.SalesCodeKey IN ( 622, 387, 627, 1734, 1756 )
		...
		WHERE   CTR.CenterTypeKey = 2
				...
				AND ( ( FST.NB_ExtCnt >= 1 ) -- Initial Assignment
						OR ( DM.MembershipKey = 106 AND DD.FullDate > o_S.ServiceDate AND FST.SalesCodeKey IN ( 1822, 1823 ) ) ) -- In-House Payment Plan Payments made after Initial Svc
