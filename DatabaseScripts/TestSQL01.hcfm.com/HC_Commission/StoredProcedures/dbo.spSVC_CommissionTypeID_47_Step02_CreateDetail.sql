/* CreateDate: 08/29/2018 14:38:54.323 , ModifyDate: 08/29/2018 14:41:13.667 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
PROCEDURE:				spSVC_CommissionTypeID_47_Step02_CreateDetail
...
EXEC spSVC_CommissionTypeID_47_Step02_CreateDetail
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_47_Step02_CreateDetail]
AS
BEGIN
...
INSERT  INTO #Details
        ...
        WHERE   DD.FullDate BETWEEN @TransactionStartDate AND @TransactionEndDate
				...
				AND SC.SalesCodeDescriptionShort IN ( 'INITASG', 'MEMPMTXTRD', 'TAPEINSTSVC', 'TAPEREINSTSVC' )
