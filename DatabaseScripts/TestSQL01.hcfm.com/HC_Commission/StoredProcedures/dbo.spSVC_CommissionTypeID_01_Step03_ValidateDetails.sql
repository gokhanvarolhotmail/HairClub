/* CreateDate: 10/10/2012 15:20:18.393 , ModifyDate: 03/14/2013 16:24:55.777 */
GO
SET ANSI_NULLS ON
GO
...
PROCEDURE:				[spSVC_CommissionTypeID_01_Step03_ValidateDetails]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_01_Step03_ValidateDetails]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_01_Step03_ValidateDetails] AS
BEGIN
	SET NOCOUNT ON
