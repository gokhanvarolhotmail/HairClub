/* CreateDate: 03/30/2019 12:35:15.733 , ModifyDate: 06/03/2019 15:41:22.623 */
GO
SET ANSI_NULLS ON
GO
...
UPDATE	oc
SET		oc.CalculatedCommission = CASE WHEN oc.ConvertedToMembershipDescriptionShort IN ( 'BASIC', 'RUBY', 'RUBYPLUS' ) THEN 75 ELSE 150 END
FROM	#OpenCommissions oc
