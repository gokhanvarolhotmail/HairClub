/* CreateDate: 08/07/2017 13:42:24.060 , ModifyDate: 08/07/2017 14:23:23.180 */
GO
SET ANSI_NULLS ON
GO
...
INSERT  INTO #Details
        ...
        WHERE   dd.FullDate BETWEEN @TransactionStartDate AND @TransactionEndDate
                AND sc.SalesCodeDescriptionShort IN ( 'MEDADDONTG', 'MEDADDONTG9', 'BOSPERFTG', 'BOSPERFTGBPS' )
