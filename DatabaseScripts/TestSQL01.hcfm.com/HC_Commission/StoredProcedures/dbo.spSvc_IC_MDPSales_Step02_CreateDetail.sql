/* CreateDate: 03/30/2019 12:38:49.140 , ModifyDate: 09/16/2020 15:05:49.587 */
GO
/***********************************************************************
PROCEDURE:				spSvc_IC_MDPSales_Step02_CreateDetail
DESTINATION SERVER:		SQL06
DESTINATION DATABASE:	HC_Commission
AUTHOR:					Dominic Leiba
IMPLEMENTOR:			Dominic Leiba
DATE IMPLEMENTED:		3/23/2019
DESCRIPTION:			Used to generate a commission detail record for IC MDP Sales
------------------------------------------------------------------------
NOTES:
...
EXEC spSvc_IC_MDPSales_Step02_CreateDetail
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_IC_MDPSales_Step02_CreateDetail]
AS
BEGIN
...
-- Get all mdp sale details within the specified time frame
INSERT	INTO #DetailsToProcess
		...
		WHERE	ctr.CenterTypeKey = 2
				...
				AND ( fst.SalesOrderKey = oc.SalesOrderKey
						OR sc.SalesCodeDescriptionShort = 'SVCSMP' )
