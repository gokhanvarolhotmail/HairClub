/* CreateDate: 03/30/2019 12:38:56.963 , ModifyDate: 03/17/2021 09:25:39.583 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
PROCEDURE:				spSvc_IC_MDPSales_Step01_CreateHeader
DESTINATION SERVER:		SQL06
DESTINATION DATABASE:	HC_Commission
AUTHOR:					Dominic Leiba
IMPLEMENTOR:			Dominic Leiba
DATE IMPLEMENTED:		3/23/2019
DESCRIPTION:			Used to generate a commission header record for IC MDP Sales
------------------------------------------------------------------------
NOTES:
...
EXEC spSvc_IC_MDPSales_Step01_CreateHeader
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_IC_MDPSales_Step01_CreateHeader]
AS
BEGIN
