/* CreateDate: 11/02/2012 10:11:54.543 , ModifyDate: 03/16/2017 16:32:45.423 */
GO
SET ANSI_NULLS ON
GO
...
PROCEDURE:				[spSVC_CommissionTypeID_20_Step03_ValidateDetails]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_20_Step03_ValidateDetails]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_20_Step03_ValidateDetails] AS
BEGIN
	SET NOCOUNT ON
	...
	BEGIN
		...
		BEGIN
			...
			------------------------------------------------------------------------------------------
			IF @CurrentDetailsSalesCodeKey IN (469, 1683, 1684, 1685, 1689)
			...
			------------------------------------------------------------------------------------------
			IF @CurrentDetailsSalesCodeKey IN (600, 601,1733)
			...
			WHERE CommissionDetailKey = @CommissionDetailKey
				...
				AND (@CurrentDetailsSalesCodeKey IN (471, 632)
					OR (@CurrentDetailsSalesCodeKey IN (469, 1683, 1684, 1685, 1689)
						AND @CurrentIsRefund = 1
						AND @CurrentDetailsOrderDateDate > @InitialApplicationDate
					)
				)
