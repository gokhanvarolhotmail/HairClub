/* CreateDate: 01/28/2015 10:48:22.180 , ModifyDate: 03/29/2017 11:08:56.277 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
PROCEDURE:				spSVC_CommissionTypeID_38_Step02_CreateDetail
...
spSVC_CommissionTypeID_38_Step02_CreateDetail
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_38_Step02_CreateDetail]
AS
BEGIN
...
INSERT  INTO #Details (
        ...
        WHERE   DD.FullDate BETWEEN @TransactionStartDate AND @TransactionEndDate
				...
				AND M.MembershipKey IN ( 114, 115, 116, 117, 118, 119, 120, 121, 136, 137, 138, 139 )
