/* CreateDate: 04/01/2021 08:37:24.750 , ModifyDate: 01/27/2022 09:18:12.413 */
GO
...
GO
ALTER TABLE [bi_mktg_dds].[DimContactMonthly] ADD  CONSTRAINT [DF_DimContactMonthly_RowStartDate]  DEFAULT ('1/1/1753') FOR [RowStartDate]
GO
ALTER TABLE [bi_mktg_dds].[DimContactMonthly] ADD  CONSTRAINT [DF_DimContactMonthly_RowEndDate]  DEFAULT ('12/31/9999') FOR [RowEndDate]
GO
ALTER TABLE [bi_mktg_dds].[DimContactMonthly] ADD  CONSTRAINT [DF_DimContactMonthly_InsertAuditKey]  DEFAULT ((0)) FOR [InsertAuditKey]
GO
