/* CreateDate: 08/03/2012 14:44:15.390 , ModifyDate: 09/25/2012 15:09:22.583 */
GO
/***********************************************************************
...
SAMPLE EXECUTION: EXEC spsvc_IMSActivityExport_ONCV
							EXEC spsvc_MediaActivityExport_ONCV  '8/1/2012', '8/3/2012'
...
--SELECT DATEADD(dd, -2024,CAST(CONVERT(VARCHAR, GETDATE(), 10) AS DATETIME))
        IF ( @BegDt IS NULL
			...
			WHERE dd.FullDate BETWEEN @BegDt AND @EndDt
					...
					--and fl.ContactKey = 2221176
			--ORDER BY dc.ContactSSID desc
