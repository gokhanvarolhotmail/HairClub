/* CreateDate: 04/01/2015 17:03:33.773 , ModifyDate: 05/09/2019 11:58:26.700 */
GO
SET ANSI_NULLS ON
GO
...
GO
/*===============================================================================================
 Procedure Name:                  rptMonthlyFeeCreditCardDetail
...
================================================================================================
**NOTES**
This report was cloned from the stored procedure and report rptMonthlyFeeCreditCardDetail].
================================================================================================
Sample Execution:
EXEC [rptMonthlyFeeCreditCardDetail] 201, '3/1/2015'

EXEC [rptMonthlyFeeCreditCardDetail] 855, '3/1/2015'

================================================================================================*/

CREATE PROCEDURE [dbo].[rptMonthlyFeeCreditCardDetail]
	@CenterID int,
	@ReportDate DateTime
AS
BEGIN
