/* CreateDate: 04/24/2012 13:04:14.353 , ModifyDate: 02/27/2017 09:49:25.160 */
GO
/*
==============================================================================
PROCEDURE:				[rptAnnualReportByLengthSummary]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [rptAnnualReportByLengthSummary] '1/1/08', '12/31/08'
==============================================================================
*/
CREATE PROCEDURE [dbo].[rptAnnualReportByLengthSummary]
	@StartDate DATETIME
,	@EndDate DATETIME
AS
BEGIN
