/* CreateDate: 02/27/2017 06:47:00.410 , ModifyDate: 09/23/2019 12:13:50.693 */
GO
/***********************************************************************
	PROCEDURE:				[selTechnicalProfilesBioForClient]
	DESTINATION SERVER:		SQL01
	DESTINATION DATABASE: 	HairClubCMS
	RELATED APPLICATION:  	CMS
	AUTHOR: 				SAL
	IMPLEMENTOR: 			SAL
	DATE IMPLEMENTED: 		02/07/2017
	LAST REVISION DATE: 	07/17/2019
	--------------------------------------------------------------------------------------------------------
	NOTES: 	Returns a list of BIO Technical Profiles - does NOT include Scalp Prep records
	...
	--------------------------------------------------------------------------------------------------------
	SAMPLE EXECUTION:
	EXEC [selTechnicalProfilesBioForClient] '7BE39604-BD0F-45E0-B5FF-00000EB1EEC4'
***********************************************************************/
CREATE PROCEDURE [dbo].[selTechnicalProfilesBioForClient]
