/* CreateDate: 06/10/2013 20:12:51.493 , ModifyDate: 03/09/2020 15:10:50.447 */
GO
/*
==============================================================================
PROCEDURE:				extSiebelGetPostExtAddDetail
...
DATE IMPLEMENTED: 		  06/04/2013

LAST REVISION DATE: 	  06/04/2013

==============================================================================
DESCRIPTION:	Gets Post Ext Add Information for the Interface with Bosley
==============================================================================
NOTES:
	* 06/04/2013	MVT		Created
	* 08/15/2013	MVT		Modified to always return a Client Membership Identifier
							in order Surgery, EXT, BIO
	* 10/10/2013	MVT		Modified to always send surgery consultant and invoice number.
...
==============================================================================
SAMPLE EXECUTION:
EXEC extSiebelGetPostExtAddDetail  'E37C19AF-84D6-42DC-B864-0000C3390525'
==============================================================================
*/
CREATE PROCEDURE [dbo].[extSiebelGetPostExtAddDetail]
(
...
AS
	...
	SELECT
		...
		,COALESCE(c.LeadCreateDate, c.CreateDate, CAST('1900-01-01' as Date))  as 'LeadCreateDate'
		...
		,ISNULL(cmExt.[ContractPrice], 0) as 'Amount'
