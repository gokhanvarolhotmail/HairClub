/* CreateDate: 09/10/2014 07:53:57.443 , ModifyDate: 12/07/2021 16:20:16.003 */
GO
...
GO
ALTER TABLE [dbo].[cfgConfigurationCenterPC]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgConfigurationCenterPC_cfgCenter] FOREIGN KEY([CenterID])
