/* CreateDate: 08/27/2008 11:31:38.010 , ModifyDate: 12/07/2021 16:20:16.073 */
GO
SET ANSI_NULLS ON
GO
...
GO
ALTER TABLE [dbo].[lkpColorFormulaSize]  WITH CHECK ADD  CONSTRAINT [FK_lkpColorFormulaSize_lkpColorBrand] FOREIGN KEY([ColorBrandID])
