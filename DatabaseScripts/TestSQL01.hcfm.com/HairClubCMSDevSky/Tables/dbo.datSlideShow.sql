...
GO
ALTER TABLE [dbo].[datSlideShow]  WITH NOCHECK ADD  CONSTRAINT [FK_datSlideShow_cfgCenter] FOREIGN KEY([CenterID])
REFERENCES [dbo].[cfgCenter] ([CenterID])
GO
ALTER TABLE [dbo].[datSlideShow] CHECK CONSTRAINT [FK_datSlideShow_cfgCenter]
GO
ALTER TABLE [dbo].[datSlideShow]  WITH NOCHECK ADD  CONSTRAINT [FK_datSlideShow_lkpDayOfWeek] FOREIGN KEY([DayOfWeekID])
