/* CreateDate: 05/28/2018 22:15:34.757 , ModifyDate: 05/28/2018 22:15:34.793 */
GO
...
GO
ALTER TABLE [dbo].[cfgSalesCodeCenterContract]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgSalesCodeCenterContract_cfgCenter] FOREIGN KEY([CenterID])
