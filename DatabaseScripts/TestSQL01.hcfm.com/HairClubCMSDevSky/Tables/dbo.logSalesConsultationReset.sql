/* CreateDate: 02/12/2018 17:14:29.283 , ModifyDate: 02/02/2022 10:06:20.540 */
GO
...
GO
ALTER TABLE [dbo].[logSalesConsultationReset]  WITH CHECK ADD  CONSTRAINT [FK_logSalesConsultationReset_datAppointment] FOREIGN KEY([AppointmentGUID])
