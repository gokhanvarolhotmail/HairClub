/* CreateDate: 05/28/2018 22:15:34.517 , ModifyDate: 12/07/2021 16:20:15.883 */
GO
...
GO
ALTER TABLE [dbo].[datSalesCodeCenterInventory]  WITH NOCHECK ADD  CONSTRAINT [FK_datSalesCodeCenterInventory_cfgSalesCodeCenter] FOREIGN KEY([SalesCodeCenterID])
