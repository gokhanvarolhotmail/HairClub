/* CreateDate: 02/18/2013 06:49:02.310 , ModifyDate: 12/07/2021 16:20:15.873 */
GO
...
GO
ALTER TABLE [dbo].[cfgMembershipPromotion]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgMembershipPromotion_lkpBusinessSegment] FOREIGN KEY([BusinessSegmentID])
...
GO
ALTER TABLE [dbo].[cfgMembershipPromotion]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgMembershipPromotion_lkpMembershipPromotion] FOREIGN KEY([MembershipPromotionTypeID])
...
GO
ALTER TABLE [dbo].[cfgMembershipPromotion]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgMembershipPromotion_lkpMembershipPromotionAdjustmentType] FOREIGN KEY([MembershipPromotionAdjustmentTypeID])
...
GO
ALTER TABLE [dbo].[cfgMembershipPromotion]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgMembershipPromotion_lkpMembershipPromotionGroup] FOREIGN KEY([MembershipPromotionGroupID])
...
GO
ALTER TABLE [dbo].[cfgMembershipPromotion]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgMembershipPromotion_lkpRevenueGroup] FOREIGN KEY([RevenueGroupID])
