/* CreateDate: 02/26/2017 22:35:10.547 , ModifyDate: 12/29/2021 15:38:46.073 */
GO
...
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer]  WITH CHECK ADD  CONSTRAINT [FK_datTechnicalProfilePermRelaxer_datTechnicalProfile] FOREIGN KEY([TechnicalProfileID])
...
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer]  WITH CHECK ADD  CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpPermBrand] FOREIGN KEY([PermOwnPermBrandID])
...
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer]  WITH CHECK ADD  CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpPermBrand1] FOREIGN KEY([PermSystemPermBrandID])
REFERENCES [dbo].[lkpPermBrand] ([PermBrandID])
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer] CHECK CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpPermBrand1]
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer]  WITH CHECK ADD  CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpPermOwnHairRods1] FOREIGN KEY([PermOwnPermOwnHairRods1ID])
...
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer]  WITH CHECK ADD  CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpPermOwnHairRods2] FOREIGN KEY([PermOwnPermOwnHairRods2ID])
REFERENCES [dbo].[lkpPermOwnHairRods] ([PermOwnHairRodsID])
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer] CHECK CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpPermOwnHairRods2]
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer]  WITH CHECK ADD  CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpPermOwnHairRods3] FOREIGN KEY([PermSystemPermOwnHairRods1ID])
REFERENCES [dbo].[lkpPermOwnHairRods] ([PermOwnHairRodsID])
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer] CHECK CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpPermOwnHairRods3]
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer]  WITH CHECK ADD  CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpPermOwnHairRods4] FOREIGN KEY([PermSystemPermOwnHairRods2ID])
REFERENCES [dbo].[lkpPermOwnHairRods] ([PermOwnHairRodsID])
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer] CHECK CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpPermOwnHairRods4]
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer]  WITH CHECK ADD  CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpPermTechnique] FOREIGN KEY([PermOwnPermTechniqueID])
...
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer]  WITH CHECK ADD  CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpPermTechnique1] FOREIGN KEY([PermSystemPermTechniqueID])
REFERENCES [dbo].[lkpPermTechnique] ([PermTechniqueID])
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer] CHECK CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpPermTechnique1]
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer]  WITH CHECK ADD  CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpRelaxerBrand] FOREIGN KEY([RelaxerBrandID])
...
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer]  WITH CHECK ADD  CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpRelaxerStrength] FOREIGN KEY([RelaxerStrengthID])
...
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer]  WITH CHECK ADD  CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpTimeUnit] FOREIGN KEY([PermOwnProcessingTimeUnitID])
...
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer]  WITH CHECK ADD  CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpTimeUnit1] FOREIGN KEY([PermSystemProcessingTimeUnitID])
REFERENCES [dbo].[lkpTimeUnit] ([TimeUnitID])
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer] CHECK CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpTimeUnit1]
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer]  WITH CHECK ADD  CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpTimeUnit2] FOREIGN KEY([RelaxerProcessingTimeUnitID])
REFERENCES [dbo].[lkpTimeUnit] ([TimeUnitID])
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer] CHECK CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpTimeUnit2]
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer]  WITH CHECK ADD  CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpTimUnit] FOREIGN KEY([PermOwnProcessingTimeUnitID])
REFERENCES [dbo].[lkpTimeUnit] ([TimeUnitID])
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer] CHECK CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpTimUnit]
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer]  WITH CHECK ADD  CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpTimUnit1] FOREIGN KEY([PermSystemProcessingTimeUnitID])
REFERENCES [dbo].[lkpTimeUnit] ([TimeUnitID])
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer] CHECK CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpTimUnit1]
GO
ALTER TABLE [dbo].[datTechnicalProfilePermRelaxer]  WITH CHECK ADD  CONSTRAINT [FK_datTechnicalProfilePermRelaxer_lkpTimUnit2] FOREIGN KEY([RelaxerProcessingTimeUnitID])
REFERENCES [dbo].[lkpTimeUnit] ([TimeUnitID])
GO
