/* CreateDate: 09/26/2011 16:03:03.743 , ModifyDate: 06/14/2012 13:22:07.330 */
GO
/***********************************************************************
...
EXEC [sprpt_ScanProgress] 04, 2012, '100', 2
***********************************************************************/
...
FROM (
	...
	INNER JOIN (SELECT item FROM dbo.fnSplit(@CenterId,',')) fCenter ON fCenter.item = h.CenterID
		LEFT JOIN synHairClubCMS_dbo_lkpRegion Region ON Region.RegionID = Center.RegionId
