/* CreateDate: 10/05/2020 08:43:46.960 , ModifyDate: 04/07/2021 13:53:47.853 */
GO
/***********************************************************************
NAME:					TESTfnIsInvalidLead
...
SELECT * FROM dbo.testfnIsInvalidLead('00Q1L00001aEa2vUAC')
SELECT * FROM dbo.fnIsInvalidLead('00Q1L00001aEa2vUAC')
***********************************************************************/
CREATE FUNCTION [dbo].[testfnIsInvalidLead]
(
