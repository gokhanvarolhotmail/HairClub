/* CreateDate: 10/22/2013 17:25:10.483 , ModifyDate: 04/27/2021 16:54:54.323 */
GO
/***********************************************************************
...
EXEC [sprpt_RetailFlash] 'C', '3/23/2020', '3/23/2020', 3

EXEC [sprpt_RetailFlash] 'F', '1/1/2020', '1/31/2020', 1
--***********************************************************************/
...
SELECT
	...
	,	sc.SalesCodeDescription
	,	CASE WHEN ( scd.SalesCodeDepartmentSSID = 7052 ) THEN FST.quantity ELSE 0 END as 'RetailQty'
	,	CASE WHEN (scd.SalesCodeDivisionSSID = 30 AND scd.SalesCodeDepartmentSSID = 7052 ) THEN FST.RetailAmt
...
FROM HC_BI_CMS_DDS.bi_cms_dds.FactSalesTransaction FST
	...
	CROSS APPLY (
		SELECT	DISTINCT
				DSOT.SalesOrderKey
		FROM	HC_BI_CMS_DDS.bi_cms_dds.DimSalesOrderTender DSOT
		WHERE	DSOT.SalesOrderKey = FST.SalesOrderKey
