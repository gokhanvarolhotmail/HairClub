/* CreateDate: 01/17/2022 06:06:54.687 , ModifyDate: 01/27/2022 08:01:38.897 */
GO
/*
==============================================================================
...
,	CASE WHEN SUM(ISNULL(CASE WHEN FA.AccountID IN (10305,10306,10310,10315,10320,10321,10325,10536,10540,10551,10552,10575,10891) THEN Flash ELSE 0 END, 0)) = 0
		THEN 0 ELSE SUM(ISNULL(CASE WHEN FA.AccountID IN (10305,10306,10310,10315,10320,10321,10325,10536,10540,10551,10552,10575,10891) THEN Flash ELSE 0 END, 0))
		END AS 'SubTotalRevenueActual'  --Retail (10555) is not included here

,	NULL AS 'TotalRevenueActual'
,	CASE WHEN SUM(ISNULL(CASE WHEN FA.AccountID IN (10305,10306,10310,10315,10320,10321,10325,10536,10540,10551,10552,10555,10575,10891) THEN ABS(Budget) ELSE 0 END, 0)) = 0
		THEN 1 ELSE SUM(ISNULL(CASE WHEN FA.AccountID IN (10305,10306,10310,10315,10320,10321,10325,10536,10540,10551,10552,10555,10575,10891) THEN ABS(Budget) ELSE 0 END, 0)) END AS 'TotalRevenueBudget' --Retail (10555) is here
