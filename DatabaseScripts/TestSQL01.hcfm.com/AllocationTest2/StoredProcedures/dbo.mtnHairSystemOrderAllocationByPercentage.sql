/* CreateDate: 10/31/2019 21:09:58.603 , ModifyDate: 10/31/2019 21:09:58.603 */
GO
SET ANSI_NULLS ON
GO
  ...
  BEGIN
	...
	INSERT INTO @Orders(HairSystemOrderGUID, Vendor, HairSystemOrderNumber)
		...
		FROM datHairSystemOrder hso
			...
			LEFT OUTER JOIN cfgHairSystemAllocationFilterFlags hsaff ON hso.IsSignatureHairlineAddOn = hsaff.AllowSignatureHairline AND hsvr.Ranking1VendorID = hsaff.VendorID
	...
	INSERT INTO @Orders(HairSystemOrderGUID, Vendor, HairSystemOrderNumber)
		...
		FROM datHairSystemOrder hso
			...
			LEFT OUTER JOIN cfgHairSystemAllocationFilterFlags hsaff ON hso.IsSignatureHairlineAddOn = hsaff.AllowSignatureHairline AND hsvr.Ranking2VendorID = hsaff.VendorID
	...
	INSERT INTO @Orders(HairSystemOrderGUID, Vendor, HairSystemOrderNumber)
		...
		FROM datHairSystemOrder hso
			...
			LEFT OUTER JOIN cfgHairSystemAllocationFilterFlags hsaff ON hso.IsSignatureHairlineAddOn = hsaff.AllowSignatureHairline AND hsvr.Ranking3VendorID = hsaff.VendorID
	...
	INSERT INTO @Orders(HairSystemOrderGUID, Vendor, HairSystemOrderNumber)
		...
		FROM datHairSystemOrder hso
			...
			LEFT OUTER JOIN cfgHairSystemAllocationFilterFlags hsaff ON hso.IsSignatureHairlineAddOn = hsaff.AllowSignatureHairline AND hsvr.Ranking4VendorID = hsaff.VendorID
