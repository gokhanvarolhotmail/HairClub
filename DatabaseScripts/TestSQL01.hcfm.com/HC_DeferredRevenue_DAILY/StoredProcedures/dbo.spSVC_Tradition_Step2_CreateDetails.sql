/* CreateDate: 02/27/2020 07:44:10.983 , ModifyDate: 02/27/2020 07:44:10.983 */
GO
/***********************************************************************
PROCEDURE:				spSVC_Tradition_Step2_CreateDetails
...
EXEC spSVC_Tradition_Step2_CreateDetails '9/2/2018'
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_Tradition_Step2_CreateDetails]
(
	@Month DATETIME
)
AS
...
INSERT	INTO #DetailsToProcess
		...
		WHERE   dd.FullDate BETWEEN @StartDate AND @EndDate
				...
				AND ( fst.NB_TradCnt <> 0
						...
						OR sc.SalesCodeDescriptionShort IN ( 'NB1A', 'APP', 'CONV', 'CANCEL' ) )
