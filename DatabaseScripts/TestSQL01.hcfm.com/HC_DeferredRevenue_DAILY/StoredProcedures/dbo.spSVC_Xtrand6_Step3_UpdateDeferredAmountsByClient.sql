/* CreateDate: 02/27/2020 07:44:11.293 , ModifyDate: 02/27/2020 07:44:11.293 */
GO
/***********************************************************************
...
EXEC spSVC_Xtrand6_Step3_UpdateDeferredAmountsByClient '9/2/2018'
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_Xtrand6_Step3_UpdateDeferredAmountsByClient]
(
	@Month DATETIME
)
AS
