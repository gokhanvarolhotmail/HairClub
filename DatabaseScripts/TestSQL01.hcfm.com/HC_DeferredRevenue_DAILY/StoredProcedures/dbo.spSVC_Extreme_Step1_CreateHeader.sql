/* CreateDate: 02/27/2020 07:44:10.093 , ModifyDate: 02/27/2020 07:44:10.093 */
GO
SET ANSI_NULLS ON
GO
...
INSERT	INTO #HeadersToProcess
		...
		WHERE	dd.FullDate BETWEEN @StartDate AND @EndDate
				...
				AND m.MembershipDescriptionShort IN ( 'EXT6', 'EXT12', 'EXTENH6', 'EXTENH12', 'EXTENH9', 'EXTINITIAL' )
