/* CreateDate: 02/27/2020 07:44:10.930 , ModifyDate: 02/27/2020 07:44:10.930 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
PROCEDURE:				spSVC_Tradition_Step1_CreateHeader
...
EXEC spSVC_Tradition_Step1_CreateHeader '9/2/2018'
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_Tradition_Step1_CreateHeader]
(
	@Month DATETIME
)
AS
...
-- Get Initial Assignments to Xtrands+ Initial during specified date range
INSERT	INTO #HeadersToProcess
		...
		WHERE	dd.FullDate BETWEEN @StartDate AND @EndDate
				AND ( fst.NB_TradCnt > 0
						OR sc.SalesCodeDepartmentSSID IN ( 1015 ) ) -- Misc Mbr Agreements
				AND m.MembershipDescriptionShort = 'TRADITION'
