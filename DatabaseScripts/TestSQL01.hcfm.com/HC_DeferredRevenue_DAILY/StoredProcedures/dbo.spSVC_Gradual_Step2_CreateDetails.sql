...
EXEC spSVC_Gradual_Step2_CreateDetails '8/2/2018'
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_Gradual_Step2_CreateDetails]
(
	@Month DATETIME
)
AS
...
INSERT	INTO #DetailsToProcess
		...
		WHERE   dd.FullDate BETWEEN @StartDate AND @EndDate
				...
				AND ( fst.NB_GradCnt <> 0
						OR fst.NB_GradAmt <> 0
						OR fst.NB_AppsCnt > 0
						OR sc.SalesCodeDescriptionShort IN ( 'APP', 'NB1A', 'CONV', 'NB1XPR' ) )
