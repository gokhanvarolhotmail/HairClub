/* CreateDate: 01/06/2014 14:24:35.223 , ModifyDate: 01/06/2014 14:59:02.033 */
GO
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	SELECT
	    ...
	    CASE WHEN ccomp.show_no_show_flag = 'S' THEN 'BEBACK' ELSE 'APPOINT' END AS ActionCode
	...
	GROUP BY co.cst_center_number, coa.cst_center_number,  c.contact_id, c.last_name, c.first_name, ca.city,
	   ca.state_code, ca.zip_code, cp.area_code, cp.phone_number, c.cst_complete_sale, ccomp.show_no_show_flag
	ORDER BY [Name]
END
GO
