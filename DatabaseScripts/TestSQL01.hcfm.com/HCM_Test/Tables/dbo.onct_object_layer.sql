...
GO
ALTER TABLE [dbo].[onct_object_layer]  WITH CHECK ADD  CONSTRAINT [object_object_layer_1116] FOREIGN KEY([object_id])
REFERENCES [dbo].[onct_object] ([object_id])
GO
ALTER TABLE [dbo].[onct_object_layer] CHECK CONSTRAINT [object_object_layer_1116]
GO
ALTER TABLE [dbo].[onct_object_layer]  WITH CHECK ADD  CONSTRAINT [registry_ent_object_layer_1117] FOREIGN KEY([registry_entry_layer_id])
