...
GO
ALTER TABLE [dbo].[onca_product_version_product]  WITH CHECK ADD  CONSTRAINT [product_product_vers_1085] FOREIGN KEY([product_code])
...
GO
ALTER TABLE [dbo].[onca_product_version_product]  WITH CHECK ADD  CONSTRAINT [product_vers_product_vers_1086] FOREIGN KEY([version_code])
