...
GO
ALTER TABLE [dbo].[csta_query_criteria_detail]  WITH CHECK ADD  CONSTRAINT [csta_query_criteria_csta_query_criteria_detail_762] FOREIGN KEY([query_criteria_id])
...
GO
ALTER TABLE [dbo].[csta_query_criteria_detail]  WITH CHECK ADD  CONSTRAINT [onca_user_csta_query_criteria_detail_763] FOREIGN KEY([created_by_user_code])
REFERENCES [dbo].[onca_user] ([user_code])
GO
ALTER TABLE [dbo].[csta_query_criteria_detail] CHECK CONSTRAINT [onca_user_csta_query_criteria_detail_763]
GO
ALTER TABLE [dbo].[csta_query_criteria_detail]  WITH CHECK ADD  CONSTRAINT [onca_user_csta_query_criteria_detail_764] FOREIGN KEY([updated_by_user_code])
REFERENCES [dbo].[onca_user] ([user_code])
GO
