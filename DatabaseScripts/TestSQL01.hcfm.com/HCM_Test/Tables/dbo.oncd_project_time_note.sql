...
GO
ALTER TABLE [dbo].[oncd_project_time_note]  WITH NOCHECK ADD  CONSTRAINT [project_time_project_time_783] FOREIGN KEY([project_time_id])
...
GO
ALTER TABLE [dbo].[oncd_project_time_note]  WITH NOCHECK ADD  CONSTRAINT [user_project_time_1062] FOREIGN KEY([created_by_user_code])
REFERENCES [dbo].[onca_user] ([user_code])
GO
ALTER TABLE [dbo].[oncd_project_time_note] CHECK CONSTRAINT [user_project_time_1062]
GO
ALTER TABLE [dbo].[oncd_project_time_note]  WITH NOCHECK ADD  CONSTRAINT [user_project_time_1063] FOREIGN KEY([updated_by_user_code])
REFERENCES [dbo].[onca_user] ([user_code])
GO
