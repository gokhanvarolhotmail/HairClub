...
GO
ALTER TABLE [dbo].[onca_source]  WITH NOCHECK ADD  CONSTRAINT [campaign_source_277] FOREIGN KEY([campaign_code])
REFERENCES [dbo].[onca_campaign] ([campaign_code])
GO
ALTER TABLE [dbo].[onca_source] CHECK CONSTRAINT [campaign_source_277]
GO
ALTER TABLE [dbo].[onca_source]  WITH NOCHECK ADD  CONSTRAINT [csta_contact_age_range_onca_source_774] FOREIGN KEY([cst_age_range_code])
...
GO
ALTER TABLE [dbo].[onca_source]  WITH NOCHECK ADD  CONSTRAINT [csta_contact_hair_loss_onca_source_775] FOREIGN KEY([cst_hair_loss_code])
...
GO
ALTER TABLE [dbo].[onca_source]  WITH NOCHECK ADD  CONSTRAINT [csta_contact_language_onca_source_776] FOREIGN KEY([cst_language_code])
...
GO
ALTER TABLE [dbo].[onca_source]  WITH NOCHECK ADD  CONSTRAINT [csta_promotion_code_onca_source_773] FOREIGN KEY([cst_promotion_code])
