...
GO
ALTER TABLE [dbo].[cstd_admin_lead]  WITH NOCHECK ADD  CONSTRAINT [FK_cstd_admin_lead_created_by_user] FOREIGN KEY([created_by_user_code])
REFERENCES [dbo].[onca_user] ([user_code])
GO
ALTER TABLE [dbo].[cstd_admin_lead] CHECK CONSTRAINT [FK_cstd_admin_lead_created_by_user]
GO
ALTER TABLE [dbo].[cstd_admin_lead]  WITH NOCHECK ADD  CONSTRAINT [FK_cstd_admin_lead_csta_activity_type] FOREIGN KEY([activity_type_code])
...
GO
ALTER TABLE [dbo].[cstd_admin_lead]  WITH NOCHECK ADD  CONSTRAINT [FK_cstd_admin_lead_csta_admin_lead_category] FOREIGN KEY([admin_lead_category_code])
...
GO
ALTER TABLE [dbo].[cstd_admin_lead]  WITH NOCHECK ADD  CONSTRAINT [FK_cstd_admin_lead_onca_user] FOREIGN KEY([user_code])
REFERENCES [dbo].[onca_user] ([user_code])
GO
ALTER TABLE [dbo].[cstd_admin_lead] CHECK CONSTRAINT [FK_cstd_admin_lead_onca_user]
GO
ALTER TABLE [dbo].[cstd_admin_lead]  WITH NOCHECK ADD  CONSTRAINT [FK_cstd_admin_lead_updated_by_user] FOREIGN KEY([updated_by_user_code])
REFERENCES [dbo].[onca_user] ([user_code])
GO
