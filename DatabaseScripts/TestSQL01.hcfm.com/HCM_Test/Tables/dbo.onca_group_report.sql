...
GO
ALTER TABLE [dbo].[onca_group_report]  WITH NOCHECK ADD  CONSTRAINT [group_group_report_232] FOREIGN KEY([group_id])
REFERENCES [dbo].[onca_group] ([group_id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[onca_group_report] CHECK CONSTRAINT [group_group_report_232]
GO
ALTER TABLE [dbo].[onca_group_report]  WITH NOCHECK ADD  CONSTRAINT [report_group_group_report_237] FOREIGN KEY([report_group_id])
