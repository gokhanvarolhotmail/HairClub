...
GO
ALTER TABLE [dbo].[oncs_audit_checkpoint]  WITH CHECK ADD  CONSTRAINT [audit_client_audit_checkp_1189] FOREIGN KEY([audit_client_id])
...
GO
ALTER TABLE [dbo].[oncs_audit_checkpoint]  WITH CHECK ADD  CONSTRAINT [audit_reques_audit_checkp_1187] FOREIGN KEY([audit_requester_id])
