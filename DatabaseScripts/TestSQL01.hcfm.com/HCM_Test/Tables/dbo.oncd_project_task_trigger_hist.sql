...
GO
ALTER TABLE [dbo].[oncd_project_task_trigger_hist]  WITH NOCHECK ADD  CONSTRAINT [project_mile_project_task_1057] FOREIGN KEY([project_milestone_id])
...
GO
ALTER TABLE [dbo].[oncd_project_task_trigger_hist]  WITH NOCHECK ADD  CONSTRAINT [project_revi_project_task_771] FOREIGN KEY([project_revision_id])
...
GO
ALTER TABLE [dbo].[oncd_project_task_trigger_hist]  WITH NOCHECK ADD  CONSTRAINT [project_task_project_task_1058] FOREIGN KEY([project_task_id])
...
GO
ALTER TABLE [dbo].[oncd_project_task_trigger_hist]  WITH NOCHECK ADD  CONSTRAINT [project_task_project_task_1076] FOREIGN KEY([project_task_trigger_id])
