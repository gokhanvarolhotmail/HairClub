...
GO
ALTER TABLE [dbo].[oncd_project_task_calc_hist]  WITH NOCHECK ADD  CONSTRAINT [project_elem_project_task_1048] FOREIGN KEY([project_element_calc_id])
...
GO
ALTER TABLE [dbo].[oncd_project_task_calc_hist]  WITH NOCHECK ADD  CONSTRAINT [project_revi_project_task_769] FOREIGN KEY([project_revision_id])
...
GO
ALTER TABLE [dbo].[oncd_project_task_calc_hist]  WITH NOCHECK ADD  CONSTRAINT [project_task_project_task_1047] FOREIGN KEY([project_task_calc_id])
...
GO
ALTER TABLE [dbo].[oncd_project_task_calc_hist]  WITH NOCHECK ADD  CONSTRAINT [project_task_project_task_1049] FOREIGN KEY([project_task_id])
