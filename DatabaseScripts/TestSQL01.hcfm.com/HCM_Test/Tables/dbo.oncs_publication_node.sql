...
GO
ALTER TABLE [dbo].[oncs_publication_node]  WITH NOCHECK ADD  CONSTRAINT [publication__publication__355] FOREIGN KEY([parent_node_id])
...
GO
ALTER TABLE [dbo].[oncs_publication_node]  WITH NOCHECK ADD  CONSTRAINT [publication_publication__309] FOREIGN KEY([publication_id])
...
GO
ALTER TABLE [dbo].[oncs_publication_node]  WITH NOCHECK ADD  CONSTRAINT [table_publication__358] FOREIGN KEY([table_name])
REFERENCES [dbo].[onct_table] ([table_name])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[oncs_publication_node] CHECK CONSTRAINT [table_publication__358]
GO
ALTER TABLE [dbo].[oncs_publication_node]  WITH NOCHECK ADD  CONSTRAINT [table_relati_publication__357] FOREIGN KEY([table_relation_member_id])
