...
GO
ALTER TABLE [dbo].[oncd_project_task_action_hist]  WITH CHECK ADD  CONSTRAINT [project_mile_project_task_1044] FOREIGN KEY([project_milestone_id])
...
GO
ALTER TABLE [dbo].[oncd_project_task_action_hist]  WITH CHECK ADD  CONSTRAINT [project_revi_project_task_768] FOREIGN KEY([project_revision_id])
...
GO
ALTER TABLE [dbo].[oncd_project_task_action_hist]  WITH CHECK ADD  CONSTRAINT [project_task_project_task_1045] FOREIGN KEY([project_task_action_id])
...
GO
ALTER TABLE [dbo].[oncd_project_task_action_hist]  WITH CHECK ADD  CONSTRAINT [project_task_project_task_1046] FOREIGN KEY([project_task_id])
