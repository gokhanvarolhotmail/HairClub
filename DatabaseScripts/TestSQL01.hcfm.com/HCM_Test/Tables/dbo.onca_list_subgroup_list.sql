...
GO
ALTER TABLE [dbo].[onca_list_subgroup_list]  WITH CHECK ADD  CONSTRAINT [list_list_subgrou_1081] FOREIGN KEY([list_code])
REFERENCES [dbo].[onca_list] ([list_code])
GO
ALTER TABLE [dbo].[onca_list_subgroup_list] CHECK CONSTRAINT [list_list_subgrou_1081]
GO
ALTER TABLE [dbo].[onca_list_subgroup_list]  WITH CHECK ADD  CONSTRAINT [list_subgrou_list_subgrou_1082] FOREIGN KEY([list_subgroup_code])
