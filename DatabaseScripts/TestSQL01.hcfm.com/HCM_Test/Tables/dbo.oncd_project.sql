...
GO
ALTER TABLE [dbo].[oncd_project]  WITH NOCHECK ADD  CONSTRAINT [project_stat_project_975] FOREIGN KEY([project_status_code])
...
GO
ALTER TABLE [dbo].[oncd_project]  WITH NOCHECK ADD  CONSTRAINT [project_type_project_976] FOREIGN KEY([project_type_code])
REFERENCES [dbo].[onca_project_type] ([project_type_code])
GO
ALTER TABLE [dbo].[oncd_project] CHECK CONSTRAINT [project_type_project_976]
GO
ALTER TABLE [dbo].[oncd_project]  WITH NOCHECK ADD  CONSTRAINT [rate_project_977] FOREIGN KEY([rate_code])
REFERENCES [dbo].[onca_rate] ([rate_code])
GO
ALTER TABLE [dbo].[oncd_project] CHECK CONSTRAINT [rate_project_977]
GO
ALTER TABLE [dbo].[oncd_project]  WITH NOCHECK ADD  CONSTRAINT [user_project_946] FOREIGN KEY([created_by_user_code])
REFERENCES [dbo].[onca_user] ([user_code])
GO
ALTER TABLE [dbo].[oncd_project] CHECK CONSTRAINT [user_project_946]
GO
ALTER TABLE [dbo].[oncd_project]  WITH NOCHECK ADD  CONSTRAINT [user_project_947] FOREIGN KEY([updated_by_user_code])
REFERENCES [dbo].[onca_user] ([user_code])
GO
