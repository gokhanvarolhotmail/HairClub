...
GO
ALTER TABLE [dbo].[cstd_company_schedule_by_date_detail]  WITH CHECK ADD  CONSTRAINT [cstd_company_schedule_by_date_cstd_company_schedule_by_date_detail_818] FOREIGN KEY([company_schedule_by_date_id])
...
GO
ALTER TABLE [dbo].[cstd_company_schedule_by_date_detail]  WITH CHECK ADD  CONSTRAINT [onca_user_cstd_company_schedule_by_date_detail_819] FOREIGN KEY([updated_by_user_code])
...
GO
ALTER TABLE [dbo].[cstd_company_schedule_by_date_detail]  WITH CHECK ADD  CONSTRAINT [onca_user_cstd_company_schedule_by_date_detail_820] FOREIGN KEY([created_by_user_code])
REFERENCES [dbo].[onca_user] ([user_code])
GO
