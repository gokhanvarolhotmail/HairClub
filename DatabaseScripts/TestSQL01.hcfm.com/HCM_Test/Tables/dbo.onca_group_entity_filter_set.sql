...
GO
ALTER TABLE [dbo].[onca_group_entity_filter_set]  WITH NOCHECK ADD  CONSTRAINT [entity_filte_group_entity_1157] FOREIGN KEY([entity_filter_set_id])
...
GO
ALTER TABLE [dbo].[onca_group_entity_filter_set]  WITH NOCHECK ADD  CONSTRAINT [group_group_entity_1158] FOREIGN KEY([group_id])
