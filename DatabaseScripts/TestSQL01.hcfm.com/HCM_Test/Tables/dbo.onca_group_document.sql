...
GO
ALTER TABLE [dbo].[onca_group_document]  WITH CHECK ADD  CONSTRAINT [document_gro_group_docume_236] FOREIGN KEY([document_group_id])
...
GO
ALTER TABLE [dbo].[onca_group_document]  WITH CHECK ADD  CONSTRAINT [group_group_docume_233] FOREIGN KEY([group_id])
