...
GO
ALTER TABLE [dbo].[onca_group_security_filter]  WITH NOCHECK ADD  CONSTRAINT [group_group_securi_323] FOREIGN KEY([group_id])
REFERENCES [dbo].[onca_group] ([group_id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[onca_group_security_filter] CHECK CONSTRAINT [group_group_securi_323]
GO
ALTER TABLE [dbo].[onca_group_security_filter]  WITH NOCHECK ADD  CONSTRAINT [security_fil_group_securi_324] FOREIGN KEY([security_filter_id])
