...
GO
ALTER TABLE [dbo].[oncd_contact_note]  WITH NOCHECK ADD  CONSTRAINT [contact_contact_note_68] FOREIGN KEY([contact_id])
REFERENCES [dbo].[oncd_contact] ([contact_id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[oncd_contact_note] CHECK CONSTRAINT [contact_contact_note_68]
GO
ALTER TABLE [dbo].[oncd_contact_note]  WITH NOCHECK ADD  CONSTRAINT [user_contact_note_602] FOREIGN KEY([created_by_user_code])
REFERENCES [dbo].[onca_user] ([user_code])
GO
ALTER TABLE [dbo].[oncd_contact_note] CHECK CONSTRAINT [user_contact_note_602]
GO
ALTER TABLE [dbo].[oncd_contact_note]  WITH NOCHECK ADD  CONSTRAINT [user_contact_note_603] FOREIGN KEY([updated_by_user_code])
REFERENCES [dbo].[onca_user] ([user_code])
GO
