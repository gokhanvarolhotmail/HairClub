...
GO
ALTER TABLE [dbo].[oncs_packet_transaction]  WITH NOCHECK ADD  CONSTRAINT [packet_packet_trans_376] FOREIGN KEY([packet_id])
REFERENCES [dbo].[oncs_packet] ([packet_id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[oncs_packet_transaction] CHECK CONSTRAINT [packet_packet_trans_376]
GO
ALTER TABLE [dbo].[oncs_packet_transaction]  WITH NOCHECK ADD  CONSTRAINT [transaction_packet_trans_377] FOREIGN KEY([transaction_date], [transaction_order])
