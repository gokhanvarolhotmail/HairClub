...
GO
ALTER TABLE [dbo].[onct_registry_entry_layer_data]  WITH NOCHECK ADD  CONSTRAINT [registry_ent_registry_ent_1096] FOREIGN KEY([registry_entry_layer_id])
...
GO
ALTER TABLE [dbo].[onct_registry_entry_layer_data]  WITH NOCHECK ADD  CONSTRAINT [registry_ser_registry_ent_1113] FOREIGN KEY([registry_serializer_id])
