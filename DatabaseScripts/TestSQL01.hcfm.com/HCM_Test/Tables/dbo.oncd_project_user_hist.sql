...
GO
ALTER TABLE [dbo].[oncd_project_user_hist]  WITH NOCHECK ADD  CONSTRAINT [project_revi_project_user_772] FOREIGN KEY([project_revision_id])
...
GO
ALTER TABLE [dbo].[oncd_project_user_hist]  WITH NOCHECK ADD  CONSTRAINT [project_user_project_user_1070] FOREIGN KEY([project_user_role_code])
...
GO
ALTER TABLE [dbo].[oncd_project_user_hist]  WITH NOCHECK ADD  CONSTRAINT [project_user_project_user_1072] FOREIGN KEY([project_user_id])
...
GO
ALTER TABLE [dbo].[oncd_project_user_hist]  WITH NOCHECK ADD  CONSTRAINT [user_project_user_1068] FOREIGN KEY([created_by_user_code])
REFERENCES [dbo].[onca_user] ([user_code])
GO
ALTER TABLE [dbo].[oncd_project_user_hist] CHECK CONSTRAINT [user_project_user_1068]
GO
ALTER TABLE [dbo].[oncd_project_user_hist]  WITH NOCHECK ADD  CONSTRAINT [user_project_user_1069] FOREIGN KEY([updated_by_user_code])
REFERENCES [dbo].[onca_user] ([user_code])
GO
ALTER TABLE [dbo].[oncd_project_user_hist] CHECK CONSTRAINT [user_project_user_1069]
GO
ALTER TABLE [dbo].[oncd_project_user_hist]  WITH NOCHECK ADD  CONSTRAINT [user_project_user_1071] FOREIGN KEY([user_code])
REFERENCES [dbo].[onca_user] ([user_code])
GO
