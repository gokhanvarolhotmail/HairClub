...
GO
ALTER TABLE [dbo].[cstd_corporate_callback_lead_note]  WITH NOCHECK ADD  CONSTRAINT [FK_cstd_corporate_callback_lead_note_created_by_user] FOREIGN KEY([created_by_user_code])
...
GO
ALTER TABLE [dbo].[cstd_corporate_callback_lead_note]  WITH NOCHECK ADD  CONSTRAINT [FK_cstd_corporate_callback_lead_note_cstd_corporate_callback_lead] FOREIGN KEY([corporate_callback_lead_id])
...
GO
ALTER TABLE [dbo].[cstd_corporate_callback_lead_note]  WITH NOCHECK ADD  CONSTRAINT [FK_cstd_corporate_callback_lead_note_updated_by_user] FOREIGN KEY([updated_by_user_code])
REFERENCES [dbo].[onca_user] ([user_code])
GO
