...
GO
ALTER TABLE [dbo].[oncd_recur_note]  WITH CHECK ADD  CONSTRAINT [recur_recur_note_211] FOREIGN KEY([recur_id])
REFERENCES [dbo].[oncd_recur] ([recur_id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[oncd_recur_note] CHECK CONSTRAINT [recur_recur_note_211]
GO
ALTER TABLE [dbo].[oncd_recur_note]  WITH CHECK ADD  CONSTRAINT [user_recur_note_488] FOREIGN KEY([created_by_user_code])
REFERENCES [dbo].[onca_user] ([user_code])
GO
ALTER TABLE [dbo].[oncd_recur_note] CHECK CONSTRAINT [user_recur_note_488]
GO
ALTER TABLE [dbo].[oncd_recur_note]  WITH CHECK ADD  CONSTRAINT [user_recur_note_489] FOREIGN KEY([updated_by_user_code])
REFERENCES [dbo].[onca_user] ([user_code])
GO
