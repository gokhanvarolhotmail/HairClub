...
GO
ALTER TABLE [dbo].[onct_registry_entry]  WITH NOCHECK ADD  CONSTRAINT [registry_cat_registry_ent_1175] FOREIGN KEY([registry_category_id])
...
GO
ALTER TABLE [dbo].[onct_registry_entry]  WITH NOCHECK ADD  CONSTRAINT [registry_ent_registry_ent_1145] FOREIGN KEY([registry_entry_group_code])
...
GO
ALTER TABLE [dbo].[onct_registry_entry]  WITH NOCHECK ADD  CONSTRAINT [registry_pro_registry_ent_1176] FOREIGN KEY([registry_project_template_id])
