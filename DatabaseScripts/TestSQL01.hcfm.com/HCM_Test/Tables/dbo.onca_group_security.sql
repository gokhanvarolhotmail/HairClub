...
GO
ALTER TABLE [dbo].[onca_group_security]  WITH NOCHECK ADD  CONSTRAINT [group_group_securi_248] FOREIGN KEY([group_id])
REFERENCES [dbo].[onca_group] ([group_id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[onca_group_security] CHECK CONSTRAINT [group_group_securi_248]
GO
ALTER TABLE [dbo].[onca_group_security]  WITH NOCHECK ADD  CONSTRAINT [security_gro_group_securi_249] FOREIGN KEY([security_group_id])
