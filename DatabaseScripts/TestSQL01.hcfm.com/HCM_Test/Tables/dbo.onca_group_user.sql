...
GO
ALTER TABLE [dbo].[onca_group_user]  WITH NOCHECK ADD  CONSTRAINT [group_group_user_229] FOREIGN KEY([group_id])
REFERENCES [dbo].[onca_group] ([group_id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[onca_group_user] CHECK CONSTRAINT [group_group_user_229]
GO
ALTER TABLE [dbo].[onca_group_user]  WITH NOCHECK ADD  CONSTRAINT [user_group_user_228] FOREIGN KEY([user_code])
