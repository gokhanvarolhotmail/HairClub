/* CreateDate: 03/31/2015 09:42:48.410 , ModifyDate: 04/14/2015 16:25:58.787 */
GO
/*
==============================================================================
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_Xtrand6_Step4_CalculateDeferredRevenue]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_Xtrand6_Step4_CalculateDeferredRevenue](@Month DATETIME)
AS
BEGIN
	SET NOCOUNT ON
	...
	BEGIN
		...
		WHERE ClientMembershipKey = @CurrentClientMembershipKey
			AND SalesCodeKey IN ( 1724 ) -- Xtrand Service Code
		...
		IF (@CurrentMembershipCancelledFlag = 1)
			...
			OR (@CurrentMonthsFromSale >= 4 AND @CurrentInitialApplicationDate IS NULL) -- Change to 6 months
			BEGIN
