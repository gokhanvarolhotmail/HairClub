/* CreateDate: 02/08/2022 11:21:44.437 , ModifyDate: 02/08/2022 11:21:44.437 */
GO
/*
==============================================================================
...
==============================================================================
DESCRIPTION:	Create NB - Xtrand 6 membership headers
==============================================================================
NOTES:

==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_Xtrand6_Step1_CreateHeader] '1/1/11'
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_Xtrand6_Step1_CreateHeader] (@Month DATETIME)
AS
BEGIN
	SET NOCOUNT ON
	...
	WHERE DD.FullDate BETWEEN @StartDate AND @EndDate
		AND FST.NB_XTRCnt > 0
		AND CASE WHEN CONVERT(INT, RIGHT(CM1.ClientMembershipIdentifier, 2)) > CONVERT(INT, RIGHT(CM2.ClientMembershipIdentifier, 2)) THEN M1.MembershipKey ELSE M2.MembershipKey END IN ( 122, 124 )
