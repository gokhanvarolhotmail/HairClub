/* CreateDate: 12/07/2012 14:41:57.647 , ModifyDate: 04/02/2015 14:20:17.233 */
GO
/*
==============================================================================

PROCEDURE:				[spSVC_CreateDetails_Extreme]
...
==============================================================================
DESCRIPTION:	Create NB - Extreme membership details
==============================================================================
NOTES:
	06/10/2013 - MB - Removed Canadian conversion function
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CreateDetails_Extreme] '1/1/11'
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_Extreme_Step2_CreateDetails] (@Month DATETIME)
AS
BEGIN
	SET NOCOUNT ON
	...
	WHERE DRH.DeferredRevenueTypeID = @DeferredRevenueTypeID
		...
		AND (FST.NB_ExtCnt <> 0
			OR FST.NB_ExtAmt <> 0
			OR FST.SalesCodeKey IN (632, 475))
		AND FST.SalesCodeKey NOT IN (637, 638, 1731)
	...
	BEGIN
		...
		BEGIN
			...
			,	UpdateDate = GETDATE()
			,	UpdateUser = 'spSVC_Extreme_Step2_CreateDetails'
