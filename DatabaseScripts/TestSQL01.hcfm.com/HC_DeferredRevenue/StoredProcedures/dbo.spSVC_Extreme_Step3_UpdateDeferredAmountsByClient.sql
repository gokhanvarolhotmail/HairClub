/* CreateDate: 12/10/2012 13:24:43.710 , ModifyDate: 08/01/2014 15:45:16.283 */
GO
SET ANSI_NULLS ON
GO
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_Extreme_Step3_UpdateDeferredAmountsByClient] '1/1/11'
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_Extreme_Step3_UpdateDeferredAmountsByClient] (@Month DATETIME)
AS
BEGIN
	SET NOCOUNT ON
