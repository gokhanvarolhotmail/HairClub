/* CreateDate: 02/08/2022 11:21:40.483 , ModifyDate: 02/08/2022 11:21:40.483 */
GO
/*
==============================================================================

PROCEDURE:				[spSVC_CreateHeader_Extreme]
...
==============================================================================
DESCRIPTION:	Create NB - Extreme membership headers
==============================================================================
NOTES:
	06/11/2013 - MB - Changed procedure to use the actual membership duration
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CreateHeader_Extreme] '6/15/11'
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_Extreme_Step1_CreateHeader] (@Month DATETIME)
AS
BEGIN
	SET NOCOUNT ON
	...
	WHERE DD.FullDate BETWEEN @StartDate AND @EndDate
		...
		AND CASE WHEN CONVERT(INT, RIGHT(CM1.ClientMembershipIdentifier, 2)) > CONVERT(INT, RIGHT(CM2.ClientMembershipIdentifier, 2)) THEN M1.MembershipKey ELSE M2.MembershipKey END IN (59, 60, 61, 62, 106, 131)
