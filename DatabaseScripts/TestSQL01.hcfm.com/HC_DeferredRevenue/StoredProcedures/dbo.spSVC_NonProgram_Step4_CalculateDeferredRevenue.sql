/* CreateDate: 02/08/2022 11:21:42.540 , ModifyDate: 02/08/2022 11:21:42.540 */
GO
/*
==============================================================================
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_NonProgram_Step4_CalculateDeferredRevenue]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_NonProgram_Step4_CalculateDeferredRevenue](@Month DATETIME)
AS
BEGIN
	SET NOCOUNT ON
