/* CreateDate: 12/31/2010 13:21:07.037 , ModifyDate: 02/27/2017 09:49:30.147 */
GO
/***********************************************************************

PROCEDURE:				rptREDOAndRepairAnalysisDetail
...
EXEC rptREDOAndRepairAnalysisDetail NULL, NULL, '100,201','10,21,35','1,2,3,4,5,6,7', 1, NULL, NULL, NULL

***********************************************************************/

CREATE PROCEDURE [dbo].[rptREDOAndRepairAnalysisDetail]
	@StartDate datetime = NULL,
	@EndDate datetime = NULL,
	@CenterIDs nvarchar(MAX),
	@MembershipIDs nvarchar(MAX),
	@HairSystemIDs nvarchar(MAX),
	@IsRedoOrder bit = NULL,
	@IsRepairOrder bit = NULL,
...
BEGIN
	...
	WHERE hso.HairSystemOrderDate BETWEEN @StartDate AND @EndDate
		...
		AND (@IsRedoOrder IS NULL OR hso.IsRedoOrderFlag = 1)
		AND (@IsRepairOrder IS NULL  OR hso.IsRepairOrderFlag = 1)
	ORDER BY c.ClientFullNameCalc, hso.ClientHomeCenterID, hso.HairSystemOrderDate, m.MembershipSortOrder, hs.HairSystemSortOrder, emp.EmployeeFullNameCalc, emp2.EmployeeFullNameCalc
