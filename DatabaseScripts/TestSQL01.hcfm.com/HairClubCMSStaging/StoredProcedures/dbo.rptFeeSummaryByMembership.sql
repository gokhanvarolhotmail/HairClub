/* CreateDate: 05/14/2012 17:34:46.640 , ModifyDate: 02/27/2017 09:49:27.340 */
GO
SET ANSI_NULLS ON
GO
...
PROCEDURE:				rptFeeSummaryByMembership
...
rptFeeSummaryByMembership 1, 8, 2011, 203

***********************************************************************/
CREATE PROCEDURE [dbo].[rptFeeSummaryByMembership]
...
BEGIN
	...
	INSERT INTO @ClientEFTStatus (ClientEFTGUID, Amount, MembershipDescription, IsProfileExpired, IsProfileFrozen, IsCreditCardExpired, IsMembershipExpired)
		SELECT
			c.ClientEFTGUID,
