/* CreateDate: 06/19/2013 23:57:22.487 , ModifyDate: 06/19/2013 23:57:22.487 */
GO
/***********************************************************************

PROCEDURE:				rptDeclineSummaryByAccountType
...
--------------------------------------------------------------------------------------------------------
NOTES: 	Return EFT summary by Account Type for Decline RunDate
...
rptDeclineSummaryByAccountType '6/17/13', 201

***********************************************************************/
CREATE PROCEDURE [dbo].[rptDeclineSummaryByAccountType]
	@DeclineBatchDate DateTime,
	@centerId as int
AS
BEGIN
	...
	INSERT INTO @ClientEFTStatus (ClientEFTGUID, AccountTypeId, Amount, MembershipDescription, IsProfileExpired, IsProfileFrozen, IsCreditCardExpired, IsMembershipExpired, IsFeeAmountZero)
		SELECT
			c.ClientEFTGUID,
			c.EFTAccountTypeId,
