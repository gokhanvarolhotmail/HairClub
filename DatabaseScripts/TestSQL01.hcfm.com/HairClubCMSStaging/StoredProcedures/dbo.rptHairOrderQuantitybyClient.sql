...
EXEC [rptHairOrderQuantitybyClient] 212, '36'

EXEC [rptHairOrderQuantitybyClient] 212, '26,27,28,29,30,31,45,46,47,48'
...
BEGIN
	...
	BEGIN
		...
		FROM datClient clt
			...
			INNER JOIN datHairSystemOrder hso ON hso.ClientGUID = clt.ClientGUID
