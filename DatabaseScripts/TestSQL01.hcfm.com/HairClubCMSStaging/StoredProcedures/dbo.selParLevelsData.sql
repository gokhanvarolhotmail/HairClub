/* CreateDate: 12/07/2020 07:57:57.430 , ModifyDate: 12/21/2020 07:17:51.727 */
GO
/***********************************************************************
...
BEGIN
  ...
  BEGIN TRY
	...
	INNER JOIN cfgcenter c on c.centerid = sci.Centerid
	...
	wHERE sci.centerid = @CenterID  --and sci.QuantityOnHand<>0
