/* CreateDate: 05/01/2018 17:41:20.690 , ModifyDate: 05/13/2019 08:51:48.757 */
GO
/***********************************************************************
...
NOTES: 	Return data to populate Factory Order report for either a single Hair System Order or all
	...
	* 04/05/2019 RH  - Added IsSignatureHairlineAddOn; Removed IsBleachOrderFlag
--------------------------------------------------------------------------------------------------------

SAMPLE EXECUTION:

EXEC rptHairSystemOrder_HW NULL, 'F680DF15-B4C8-4BCE-9AC9-3000BAE5E5B6', NULL, 0
EXEC rptHairSystemOrder_HW NULL, '9D1E14D3-62BD-4DC7-BF0E-DBA0C4A1BD54', NULL, 0
EXEC rptHairSystemOrder_HW '14AFCAB7-623E-42A4-8692-358E69C40643', NULL, NULL, 1

***********************************************************************/

CREATE PROCEDURE [dbo].[rptHairSystemOrder_HW]
