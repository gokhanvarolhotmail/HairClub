/* CreateDate: 09/10/2018 10:59:19.700 , ModifyDate: 02/01/2022 10:53:59.700 */
GO
CREATE VIEW [dbo].[vw_SerializedInventoryData]
AS
/*
https://hairclub.zendesk.com/agent/tickets/13996
Added RegionDescription
*/
SELECT
    [ctr].[CenterNumber]
...
LEFT JOIN [dbo].[lkpRegion] AS [a] ON [a].[RegionID] = [ctr].[RegionID]
