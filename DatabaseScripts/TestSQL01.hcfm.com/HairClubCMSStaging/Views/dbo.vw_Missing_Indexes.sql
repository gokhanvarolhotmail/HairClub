/* CreateDate: 01/19/2022 10:37:59.667 , ModifyDate: 01/19/2022 11:06:04.797 */
GO
CREATE view [dbo].[vw_Missing_Indexes] as
SELECT
UPPER(DB_Name()) as 'DATABASE',
DB_NAME(SQLOPS_MsgIdxDetails.database_id) as DatabaseName,
Object_Name(SQLOPS_MsgIdxDetails.object_id) as 'OBJECT NAME',
Schema_Name(SQLOPS_SysObj.schema_id) as 'SCHEMA NAME',
'CREATE INDEX SQLOPS_'+
