/* CreateDate: 06/10/2019 06:44:57.810 , ModifyDate: 06/10/2019 06:44:57.900 */
GO
...
GO
ALTER TABLE [dbo].[datStyleBookStyleBookHairLength]  WITH NOCHECK ADD  CONSTRAINT [FK_datStyleBookStyleBookHairLength_datStyleBook] FOREIGN KEY([StyleBookID])
...
GO
ALTER TABLE [dbo].[datStyleBookStyleBookHairLength]  WITH NOCHECK ADD  CONSTRAINT [FK_datStyleBookStyleBookHairLength_lkpStyleBookHairLength] FOREIGN KEY([StyleBookHairLengthID])
