/* CreateDate: 08/27/2008 11:39:37.957 , ModifyDate: 05/26/2020 10:49:40.080 */
GO
...
GO
ALTER TABLE [dbo].[lkpDeveloperVolume]  WITH NOCHECK ADD  CONSTRAINT [FK_lkpDeveloperVolume_lkpColorBrand] FOREIGN KEY([ColorBrandID])
