/* CreateDate: 02/03/2014 08:50:42.613 , ModifyDate: 05/26/2020 10:49:45.233 */
GO
SET ANSI_NULLS ON
GO
...
GO
ALTER TABLE [dbo].[datInterCompanyTransaction]  WITH CHECK ADD  CONSTRAINT [FK_datInterCompanyTransaction_cfgCenter] FOREIGN KEY([CenterId])
REFERENCES [dbo].[cfgCenter] ([CenterID])
GO
ALTER TABLE [dbo].[datInterCompanyTransaction] CHECK CONSTRAINT [FK_datInterCompanyTransaction_cfgCenter]
GO
ALTER TABLE [dbo].[datInterCompanyTransaction]  WITH CHECK ADD  CONSTRAINT [FK_datInterCompanyTransaction_cfgCenter1] FOREIGN KEY([ClientHomeCenterId])
REFERENCES [dbo].[cfgCenter] ([CenterID])
GO
ALTER TABLE [dbo].[datInterCompanyTransaction] CHECK CONSTRAINT [FK_datInterCompanyTransaction_cfgCenter1]
GO
ALTER TABLE [dbo].[datInterCompanyTransaction]  WITH CHECK ADD  CONSTRAINT [FK_datInterCompanyTransaction_datAppointment] FOREIGN KEY([AppointmentGUID])
...
GO
ALTER TABLE [dbo].[datInterCompanyTransaction]  WITH CHECK ADD  CONSTRAINT [FK_datInterCompanyTransaction_datClient] FOREIGN KEY([ClientGUID])
REFERENCES [dbo].[datClient] ([ClientGUID])
GO
ALTER TABLE [dbo].[datInterCompanyTransaction] CHECK CONSTRAINT [FK_datInterCompanyTransaction_datClient]
GO
ALTER TABLE [dbo].[datInterCompanyTransaction]  WITH CHECK ADD  CONSTRAINT [FK_datInterCompanyTransaction_datClientMembership] FOREIGN KEY([ClientMembershipGUID])
...
GO
ALTER TABLE [dbo].[datInterCompanyTransaction]  WITH CHECK ADD  CONSTRAINT [FK_datInterCompanyTransaction_datSalesOrder] FOREIGN KEY([SalesOrderGUID])
