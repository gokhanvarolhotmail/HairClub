/* CreateDate: 02/18/2013 06:49:02.443 , ModifyDate: 05/26/2020 10:49:09.227 */
GO
...
GO
ALTER TABLE [dbo].[cfgCenterMembershipPromotion]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgCenterMembershipPromotion_cfgCenter] FOREIGN KEY([CenterId])
REFERENCES [dbo].[cfgCenter] ([CenterID])
GO
ALTER TABLE [dbo].[cfgCenterMembershipPromotion] CHECK CONSTRAINT [FK_cfgCenterMembershipPromotion_cfgCenter]
GO
ALTER TABLE [dbo].[cfgCenterMembershipPromotion]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgCenterMembershipPromotion_cfgMembershipPromotion] FOREIGN KEY([MembershipPromotionId])
