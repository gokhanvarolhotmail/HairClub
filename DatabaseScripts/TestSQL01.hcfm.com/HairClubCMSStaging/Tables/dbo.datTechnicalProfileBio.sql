/* CreateDate: 02/26/2017 22:35:10.350 , ModifyDate: 05/26/2020 10:49:45.793 */
GO
...
GO
ALTER TABLE [dbo].[datTechnicalProfileBio]  WITH NOCHECK ADD  CONSTRAINT [FK_datTechnicalProfileBio_cfgHairSystem] FOREIGN KEY([HairSystemID])
...
GO
ALTER TABLE [dbo].[datTechnicalProfileBio]  WITH NOCHECK ADD  CONSTRAINT [FK_datTechnicalProfileBio_cfgSalesCode] FOREIGN KEY([OtherServiceSalesCodeID])
...
GO
ALTER TABLE [dbo].[datTechnicalProfileBio]  WITH NOCHECK ADD  CONSTRAINT [FK_datTechnicalProfileBio_datTechnicalProfile] FOREIGN KEY([TechnicalProfileID])
...
GO
ALTER TABLE [dbo].[datTechnicalProfileBio]  WITH NOCHECK ADD  CONSTRAINT [FK_datTechnicalProfileBio_lkpAdhesiveFront1] FOREIGN KEY([AdhesiveFront1ID])
...
GO
ALTER TABLE [dbo].[datTechnicalProfileBio]  WITH NOCHECK ADD  CONSTRAINT [FK_datTechnicalProfileBio_lkpAdhesiveFront2] FOREIGN KEY([AdhesiveFront2ID])
REFERENCES [dbo].[lkpAdhesiveFront] ([AdhesiveFrontID])
GO
ALTER TABLE [dbo].[datTechnicalProfileBio] CHECK CONSTRAINT [FK_datTechnicalProfileBio_lkpAdhesiveFront2]
GO
ALTER TABLE [dbo].[datTechnicalProfileBio]  WITH NOCHECK ADD  CONSTRAINT [FK_datTechnicalProfileBio_lkpAdhesivePerimeter1] FOREIGN KEY([AdhesivePerimeter1ID])
...
GO
ALTER TABLE [dbo].[datTechnicalProfileBio]  WITH NOCHECK ADD  CONSTRAINT [FK_datTechnicalProfileBio_lkpAdhesivePerimeter2] FOREIGN KEY([AdhesivePerimeter2ID])
REFERENCES [dbo].[lkpAdhesivePerimeter] ([AdhesivePerimeterID])
GO
ALTER TABLE [dbo].[datTechnicalProfileBio] CHECK CONSTRAINT [FK_datTechnicalProfileBio_lkpAdhesivePerimeter2]
GO
ALTER TABLE [dbo].[datTechnicalProfileBio]  WITH NOCHECK ADD  CONSTRAINT [FK_datTechnicalProfileBio_lkpAdhesivePerimeter3] FOREIGN KEY([AdhesivePerimeter3ID])
REFERENCES [dbo].[lkpAdhesivePerimeter] ([AdhesivePerimeterID])
GO
ALTER TABLE [dbo].[datTechnicalProfileBio] CHECK CONSTRAINT [FK_datTechnicalProfileBio_lkpAdhesivePerimeter3]
GO
ALTER TABLE [dbo].[datTechnicalProfileBio]  WITH NOCHECK ADD  CONSTRAINT [FK_datTechnicalProfileBio_lkpAdhesiveSolvent] FOREIGN KEY([AdhesiveSolventID])
...
GO
ALTER TABLE [dbo].[datTechnicalProfileBio]  WITH NOCHECK ADD  CONSTRAINT [FK_datTechnicalProfileBio_lkpRemovalProcess] FOREIGN KEY([RemovalProcessID])
...
GO
ALTER TABLE [dbo].[datTechnicalProfileBio]  WITH NOCHECK ADD  CONSTRAINT [FK_datTechnicalProfileBio_lkpTimeUnit] FOREIGN KEY([ApplicationTimeUnitID])
...
GO
ALTER TABLE [dbo].[datTechnicalProfileBio]  WITH NOCHECK ADD  CONSTRAINT [FK_datTechnicalProfileBio_lkpTimeUnit1] FOREIGN KEY([FullServiceTimeUnitID])
REFERENCES [dbo].[lkpTimeUnit] ([TimeUnitID])
GO
ALTER TABLE [dbo].[datTechnicalProfileBio] CHECK CONSTRAINT [FK_datTechnicalProfileBio_lkpTimeUnit1]
GO
ALTER TABLE [dbo].[datTechnicalProfileBio]  WITH NOCHECK ADD  CONSTRAINT [FK_datTechnicalProfileBio_lkpTimeUnit2] FOREIGN KEY([OtherServiceTimeUnitID])
REFERENCES [dbo].[lkpTimeUnit] ([TimeUnitID])
GO
