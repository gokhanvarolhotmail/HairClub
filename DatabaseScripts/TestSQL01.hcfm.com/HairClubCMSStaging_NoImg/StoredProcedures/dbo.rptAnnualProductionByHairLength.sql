/* CreateDate: 10/04/2010 12:09:07.907 , ModifyDate: 02/27/2017 09:49:24.127 */
GO
/*
==============================================================================
PROCEDURE:				[rptAnnualProductionByHairLength]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [rptAnnualProductionByHairLength] '9/1/09', '9/16/09'
==============================================================================
*/
CREATE PROCEDURE [dbo].[rptAnnualProductionByHairLength]
	@StartDate DATETIME
,	@EndDate DATETIME
AS
BEGIN
