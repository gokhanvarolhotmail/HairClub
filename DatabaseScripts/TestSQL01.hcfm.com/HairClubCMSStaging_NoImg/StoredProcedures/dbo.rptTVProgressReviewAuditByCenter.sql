/* CreateDate: 02/27/2017 08:33:22.203 , ModifyDate: 12/07/2018 09:45:59.023 */
GO
SET ANSI_NULLS ON
GO
...
GO
/*===============================================================================================
 Procedure Name:            rptTVProgressReviewAuditByCenter
...
EXEC [rptTVProgressReviewAuditByCenter] 230
================================================================================================*/

CREATE PROCEDURE [dbo].[rptTVProgressReviewAuditByCenter](
	@CenterID INT
)
