/* CreateDate: 02/18/2013 07:43:35.583 , ModifyDate: 03/15/2017 15:38:22.640 */
GO
SET ANSI_NULLS ON
GO
...
GO
/*===============================================================================================
 Procedure Name:            rptAppointment2
...
EXEC rptAppointment2 232,'01/06/2017','01/08/2017','549E4F5D-4985-4F13-A5D8-1989CFDEC840','4C6E44A3-3688-4787-8EC2-D12D30B9F174'
EXEC rptAppointment2 240,'02/28/2017','02/28/2017',NULL,NULL
EXEC rptAppointment2 240,'02/28/2017','02/28/2017',NULL, '6C6EEF10-7601-415F-97CB-A4DBBC834912' --Vemireddy, Avinash (540849) 240 --Nolden, Heather EXT
EXEC rptAppointment2 240,'02/28/2017','02/28/2017',NULL, 'F3E3DA71-7AAA-4D0A-BC9D-09B8E812E2E9' --Charpenter, Claudette (539335) 240 --Nolden, Heather XTR
EXEC rptAppointment2 201,'1/19/2017','1/19/2017','6C43ABEF-96FE-42DA-A7D7-D58709E1109C',NULL

EXEC rptAppointment2 201,'12/14/2016','12/14/2016',NULL,'6477A897-9050-47A6-B8C2-C9A71E9F12F5'

================================================================================================*/

CREATE PROCEDURE [dbo].[rptAppointment2]
	@CenterID INT
	,	@StartDate DATETIME
	,	@EndDate DATETIME
...
SELECT
	...
	,	sns.TotalAccumQuantity SNSTotal
	,	sns.UsedAccumQuantity SNSUsed
...
,	EXT.TechnicalProfileID AS 'EXTTechnicalProfileID'
,	XTR.TechnicalProfileID AS 'XTRTechnicalProfileID'
...
GROUP BY ap.AppointmentGUID
	...
	,	EXT.TechnicalProfileID
	,	XTR.TechnicalProfileID
