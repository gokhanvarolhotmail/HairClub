/* CreateDate: 02/14/2022 08:28:01.200 , ModifyDate: 02/14/2022 08:28:01.200 */
GO
...
;with cte_Centers as(
		...
		FROM    HC_BI_ENT_DDS.bi_ent_dds.DimCenter DC WITH (NOLOCK)
				INNER JOIN HC_BI_ENT_DDS.bi_ent_dds.DimCenterType DCT WITH (NOLOCK)
					ON DC.CenterTypeKey = DCT.CenterTypeKey
				INNER JOIN HC_BI_ENT_DDS.bi_ent_dds.DimRegion DR WITH (NOLOCK)
	...
	FROM HC_BI_MKTG_DDS.bi_mktg_dds.vwFactActivityResults far WITH (NOLOCK)
		...
		inner join HC_BI_ENT_DDS.bi_ent_dds.vwDimDate dd WITH (NOLOCK)
	...
	FROM HC_BI_MKTG_DDS.bi_mktg_dds.vwFactLead fl WITH (NOLOCK)
		inner join cte_Centers ctr
