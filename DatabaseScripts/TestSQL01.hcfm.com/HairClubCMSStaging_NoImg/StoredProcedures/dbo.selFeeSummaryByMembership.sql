/* CreateDate: 05/14/2012 17:40:57.953 , ModifyDate: 02/11/2021 17:50:19.493 */
GO
SET ANSI_NULLS ON
GO
...
PROCEDURE:				selFeeSummaryByMembership
...
NOTES: 	Return EFT summary by Membership for the specified Pay Cycle, Month, Year, and Center for the specified month.
		...
		04/02/2019 - JLM: Update add-on fee amount logic. (TFS #12202)
...
selFeeSummaryByMembership 2, 02, 2019, 201

***********************************************************************/
CREATE PROCEDURE [dbo].[selFeeSummaryByMembership]
...
BEGIN
	...
	INSERT INTO @ClientEFTStatus (ClientEFTGUID, Amount, AddOnAmount, MembershipDescription, MembershipId, IsProfileExpired, IsProfileFrozen, IsCreditCardExpired, IsMembershipExpired, IsFeeAmountZero)
		SELECT
			c.ClientEFTGUID,
