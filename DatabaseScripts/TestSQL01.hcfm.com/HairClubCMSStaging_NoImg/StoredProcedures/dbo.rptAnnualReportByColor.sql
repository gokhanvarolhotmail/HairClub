/* CreateDate: 04/24/2012 13:04:08.450 , ModifyDate: 02/27/2017 09:49:24.720 */
GO
SET ANSI_NULLS ON
GO
...
/*
==============================================================================
PROCEDURE:				[rptAnnualReportByColor]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [rptAnnualReportByColor] '9/1/09', '9/16/09'
==============================================================================
*/

CREATE PROCEDURE [dbo].[rptAnnualReportByColor]
	@StartDate DATETIME
,	@EndDate DATETIME
AS
BEGIN
