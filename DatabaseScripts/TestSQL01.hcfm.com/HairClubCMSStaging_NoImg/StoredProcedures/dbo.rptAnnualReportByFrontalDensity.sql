/* CreateDate: 04/24/2012 13:04:18.593 , ModifyDate: 02/27/2017 09:49:24.947 */
GO
SET ANSI_NULLS ON
GO
...
/*
==============================================================================
PROCEDURE:				[rptAnnualReportByFrontalDensity]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [rptAnnualReportByFrontalDensity] '9/1/09', '9/16/09'
==============================================================================
*/

CREATE PROCEDURE [dbo].[rptAnnualReportByFrontalDensity]
	@StartDate DATETIME
,	@EndDate DATETIME
AS
BEGIN
