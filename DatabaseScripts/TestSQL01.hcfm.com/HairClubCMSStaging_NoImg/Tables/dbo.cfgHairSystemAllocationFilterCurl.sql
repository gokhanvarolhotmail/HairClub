/* CreateDate: 10/04/2010 12:08:45.350 , ModifyDate: 12/03/2021 10:24:48.627 */
GO
...
GO
ALTER TABLE [dbo].[cfgHairSystemAllocationFilterCurl]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgHairSystemAllocationFilterCurl_cfgVendor] FOREIGN KEY([VendorID])
...
GO
ALTER TABLE [dbo].[cfgHairSystemAllocationFilterCurl]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgHairSystemAllocationFilterCurl_lkpHairSystemCurl] FOREIGN KEY([HairSystemCurlID])
