/* CreateDate: 07/15/2008 12:59:04.427 , ModifyDate: 12/03/2021 10:24:48.693 */
GO
...
GO
ALTER TABLE [dbo].[datEmployeeVisitCenter]  WITH NOCHECK ADD  CONSTRAINT [FK_datEmployeeCenter_cfgCenter] FOREIGN KEY([CenterID])
REFERENCES [dbo].[cfgCenter] ([CenterID])
GO
ALTER TABLE [dbo].[datEmployeeVisitCenter] CHECK CONSTRAINT [FK_datEmployeeCenter_cfgCenter]
GO
ALTER TABLE [dbo].[datEmployeeVisitCenter]  WITH NOCHECK ADD  CONSTRAINT [FK_datEmployeeCenter_datEmployee] FOREIGN KEY([EmployeeGUID])
