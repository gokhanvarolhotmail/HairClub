...
GO
ALTER TABLE [dbo].[cfgSalesCodeDistributor]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgSalesCodeDistributor_cfgCenter] FOREIGN KEY([CenterID])
REFERENCES [dbo].[cfgCenter] ([CenterID])
GO
ALTER TABLE [dbo].[cfgSalesCodeDistributor] CHECK CONSTRAINT [FK_cfgSalesCodeDistributor_cfgCenter]
GO
ALTER TABLE [dbo].[cfgSalesCodeDistributor]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgSalesCodeDistributor_cfgSalesCode] FOREIGN KEY([SalesCodeID])
