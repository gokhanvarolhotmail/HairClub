/* CreateDate: 05/14/2012 17:29:33.110 , ModifyDate: 12/03/2021 10:24:48.533 */
GO
...
GO
ALTER TABLE [dbo].[datClientAddress]  WITH NOCHECK ADD  CONSTRAINT [FK_datClientAddress_datClient] FOREIGN KEY([ClientGUID])
REFERENCES [dbo].[datClient] ([ClientGUID])
GO
ALTER TABLE [dbo].[datClientAddress] CHECK CONSTRAINT [FK_datClientAddress_datClient]
GO
ALTER TABLE [dbo].[datClientAddress]  WITH NOCHECK ADD  CONSTRAINT [FK_datClientAddress_datClient1] FOREIGN KEY([ClientGUID])
REFERENCES [dbo].[datClient] ([ClientGUID])
GO
ALTER TABLE [dbo].[datClientAddress] CHECK CONSTRAINT [FK_datClientAddress_datClient1]
GO
ALTER TABLE [dbo].[datClientAddress]  WITH NOCHECK ADD  CONSTRAINT [FK_datClientAddress_lkpClientAddressType] FOREIGN KEY([ClientAddressTypeID])
...
GO
ALTER TABLE [dbo].[datClientAddress]  WITH NOCHECK ADD  CONSTRAINT [FK_datClientAddress_lkpCountry] FOREIGN KEY([CountryID])
REFERENCES [dbo].[lkpCountry] ([CountryID])
GO
ALTER TABLE [dbo].[datClientAddress] CHECK CONSTRAINT [FK_datClientAddress_lkpCountry]
GO
ALTER TABLE [dbo].[datClientAddress]  WITH NOCHECK ADD  CONSTRAINT [FK_datClientAddress_lkpState] FOREIGN KEY([StateID])
