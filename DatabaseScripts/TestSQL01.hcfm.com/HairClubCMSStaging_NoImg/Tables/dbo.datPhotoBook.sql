/* CreateDate: 05/21/2017 22:29:10.503 , ModifyDate: 08/17/2020 09:11:05.617 */
GO
...
GO
ALTER TABLE [dbo].[datPhotoBook]  WITH NOCHECK ADD  CONSTRAINT [FK_datPhotoBook_cfgCenter] FOREIGN KEY([CenterID])
REFERENCES [dbo].[cfgCenter] ([CenterID])
GO
ALTER TABLE [dbo].[datPhotoBook] CHECK CONSTRAINT [FK_datPhotoBook_cfgCenter]
GO
ALTER TABLE [dbo].[datPhotoBook]  WITH NOCHECK ADD  CONSTRAINT [FK_datPhotoBook_lkpBusinessSegment] FOREIGN KEY([BusinessSegmentID])
...
GO
ALTER TABLE [dbo].[datPhotoBook]  WITH NOCHECK ADD  CONSTRAINT [FK_datPhotoBook_lkpGender] FOREIGN KEY([GenderID])
