/* CreateDate: 01/21/2014 23:49:41.730 , ModifyDate: 12/03/2021 10:24:48.673 */
GO
...
GO
ALTER TABLE [dbo].[cfgHairSystemHighLightJoin]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgHairSystemHighLightJoin_cfgHairSystem] FOREIGN KEY([HairSystemID])
...
GO
ALTER TABLE [dbo].[cfgHairSystemHighLightJoin]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgHairSystemHighLightJoin_lkpHairSystemHighLight] FOREIGN KEY([HairSystemHighLightID])
