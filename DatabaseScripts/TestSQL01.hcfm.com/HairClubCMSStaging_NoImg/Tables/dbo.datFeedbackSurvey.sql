...
GO
ALTER TABLE [dbo].[datFeedbackSurvey]  WITH NOCHECK ADD  CONSTRAINT [FK_datFeedbackSurvey_datAppointment] FOREIGN KEY([AppointmentGUID])
...
GO
ALTER TABLE [dbo].[datFeedbackSurvey]  WITH NOCHECK ADD  CONSTRAINT [FK_datFeedbackSurvey_datClient] FOREIGN KEY([ClientGUID])
