...
GO
ALTER TABLE [dbo].[cfgEntity]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgEntity_lkpCountry] FOREIGN KEY([CountryID])
REFERENCES [dbo].[lkpCountry] ([CountryID])
GO
ALTER TABLE [dbo].[cfgEntity] CHECK CONSTRAINT [FK_cfgEntity_lkpCountry]
GO
ALTER TABLE [dbo].[cfgEntity]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgEntity_lkpPhone1Type] FOREIGN KEY([Phone1TypeID])
REFERENCES [dbo].[lkpPhoneType] ([PhoneTypeID])
GO
ALTER TABLE [dbo].[cfgEntity] CHECK CONSTRAINT [FK_cfgEntity_lkpPhone1Type]
GO
ALTER TABLE [dbo].[cfgEntity]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgEntity_lkpPhone2Type] FOREIGN KEY([Phone2TypeID])
REFERENCES [dbo].[lkpPhoneType] ([PhoneTypeID])
GO
ALTER TABLE [dbo].[cfgEntity] CHECK CONSTRAINT [FK_cfgEntity_lkpPhone2Type]
GO
ALTER TABLE [dbo].[cfgEntity]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgEntity_lkpPhone3Type] FOREIGN KEY([Phone3TypeID])
REFERENCES [dbo].[lkpPhoneType] ([PhoneTypeID])
GO
ALTER TABLE [dbo].[cfgEntity] CHECK CONSTRAINT [FK_cfgEntity_lkpPhone3Type]
GO
ALTER TABLE [dbo].[cfgEntity]  WITH NOCHECK ADD  CONSTRAINT [FK_cfgEntity_lkpState] FOREIGN KEY([StateID])
