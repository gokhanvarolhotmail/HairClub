/* CreateDate: 01/20/2017 15:40:37.173 , ModifyDate: 01/20/2017 15:40:37.173 */
GO
/*
==============================================================================
...
BEGIN TRANSACTION
      ...
      INSERT  intO oncd_activity (activity_id, due_date, start_time, action_code, result_code, completed_by_user_code, completion_date, completion_time, created_by_user_code, creation_date, updated_by_user_code, updated_date, [description], cst_activity_type_code, source_code, cst_time_zone_code)
            VALUES (@ActivityID, CAST(CONVERT(varchar(11),  @Start,  101) AS datetime), CAST(CONVERT(TIME,@Start) AS DateTime), @ActionCode, @ResultCode, NULL, NULL, NULL, @p_User, GETDATE(), @p_User, GETDATE(), @Description, @ActivityType, CASE WHEN @ActionCode = 'INHOUSE' THEN @ActivitySource ELSE NULL END, @TimeZoneCode )
