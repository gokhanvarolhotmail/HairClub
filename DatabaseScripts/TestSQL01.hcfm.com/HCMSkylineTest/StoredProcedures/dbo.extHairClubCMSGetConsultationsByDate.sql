/* CreateDate: 07/22/2014 18:28:29.840 , ModifyDate: 01/30/2017 13:49:06.563 */
GO
/*
==============================================================================
...
==============================================================================
SAMPLE EXECUTION:
EXEC extHairClubCMSGetConsultationsByDate 292, '6/15/2015', '6/17/15', 1
==============================================================================
*/
...
BEGIN
	...
	FROM oncd_company co WITH(NOLOCK)
		...
		INNER JOIN oncd_activity a WITH(NOLOCK) on acon.activity_id = a.activity_id
				...
				AND ((a.result_code IS NULL OR result_code = '') OR a.result_code NOT IN ('CANCEL', 'RESCHEDULE','CTREXCPTN', 'PRANK'))
