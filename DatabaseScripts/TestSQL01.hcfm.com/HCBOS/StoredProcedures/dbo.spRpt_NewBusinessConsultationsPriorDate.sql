...
DATE IMPLEMENTED: 9/19/08

LAST REVISION DATE: 9/19/08
-------------------------------------------------------------------------------------------------
--3/16/09 Modified by: ONC PSO Fred Remers
--removed view
--implimented 3/17/09 1:09 PM
--------------------------------------------------------------------------------------------------------
NOTES:
--------------------------------------------------------------------------------------------------------
SAMPLE EXEC:  EXECUTE [spRpt_NewBusinessConsultationsPriorDate] 201, '3/6/2009'
--------------------------------------------------------------------------------------------------------

***********************************************************************/

CREATE PROCEDURE [dbo].[spRpt_NewBusinessConsultationsPriorDate]
	@CenterNumber	int
,	@Date			datetime
...
SELECT
	...
	dbo.pCase(pc.description) As 'Promo',
