/* CreateDate: 09/22/2008 15:06:22.407 , ModifyDate: 01/25/2010 08:11:31.743 */
GO
SET ANSI_NULLS ON
GO
...
GO
/*===============================================================================================
-- Procedure Name:			spApp_TREConsultations_GetNoSaleReasonsList
...
Sample Execution:
--
EXEC spApp_TREConsultations_GetNoSaleReasonsList
================================================================================================*/
CREATE PROCEDURE [dbo].[spApp_TREConsultations_GetNoSaleReasonsList]
AS
BEGIN
