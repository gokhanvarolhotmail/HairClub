/* CreateDate: 09/22/2008 15:05:02.360 , ModifyDate: 01/25/2010 08:11:31.823 */
GO
SET ANSI_NULLS ON
GO
...
GO
/*===============================================================================================
-- Procedure Name:			spApp_TREConsultations_GetConsultationsByCenter
...
Sample Execution:
--
EXEC spApp_TREConsultations_GetConsultationsByCenter 205, '3/6/2009', '3/6/2009'
================================================================================================*/
CREATE PROCEDURE [dbo].[spApp_TREConsultations_GetConsultationsByCenter]
(
	@CenterNumber INT,
	@StartDate DATETIME,
	@EndDate DATETIME
