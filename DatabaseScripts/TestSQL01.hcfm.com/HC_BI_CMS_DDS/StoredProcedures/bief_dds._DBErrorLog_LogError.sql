/* CreateDate: 05/03/2010 12:17:25.437 , ModifyDate: 09/16/2019 09:33:49.877 */
GO
...
BEGIN
	...
	SET @IsErrorLoggingEnabled = (SELECT [bief_dds].[fn_IsErrorLoggingEnabled]())
    ...
    BEGIN CATCH
        ...
        EXECUTE [bief_dds].[_DBErrorLog_PrintError];
        RETURN -1;
    END CATCH
END;
GO
