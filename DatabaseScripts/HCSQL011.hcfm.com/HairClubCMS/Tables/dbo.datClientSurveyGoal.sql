/* CreateDate: 10/20/2014 07:50:33.877 , ModifyDate: 10/20/2014 07:50:34.127 */
GO
...
GO
ALTER TABLE [dbo].[datClientSurveyGoal]  WITH NOCHECK ADD  CONSTRAINT [FK_datClientSurveyGoal_datClientSurvey] FOREIGN KEY([ClientSurveyID])
...
GO
ALTER TABLE [dbo].[datClientSurveyGoal]  WITH NOCHECK ADD  CONSTRAINT [FK_datClientSurveyGoal_lkpClientSurveyGoal] FOREIGN KEY([lkpClientSurveyGoalID])
