/* CreateDate: 10/21/2015 16:00:04.610 , ModifyDate: 06/23/2017 05:38:14.450 */
GO
...
GO
ALTER TABLE [dbo].[datClientPhoto]  WITH NOCHECK ADD  CONSTRAINT [FK_datClientPhoto_datClient] FOREIGN KEY([ClientGUID])
