/* CreateDate: 08/27/2008 11:31:06.397 , ModifyDate: 05/26/2020 10:49:28.880 */
GO
...
GO
ALTER TABLE [dbo].[lkpColorFormula]  WITH NOCHECK ADD  CONSTRAINT [FK_lkpColorFormula_lkpColorBrand] FOREIGN KEY([ColorBrandID])
