/* CreateDate: 05/20/2019 11:10:25.857 , ModifyDate: 05/20/2019 11:10:25.857 */
GO
/***********************************************************************

PROCEDURE:				rptFeeSummaryByAccountTypeWithAddOns
...
NOTES: 	Return EFT summary by Account Type for the specified Pay Cycle, Month, Year, and Center.
		...
		05/13/2019 - RMH: Used this version selFeeSummaryByAccountType for the report - renamed with rpt...WithAddOns
--------------------------------------------------------------------------------------------------------

SAMPLE EXECUTION:

rptFeeSummaryByAccountTypeWithAddOns 2, 02, 2019, 201

***********************************************************************/
CREATE PROCEDURE [dbo].[rptFeeSummaryByAccountTypeWithAddOns]
...
BEGIN
	...
	DECLARE @FeeTotal AS DECIMAL(18,4), @WillRunTotal As DECIMAL(18,4), @WontRunTotal AS DECIMAL(18,4), @ExceptionsTotal as DECIMAL(18,4), @FrozenTotal AS DECIMAL(18,4)
