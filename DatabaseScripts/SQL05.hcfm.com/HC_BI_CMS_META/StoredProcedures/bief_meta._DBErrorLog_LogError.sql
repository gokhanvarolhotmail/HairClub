/* CreateDate: 05/03/2010 12:19:28.520 , ModifyDate: 05/03/2010 12:19:28.520 */
GO
CREATE PROCEDURE [bief_meta].[_DBErrorLog_LogError]
(
...
BEGIN
	...
	SET @IsErrorLoggingEnabled = (SELECT [bief_meta].[fn_IsErrorLoggingEnabled]())
    ...
    BEGIN CATCH
        ...
        EXECUTE [bief_meta].[_DBErrorLog_PrintError];
        RETURN -1;
    END CATCH
END;
GO
