...
GO
EXEC sys.sp_addextendedproperty @name=N'Business Relationship', @value=N'Quantity derived from Sales Order detail table in cONEct. Reflects quantiy of items purchased in Retail sales. Otherwise indicative of a membership assignment.Negative quantity can indicate return or cancellation depending on if its a Membersihp or Sales Order' , @level0type=N'SCHEMA',@level0name=N'bi_cms_dds', @level1type=N'VIEW',@level1name=N'vwFactSalesConect', @level2type=N'COLUMN',@level2name=N'SF-Quantity'
GO
EXEC sys.sp_addextendedproperty @name=N'Derviation', @value=N'Table: datSalesOrderDetail
Column: Quantity' , @level0type=N'SCHEMA',@level0name=N'bi_cms_dds', @level1type=N'VIEW',@level1name=N'vwFactSalesConect', @level2type=N'COLUMN',@level2name=N'SF-Quantity'
GO
EXEC sys.sp_addextendedproperty @name=N'Related Application', @value=N'cONEct' , @level0type=N'SCHEMA',@level0name=N'bi_cms_dds', @level1type=N'VIEW',@level1name=N'vwFactSalesConect', @level2type=N'COLUMN',@level2name=N'SF-Quantity'
GO
EXEC sys.sp_addextendedproperty @name=N'Source', @value=N'Database: HairClubCMS
Column: Quantity' , @level0type=N'SCHEMA',@level0name=N'bi_cms_dds', @level1type=N'VIEW',@level1name=N'vwFactSalesConect', @level2type=N'COLUMN',@level2name=N'SF-Quantity'
GO
