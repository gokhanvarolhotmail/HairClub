/* CreateDate: 08/05/2015 09:01:32.297 , ModifyDate: 08/05/2015 09:01:32.297 */
GO
create procedure [sp_MSupd_dboNoSaleReasons]
		@c1 varchar(50) = NULL,
		@c2 varchar(50) = NULL,
		@c3 int = NULL,
		@c4 int = NULL,
...
begin
update [dbo].[NoSaleReasons] set
		[ReasonCode] = case substring(@bitmap,1,1) & 1 when 1 then @c1 else [ReasonCode] end,
