/* CreateDate: 08/05/2015 09:01:32.260 , ModifyDate: 08/05/2015 09:01:32.260 */
GO
create procedure [sp_MSupd_dboContactSalesType]
		@c1 varchar(50) = NULL,
		@c2 varchar(50) = NULL,
		@c3 int = NULL,
		@c4 int = NULL,
...
begin
update [dbo].[ContactSalesType] set
		[SalesTypeCode] = case substring(@bitmap,1,1) & 1 when 1 then @c1 else [SalesTypeCode] end,
