/* CreateDate: 01/20/2016 11:29:18.187 , ModifyDate: 01/09/2018 14:53:01.470 */
GO
/***********************************************************************
...
SELECT * FROM vw_PCPCounts_Rolling2Years where CenterSSID = 6
***********************************************************************/
CREATE VIEW [dbo].[vw_PCPCounts_Rolling2Years]
AS
