/* CreateDate: 02/22/2022 10:16:11.957 , ModifyDate: 02/24/2022 12:14:23.430 */
GO
/***********************************************************************
...
***********************************************************************/
CREATE PROCEDURE [dbo].[spRpt_ClosingByConsultant_V2]
    @CenterType INT
  , @StartDate  DATETIME
  , @EndDate    DATETIME
AS
...
SELECT
  ...
  , [b].[ClientGUIDList]
  , [b].[ClientKeyList]
  , [b].[ClientIdentifierList]
  , [b].[ClientFullNameList]
  , [b].[ClientCount]
  , [a].[FullDate]
  , [a].[RegionID]
  , [a].[Region]
...
OUTER APPLY( SELECT
               ...
               , [Utility].[dbo].[StringConcat]([c].[ClientIdentifier], ',') AS [ClientIdentifierList]
               , [Utility].[dbo].[StringConcat]([c].[ClientFullName], '|') AS [ClientFullNameList]
