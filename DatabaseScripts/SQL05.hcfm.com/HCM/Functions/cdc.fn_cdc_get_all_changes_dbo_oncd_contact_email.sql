/* CreateDate: 01/03/2018 17:04:46.367 , ModifyDate: 01/03/2018 17:04:46.367 */
GO
create function [cdc].[fn_cdc_get_all_changes_dbo_oncd_contact_email]
	(	@from_lsn binary(10),
		@to_lsn binary(10),
	...
	where ( [sys].[fn_cdc_check_parameters]( N'dbo_oncd_contact_email', @from_lsn, @to_lsn, lower(rtrim(ltrim(@row_filter_option))), 0) = 0)
