/* CreateDate: 01/03/2018 16:31:35.523 , ModifyDate: 01/03/2018 16:31:35.523 */
GO
create procedure [dbo].[sp_MSupd_dbooncd_activity_contact]
		@c1 nchar(10) = NULL,
		@c2 nchar(10) = NULL,
		@c3 nchar(10) = NULL,
		@c4 datetime = NULL,
...
begin
update [dbo].[oncd_activity_contact] set
		[activity_contact_id] = case substring(@bitmap,1,1) & 1 when 1 then @c1 else [activity_contact_id] end,
		[activity_id] = case substring(@bitmap,1,1) & 2 when 2 then @c2 else [activity_id] end,
		[contact_id] = case substring(@bitmap,1,1) & 4 when 4 then @c3 else [contact_id] end,
