/* CreateDate: 05/03/2010 12:26:50.267 , ModifyDate: 08/05/2019 11:19:05.063 */
GO
CREATE PROCEDURE [bi_mktg_stage].[zzzspHC_DQA_FactActivity_Upsert]
			  @DataPkgKey				int
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_mktg_stage].[synHC_DQA_FactActivity] DQA ON
