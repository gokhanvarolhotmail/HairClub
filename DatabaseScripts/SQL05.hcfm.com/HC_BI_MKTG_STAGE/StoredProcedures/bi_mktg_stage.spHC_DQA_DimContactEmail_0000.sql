/* CreateDate: 05/03/2010 12:26:49.543 , ModifyDate: 05/03/2010 12:26:49.543 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DQA_DimContactEmail_0000]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimContactEmail_0000] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_mktg_stage].[spHC_DQA_DimContactEmail_0000]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @TableName = N'[bi_mktg_dqa].[DimContactEmail]'
	...
	BEGIN TRY
		...
		-----------------------
		EXEC	@return_value = [bi_mktg_stage].[spHC_DQA_DimContactEmail_Upsert] @DataPkgKey, @RuleKey, @RuleActionKey,
