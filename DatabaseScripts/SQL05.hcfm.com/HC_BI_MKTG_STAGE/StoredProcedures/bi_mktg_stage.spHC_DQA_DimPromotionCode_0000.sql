/* CreateDate: 02/02/2011 17:34:45.720 , ModifyDate: 02/02/2011 17:34:45.720 */
GO
create PROCEDURE [bi_mktg_stage].[spHC_DQA_DimPromotionCode_0000]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimPromotionCode_0000] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_mktg_stage].[spHC_DQA_DimPromotionCode_0000]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @TableName = N'[bi_mktg_dqa].[DimPromotionCode]'
	...
	BEGIN TRY
		...
		-----------------------
		EXEC	@return_value = [bi_mktg_stage].[spHC_DQA_DimPromotionCode_Upsert] @DataPkgKey, @RuleKey, @RuleActionKey,
