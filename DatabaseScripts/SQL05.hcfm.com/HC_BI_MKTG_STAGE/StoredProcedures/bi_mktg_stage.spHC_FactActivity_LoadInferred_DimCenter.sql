/* CreateDate: 05/03/2010 12:26:59.340 , ModifyDate: 01/06/2021 12:07:53.167 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimCenter]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactActivity_LoadInferred_DimCenter] is used to load inferred
-- members to the DimCenter table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimCenter] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
