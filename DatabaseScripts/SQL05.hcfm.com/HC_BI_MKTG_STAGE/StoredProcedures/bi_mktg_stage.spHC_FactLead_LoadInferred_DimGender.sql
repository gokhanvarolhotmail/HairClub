/* CreateDate: 05/03/2010 12:27:06.007 , ModifyDate: 05/03/2010 12:27:06.007 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimGender]
			   @DataPkgKey					int


AS
-------------------------------------------------------------------------
-- [spHC_FactLead_LoadInferred_DimGender] is used to load inferred
-- members to the DimGender table.
--
--
--   exec [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimGender] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
