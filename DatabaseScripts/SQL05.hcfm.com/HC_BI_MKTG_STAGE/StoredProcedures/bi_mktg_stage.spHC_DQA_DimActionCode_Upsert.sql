/* CreateDate: 05/03/2010 12:26:49.253 , ModifyDate: 05/03/2010 12:26:49.253 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DQA_DimActionCode_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimActionCode_Upsert] loads data to Data Quality
-- table
--
--
--   exec [bi_mktg_stage].[spHC_DQA_DimActionCode_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_mktg_stage].[synHC_DQA_DimActionCode] DQA ON
				DQA.[ActionCodeSSID] = STG.[ActionCodeSSID]
		...
		-----------------------
		INSERT INTO [bi_mktg_stage].[synHC_DQA_DimActionCode]
					( [DataPkgKey]
					, [ActionCodeKey]
					, [ActionCodeSSID]
