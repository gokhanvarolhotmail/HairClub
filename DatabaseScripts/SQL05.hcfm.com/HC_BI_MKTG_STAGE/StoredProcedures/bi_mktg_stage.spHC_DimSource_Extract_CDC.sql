/* CreateDate: 05/03/2010 12:26:49.150 , ModifyDate: 08/30/2021 21:25:30.117 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DimSource_Extract_CDC]
		@DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DimSource_Extract_CDC] is used to retrieve a
-- list Sources
--
--   exec [bi_mktg_stage].[spHC_DimSource_Extract_CDC]  '2009-01-01 01:00:00', '2009-01-02 01:00:00'
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
