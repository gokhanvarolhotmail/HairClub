/* CreateDate: 05/03/2010 12:26:49.607 , ModifyDate: 09/14/2020 15:07:22.867 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DQA_DimContactPhone_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimContactPhone_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_mktg_stage].[spHC_DQA_DimContactPhone_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_mktg_stage].[synHC_DQA_DimContactPhone] DQA ON
				DQA.[SFDC_LeadPhoneID] = STG.[SFDC_LeadPhoneID]
		...
		-----------------------
		INSERT INTO [bi_mktg_stage].[synHC_DQA_DimContactPhone]
					( [DataPkgKey]
				    , [ContactPhoneKey]
				    , [ContactPhoneSSID]
				    , [ContactSSID]
