/* CreateDate: 08/05/2019 11:17:15.077 , ModifyDate: 08/31/2021 14:29:10.803 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DDS_FactActivityResults_Upsert]
			   @DataPkgKey					int
...
--			12/15/2020  KMurdoch     Added Lead Creation Date/TimeKey; Source/Promo to FAR
-------------------------------------------------------------------------
BEGIN
	...
	BEGIN TRY
		...
		UPDATE DW SET
				...
				, DW.[LeadSourceKey] = STG.[LeadSourceKey]
				, DW.[PromoCodeKey] = STG.[PromoCodeKey]
