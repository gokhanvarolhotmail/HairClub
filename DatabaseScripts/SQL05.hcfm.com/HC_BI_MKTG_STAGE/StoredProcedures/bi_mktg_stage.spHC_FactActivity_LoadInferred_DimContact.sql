/* CreateDate: 08/05/2019 11:22:41.820 , ModifyDate: 08/06/2019 10:39:01.700 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimContact]
			   @DataPkgKey					int
...
AS
-------------------------------------------------------------------------
-- [spHC_FactActivity_LoadInferred_DimContact] is used to load inferred
-- members to the DimContact table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimContact] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
--			06/06/2019  KMurdoch     Modified creation of inferred to only look at SFDC_LeadID
-------------------------------------------------------------------------
BEGIN
	...
	BEGIN TRY
		...
		INSERT INTO [bi_mktg_stage].[synHC_DDS_DimContact] (
			...
			--		OR STG.[SFDC_LeadID] IS NOT NULL )
