/* CreateDate: 05/03/2010 12:26:34.217 , ModifyDate: 05/03/2010 12:26:34.217 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DimContactEmail_Cleanup]
       (
			  @DataPkgKey				int
       )
...
AS
-------------------------------------------------------------------------
-- [spHC_DimContactEmail_Cleanup] is used to Cleanup records
--
--
-- EXEC [spHC_DimContactEmail_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
