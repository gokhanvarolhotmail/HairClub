/* CreateDate: 05/03/2010 12:26:49.723 , ModifyDate: 05/03/2010 12:26:49.723 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DQA_DimEmployee]
			  @DataPkgKey				int
...
--
--
--   exec [bi_mktg_stage].[spHC_DQA_DimEmployee] 431
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
	...
	BEGIN TRY
		...
		IF (@IsDQAInformationLoggingEnabled = 1)
			BEGIN
				...
				-----------------------
				EXEC	@return_value = [bi_mktg_stage].[spHC_DQA_DimEmployee_0000] @DataPkgKey
			END
