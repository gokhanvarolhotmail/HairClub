/* CreateDate: 05/03/2010 12:26:36.340 , ModifyDate: 09/14/2020 14:02:42.997 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DimContactPhone_Extract]
		@DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DimContactPhone_Extract] is used to retrieve a
-- list of Contact Phones
--
--   exec [bi_mktg_stage].[spHC_DimContactPhone_Extract]  '2009-01-01 01:00:00'
--                                       , '2009-01-02 01:00:00'
--
-------------------------------------------------------------------------
-- Change History
...
/****** Object:  StoredProcedure [bi_mktg_stage].[spHC_DimContactPhone_Extract_CDC]    Script Date: 11/30/2018 12:35:14 PM ******/
SET ANSI_NULLS ON
GO
