/* CreateDate: 05/03/2010 12:27:05.990 , ModifyDate: 05/03/2010 12:27:05.990 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimEthnicity]
			   @DataPkgKey					int


AS
-------------------------------------------------------------------------
-- [spHC_FactLead_LoadInferred_DimEthnicity] is used to load inferred
-- members to the DimEthnicity table.
--
--
--   exec [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimEthnicity] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
