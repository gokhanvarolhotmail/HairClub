/* CreateDate: 05/03/2010 12:27:06.020 , ModifyDate: 05/03/2010 12:27:06.020 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimHairLossType]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactLead_LoadInferred_DimHairLossType] is used to load inferred
-- members to the DimHairLossType table.
--
--
--   exec [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimHairLossType] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
