/* CreateDate: 05/03/2010 12:26:59.427 , ModifyDate: 05/03/2010 12:26:59.427 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimGender]
			   @DataPkgKey					int
...
AS
-------------------------------------------------------------------------
-- [spHC_FactActivity_LoadInferred_DimGender] is used to load inferred
-- members to the DimGender table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimGender] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
