/* CreateDate: 05/03/2010 12:26:54.520 , ModifyDate: 05/03/2010 12:26:54.520 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivityResults_LoadInferred_DimActionCode]
			   @DataPkgKey					int
...
AS
-------------------------------------------------------------------------
-- [spHC_FactActivityResults_LoadInferred_DimActionCode] is used to load inferred
-- members to the DimActionCode table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivityResults_LoadInferred_DimActionCode] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
