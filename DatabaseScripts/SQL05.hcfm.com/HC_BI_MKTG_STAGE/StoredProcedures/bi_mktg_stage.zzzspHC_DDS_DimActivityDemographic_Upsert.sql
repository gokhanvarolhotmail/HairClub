/* CreateDate: 05/03/2010 12:26:23.310 , ModifyDate: 08/05/2019 11:13:28.277 */
GO
CREATE PROCEDURE [bi_mktg_stage].[zzzspHC_DDS_DimActivityDemographic_Upsert]
			   @DataPkgKey					int
	...
	BEGIN TRY
		...
		FROM [HC_BI_MKTG_DDS].[bi_mktg_dds].[DimContact] DimContact
			Inner join [bi_mktg_stage].[DimActivityDemographic] DimActivityDemographic
				ON DimContact.contactssid = DimActivityDemographic.contactssid
