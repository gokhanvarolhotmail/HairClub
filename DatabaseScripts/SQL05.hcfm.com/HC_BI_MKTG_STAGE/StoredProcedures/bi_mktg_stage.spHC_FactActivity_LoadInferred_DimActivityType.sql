/* CreateDate: 05/03/2010 12:26:59.313 , ModifyDate: 05/03/2010 12:26:59.313 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimActivityType]
			   @DataPkgKey					int
...
AS
-------------------------------------------------------------------------
-- [spHC_FactActivity_LoadInferred_DimActivityType] is used to load inferred
-- members to the DimActivityType table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimActivityType] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		------------------------
		INSERT INTO [bi_mktg_stage].[synHC_DDS_DimActivityType] (
				 [ActivityTypeSSID]
