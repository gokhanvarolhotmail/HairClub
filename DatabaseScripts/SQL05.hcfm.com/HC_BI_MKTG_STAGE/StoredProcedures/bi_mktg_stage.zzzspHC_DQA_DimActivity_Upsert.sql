/* CreateDate: 05/03/2010 12:26:49.430 , ModifyDate: 08/05/2019 10:51:31.753 */
GO
CREATE PROCEDURE [bi_mktg_stage].[zzzspHC_DQA_DimActivity_Upsert]
			  @DataPkgKey				int
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_mktg_stage].[synHC_DQA_DimActivity] DQA ON
				DQA.[ActivitySSID] = STG.[ActivitySSID]
