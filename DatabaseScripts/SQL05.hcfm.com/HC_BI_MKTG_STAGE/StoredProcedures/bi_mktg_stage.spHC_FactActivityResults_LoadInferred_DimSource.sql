/* CreateDate: 05/03/2010 12:26:54.787 , ModifyDate: 05/03/2010 12:26:54.787 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivityResults_LoadInferred_DimSource]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactActivityResults_LoadInferred_DimSource] is used to load inferred
-- members to the DimSource table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivityResults_LoadInferred_DimSource] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
