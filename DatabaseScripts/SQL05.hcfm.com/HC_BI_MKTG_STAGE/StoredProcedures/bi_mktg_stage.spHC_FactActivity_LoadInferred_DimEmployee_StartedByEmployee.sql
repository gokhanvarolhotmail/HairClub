/* CreateDate: 05/03/2010 12:26:59.397 , ModifyDate: 08/05/2011 12:24:58.380 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimEmployee_StartedByEmployee]
			   @DataPkgKey					int
...
AS
-------------------------------------------------------------------------
-- [spHC_FactActivity_LoadInferred_DimEmployee] is used to load inferred
-- members to the DimEmployee table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimEmployee] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		INSERT INTO [bi_mktg_stage].[synHC_DDS_DimEmployee] (
			...
			SELECT
				  DISTINCT(STG.[StartedByEmployeeSSID])
				, ''
				, ''
				, ''
				, ''
