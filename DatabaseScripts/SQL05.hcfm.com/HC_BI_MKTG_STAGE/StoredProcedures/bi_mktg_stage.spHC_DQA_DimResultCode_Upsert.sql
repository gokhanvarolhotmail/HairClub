/* CreateDate: 05/03/2010 12:26:49.833 , ModifyDate: 05/03/2010 12:26:49.833 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DQA_DimResultCode_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimResultCode_Upsert] loads data to Data Quality
-- table
--
--
--   exec [bi_mktg_stage].[spHC_DQA_DimResultCode_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_mktg_stage].[synHC_DQA_DimResultCode] DQA ON
				DQA.[ResultCodeSSID] = STG.[ResultCodeSSID]
		...
		-----------------------
		INSERT INTO [bi_mktg_stage].[synHC_DQA_DimResultCode]
					( [DataPkgKey]
					, [ResultCodeKey]
					, [ResultCodeSSID]
