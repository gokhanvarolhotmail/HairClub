/* CreateDate: 05/03/2010 12:26:54.750 , ModifyDate: 05/03/2010 12:26:54.750 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivityResults_LoadInferred_DimResultCode]
			   @DataPkgKey					int
...
AS
-------------------------------------------------------------------------
-- [spHC_FactActivityResults_LoadInferred_DimResultCode] is used to load inferred
-- members to the DimResultCode table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivityResults_LoadInferred_DimResultCode] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
