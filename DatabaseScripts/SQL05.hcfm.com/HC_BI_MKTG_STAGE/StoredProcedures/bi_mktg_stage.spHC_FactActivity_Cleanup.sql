/* CreateDate: 05/03/2010 12:26:55.327 , ModifyDate: 05/03/2010 12:26:55.327 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivity_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_FactActivity_Cleanup] is used to Cleanup records
--
--
--   exec [bi_mktg_stage].[spHC_FactActivity_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
	...
	BEGIN TRY
		...
		WHILE ( 0 = 0 )
			BEGIN
				...
				FROM [bi_mktg_stage].[FactActivity]
				WHERE DataPkgKey = @DataPkgKey
				AND IsLoaded = 1
				AND IsException = 0
