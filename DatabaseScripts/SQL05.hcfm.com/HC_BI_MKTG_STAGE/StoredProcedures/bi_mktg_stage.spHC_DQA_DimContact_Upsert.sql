/* CreateDate: 05/03/2010 12:26:49.690 , ModifyDate: 11/24/2020 13:30:16.500 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DQA_DimContact_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimContact_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_mktg_stage].[spHC_DQA_DimContact_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
--			10/26/2020  KMurdoch     Added SFDC_LeadID
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_mktg_stage].[synHC_DQA_DimContact] DQA ON
		...
		-----------------------
		INSERT INTO [bi_mktg_stage].[synHC_DQA_DimContact]
					( [DataPkgKey]
					, [ContactKey]
					, [ContactSSID]
					, [SFDC_LeadID]
