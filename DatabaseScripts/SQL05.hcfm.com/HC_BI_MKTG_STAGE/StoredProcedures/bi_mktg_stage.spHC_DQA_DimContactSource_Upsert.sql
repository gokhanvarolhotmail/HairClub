/* CreateDate: 05/03/2010 12:26:49.650 , ModifyDate: 05/03/2010 12:26:49.650 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DQA_DimContactSource_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimContactSource_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_mktg_stage].[spHC_DQA_DimContactSource_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_mktg_stage].[synHC_DQA_DimContactSource] DQA ON
				DQA.[ContactSourceSSID] = STG.[ContactSourceSSID]
		...
		-----------------------
		INSERT INTO [bi_mktg_stage].[synHC_DQA_DimContactSource]
					( [DataPkgKey]
				    , [ContactSourceKey]
				    , [ContactSourceSSID]
				    , [ContactSSID]
