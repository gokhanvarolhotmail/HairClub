/* CreateDate: 05/03/2010 12:27:05.960 , ModifyDate: 09/10/2020 14:08:57.903 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimContact]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactLead_LoadInferred_DimContact] is used to load inferred
-- members to the DimContact table.
--
--
--   exec [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimContact] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
--			08/06/2019  KMurdoch	 Removed check to see if ContactSSID is null
