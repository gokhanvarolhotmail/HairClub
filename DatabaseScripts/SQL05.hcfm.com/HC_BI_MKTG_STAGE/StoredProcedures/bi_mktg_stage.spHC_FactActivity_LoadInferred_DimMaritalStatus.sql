/* CreateDate: 05/03/2010 12:26:59.463 , ModifyDate: 05/03/2010 12:26:59.463 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimMaritalStatus]
			   @DataPkgKey					int
...
AS
-------------------------------------------------------------------------
-- [spHC_FactActivity_LoadInferred_DimMaritalStatus] is used to load inferred
-- members to the DimMaritalStatus table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimMaritalStatus] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
