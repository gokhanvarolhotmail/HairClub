/* CreateDate: 05/03/2010 12:27:06.050 , ModifyDate: 05/03/2010 12:27:06.050 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimOccupation]
			   @DataPkgKey					int


AS
-------------------------------------------------------------------------
-- [spHC_FactLead_LoadInferred_DimOccupation] is used to load inferred
-- members to the DimOccupation table.
--
--
--   exec [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimOccupation] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
