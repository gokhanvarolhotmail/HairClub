/* CreateDate: 08/05/2019 11:25:12.860 , ModifyDate: 08/24/2021 16:48:45.600 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DimActivityResult_Extract_CDC]
		@DataPkgKey				int
...
--			09/10/2020  KMurdoch     Added SFDC_PersonAccountID and update statement
-------------------------------------------------------------------------
BEGIN
