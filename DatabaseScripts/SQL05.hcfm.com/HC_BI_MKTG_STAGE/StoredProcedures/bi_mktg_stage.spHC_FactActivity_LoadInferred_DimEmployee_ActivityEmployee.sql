/* CreateDate: 08/05/2011 12:23:34.427 , ModifyDate: 08/05/2011 12:23:34.427 */
GO
create PROCEDURE [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimEmployee_ActivityEmployee]
			   @DataPkgKey					int
...
BEGIN
	...
	BEGIN TRY
		...
		INSERT INTO [bi_mktg_stage].[synHC_DDS_DimEmployee] (
			...
			SELECT
				  DISTINCT(STG.[ActivityEmployeeSSID])
				, ''
				, ''
				, ''
				, ''
