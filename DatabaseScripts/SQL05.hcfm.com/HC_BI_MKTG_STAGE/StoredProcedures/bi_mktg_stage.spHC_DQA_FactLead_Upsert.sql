/* CreateDate: 05/03/2010 12:26:50.393 , ModifyDate: 08/24/2020 08:38:23.527 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DQA_FactLead_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_FactLead_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_mktg_stage].[spHC_DQA_FactLead_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
--			08/10/2011  KMurdoch	 Added AssignedEmployeeKey
--			08/06/2019  KMurdoch     Modified SFDC to be primary
--			08/24/2020  KMurdoch     Added RecentSource Key to FactLead
-------------------------------------------------------------------------
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_mktg_stage].[synHC_DQA_FactLead] DQA ON
				 DQA.[SFDC_LeadID] = STG.[SFDC_LeadID]
		...
		-----------------------
		INSERT INTO [bi_mktg_stage].[synHC_DQA_FactLead]
				   ( [DataPkgKey]
				   , [ContactKey]
				   , [ContactSSID]
				   , [SFDC_LeadID]
