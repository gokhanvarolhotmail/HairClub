/* CreateDate: 05/03/2010 12:27:06.067 , ModifyDate: 05/03/2010 12:27:06.067 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimSource]
			   @DataPkgKey					int


AS
-------------------------------------------------------------------------
-- [spHC_FactLead_LoadInferred_DimSource] is used to load inferred
-- members to the DimSource table.
--
--
--   exec [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimSource] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
