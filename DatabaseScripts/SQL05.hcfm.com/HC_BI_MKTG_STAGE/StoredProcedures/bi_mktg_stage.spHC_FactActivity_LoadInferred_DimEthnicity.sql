/* CreateDate: 05/03/2010 12:26:59.410 , ModifyDate: 05/03/2010 12:26:59.410 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimEthnicity]
			   @DataPkgKey					int
...
AS
-------------------------------------------------------------------------
-- [spHC_FactActivity_LoadInferred_DimEthnicity] is used to load inferred
-- members to the DimEthnicity table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimEthnicity] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
