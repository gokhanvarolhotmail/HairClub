/* CreateDate: 05/03/2010 12:26:59.483 , ModifyDate: 05/03/2010 12:26:59.483 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimOccupation]
			   @DataPkgKey					int
...
AS
-------------------------------------------------------------------------
-- [spHC_FactActivity_LoadInferred_DimOccupation] is used to load inferred
-- members to the DimOccupation table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimOccupation] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
