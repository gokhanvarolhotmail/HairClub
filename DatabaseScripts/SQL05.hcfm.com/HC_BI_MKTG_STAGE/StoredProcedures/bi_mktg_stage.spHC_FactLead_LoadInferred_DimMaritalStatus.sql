/* CreateDate: 05/03/2010 12:27:06.037 , ModifyDate: 05/03/2010 12:27:06.037 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimMaritalStatus]
			   @DataPkgKey					int


AS
-------------------------------------------------------------------------
-- [spHC_FactLead_LoadInferred_DimMaritalStatus] is used to load inferred
-- members to the DimMaritalStatus table.
--
--
--   exec [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimMaritalStatus] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
