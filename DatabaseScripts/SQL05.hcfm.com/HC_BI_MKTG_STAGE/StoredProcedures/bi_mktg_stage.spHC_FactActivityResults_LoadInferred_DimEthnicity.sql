/* CreateDate: 05/03/2010 12:26:54.633 , ModifyDate: 05/03/2010 12:26:54.633 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivityResults_LoadInferred_DimEthnicity]
			   @DataPkgKey					int
...
AS
-------------------------------------------------------------------------
-- [spHC_FactActivityResults_LoadInferred_DimEthnicity] is used to load inferred
-- members to the DimEthnicity table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivityResults_LoadInferred_DimEthnicity] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		------------------------
		INSERT INTO [bi_mktg_stage].[synHC_DDS_DimEthnicity] (
				 [EthnicitySSID]
