/* CreateDate: 05/03/2010 12:26:59.943 , ModifyDate: 05/03/2010 12:26:59.943 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactLead_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_FactLead_Cleanup] is used to Cleanup records
--
--
--   exec [bi_mktg_stage].[spHC_FactLead_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
