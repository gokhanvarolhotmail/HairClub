/* CreateDate: 02/03/2011 17:42:01.870 , ModifyDate: 02/03/2011 17:42:01.870 */
GO
create PROCEDURE [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimSalesType]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactLead_LoadInferred_DimSalesType] is used to load inferred
-- members to the DimSalesType table.
--
--
--   exec [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimSalesType] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
