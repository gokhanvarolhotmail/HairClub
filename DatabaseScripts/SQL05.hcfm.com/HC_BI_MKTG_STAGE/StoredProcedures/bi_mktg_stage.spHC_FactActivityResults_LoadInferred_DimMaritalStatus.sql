/* CreateDate: 05/03/2010 12:26:54.703 , ModifyDate: 05/03/2010 12:26:54.703 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivityResults_LoadInferred_DimMaritalStatus]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactActivityResults_LoadInferred_DimMaritalStatus] is used to load inferred
-- members to the DimMaritalStatus table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivityResults_LoadInferred_DimMaritalStatus] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		------------------------
		INSERT INTO [bi_mktg_stage].[synHC_DDS_DimMaritalStatus] (
				 [MaritalStatusSSID]
			...
			SELECT
				  DISTINCT(STG.[MaritalStatusSSID])
				, ''
				, ''
				, 1 -- [RowIsCurrent]
