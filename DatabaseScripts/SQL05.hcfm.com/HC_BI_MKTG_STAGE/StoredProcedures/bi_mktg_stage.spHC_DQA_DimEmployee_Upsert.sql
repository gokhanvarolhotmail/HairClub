/* CreateDate: 05/03/2010 12:26:49.770 , ModifyDate: 05/03/2010 12:26:49.770 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DQA_DimEmployee_Upsert]
			  @DataPkgKey				int
...
--
--
--   exec [bi_mktg_stage].[spHC_DQA_DimEmployee_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_mktg_stage].[synHC_DQA_DimEmployee] DQA ON
		...
		-----------------------
		INSERT INTO [bi_mktg_stage].[synHC_DQA_DimEmployee]
					( [DataPkgKey]
					, [EmployeeKey]
					, [EmployeeSSID]
					, [EmployeeFirstName]
