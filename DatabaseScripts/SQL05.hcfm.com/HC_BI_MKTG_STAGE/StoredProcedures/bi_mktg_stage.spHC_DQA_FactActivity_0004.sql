/* CreateDate: 05/03/2010 12:26:50.187 , ModifyDate: 10/26/2011 10:19:27.473 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DQA_FactActivity_0004]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_FactActivity_0004] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_mktg_stage].[spHC_DQA_FactActivity_0004]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		-- Put other clauses here
			AND ([ActivityDateKey] IS NULL
			OR [ActivityDateKey] = 0)
