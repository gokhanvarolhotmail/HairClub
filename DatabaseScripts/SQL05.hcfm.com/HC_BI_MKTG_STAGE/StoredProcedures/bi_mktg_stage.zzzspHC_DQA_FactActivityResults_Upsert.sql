/* CreateDate: 05/03/2010 12:26:50.140 , ModifyDate: 08/05/2019 11:18:47.320 */
GO
CREATE PROCEDURE [bi_mktg_stage].[zzzspHC_DQA_FactActivityResults_Upsert]
			  @DataPkgKey				int
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_mktg_stage].[synHC_DQA_FactActivityResults] DQA ON
				DQA.[ActivityResultSSID] = STG.[ActivityResultSSID]
				-- AND DQA.[ActivityDateSSID] = STG.[ActivityDateSSID]
				-- AND DQA.[ActivityTimeSSID] = STG.[ActivityTimeSSID]
