/* CreateDate: 05/03/2010 12:26:40.627 , ModifyDate: 05/03/2010 12:26:40.627 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DimContact_Cleanup]
       (
			  @DataPkgKey				int
       )
...
AS
-------------------------------------------------------------------------
-- [spHC_DimContact_Cleanup] is used to Cleanup records
--
--
-- EXEC [spHC_DimContact_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
