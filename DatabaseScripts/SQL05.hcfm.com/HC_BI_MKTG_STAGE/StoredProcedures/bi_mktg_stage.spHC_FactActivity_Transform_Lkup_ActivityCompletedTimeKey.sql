/* CreateDate: 05/03/2010 12:26:59.600 , ModifyDate: 10/26/2011 09:55:46.380 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivity_Transform_Lkup_ActivityCompletedTimeKey]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactActivity_Transform_Lkup_ActivityCompletedTimeKey] is used to populate
-- the ActivityCompletedTimeKey in the FactActivity rows
--
--
--   exec [bi_mktg_stage].[spHC_FactActivity_Transform_Lkup_ActivityCompletedTimeKey] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		-----------------------
		UPDATE STG SET
		     IsException = 1, ExceptionMessage = 'ActivityCompletedTimeKey is null - FA_Trans_Lkup'
		FROM [bi_mktg_stage].[FactActivity] STG
		WHERE STG.[DataPkgKey] = @DataPkgKey
