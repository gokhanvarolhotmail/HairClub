/* CreateDate: 05/03/2010 12:26:32.060 , ModifyDate: 05/03/2010 12:26:32.060 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DimContactAddress_Cleanup]
       (
			  @DataPkgKey				int
       )
...
AS
-------------------------------------------------------------------------
-- [spHC_DimContactAddress_Cleanup] is used to Cleanup records
--
--
-- EXEC [spHC_DimContactAddress_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
