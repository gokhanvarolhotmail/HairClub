/* CreateDate: 05/03/2010 12:26:54.727 , ModifyDate: 05/03/2010 12:26:54.727 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivityResults_LoadInferred_DimOccupation]
			   @DataPkgKey					int


AS
-------------------------------------------------------------------------
-- [spHC_FactActivityResults_LoadInferred_DimOccupation] is used to load inferred
-- members to the DimOccupation table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivityResults_LoadInferred_DimOccupation] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		------------------------
		INSERT INTO [bi_mktg_stage].[synHC_DDS_DimOccupation] (
				 [OccupationSSID]
