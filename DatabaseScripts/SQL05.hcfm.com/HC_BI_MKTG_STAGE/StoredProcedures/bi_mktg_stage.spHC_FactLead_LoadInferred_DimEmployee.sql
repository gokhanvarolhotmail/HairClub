/* CreateDate: 05/03/2010 12:27:05.977 , ModifyDate: 05/03/2010 12:27:05.977 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimEmployee]
			   @DataPkgKey					int


AS
-------------------------------------------------------------------------
-- [spHC_FactLead_LoadInferred_DimEmployee] is used to load inferred
-- members to the DimEmployee table.
--
--
--   exec [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimEmployee] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
