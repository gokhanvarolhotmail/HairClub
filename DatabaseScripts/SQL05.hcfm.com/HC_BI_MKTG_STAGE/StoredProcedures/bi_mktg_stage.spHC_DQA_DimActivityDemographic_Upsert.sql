/* CreateDate: 08/05/2019 11:27:51.827 , ModifyDate: 09/10/2020 13:10:58.077 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DQA_DimActivityDemographic_Upsert]
			  @DataPkgKey				int
...
--			08/06/2019  KMurdoch     Move SFDC to primary
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_mktg_stage].[synHC_DQA_DimActivityDemographic] DQA
