/* CreateDate: 05/03/2010 12:26:59.283 , ModifyDate: 05/03/2010 12:26:59.283 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimActionCode]
			   @DataPkgKey					int
...
AS
-------------------------------------------------------------------------
-- [spHC_FactActivity_LoadInferred_DimActionCode] is used to load inferred
-- members to the DimActionCode table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimActionCode] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
