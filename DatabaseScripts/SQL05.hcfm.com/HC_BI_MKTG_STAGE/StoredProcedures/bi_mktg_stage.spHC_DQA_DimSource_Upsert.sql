/* CreateDate: 05/03/2010 12:26:49.920 , ModifyDate: 05/03/2010 12:26:49.920 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DQA_DimSource_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimSource_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_mktg_stage].[spHC_DQA_DimSource_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_mktg_stage].[synHC_DQA_DimSource] DQA ON
				DQA.[SourceSSID] = STG.[SourceSSID]
		...
		-----------------------
		INSERT INTO [bi_mktg_stage].[synHC_DQA_DimSource]
					( [DataPkgKey]
					, [SourceKey]
					, [SourceSSID]
					, [SourceName]
