/* CreateDate: 05/03/2010 12:26:54.657 , ModifyDate: 05/03/2010 12:26:54.657 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivityResults_LoadInferred_DimGender]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactActivityResults_LoadInferred_DimGender] is used to load inferred
-- members to the DimGender table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivityResults_LoadInferred_DimGender] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		------------------------
		INSERT INTO [bi_mktg_stage].[synHC_DDS_DimGender] (
				 [GenderSSID]
				,[GenderDescription]
