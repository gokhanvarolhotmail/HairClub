/* CreateDate: 05/03/2010 12:26:54.773 , ModifyDate: 05/03/2010 12:26:54.773 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivityResults_LoadInferred_DimSalesType]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactActivityResults_LoadInferred_DimSalesType] is used to load inferred
-- members to the DimSalesType table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivityResults_LoadInferred_DimSalesType] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
