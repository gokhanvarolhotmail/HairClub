/* CreateDate: 05/03/2010 12:26:50.333 , ModifyDate: 10/26/2011 10:06:57.740 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DQA_FactLead_0006]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_FactLead_0006] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_mktg_stage].[spHC_DQA_FactLead_0006]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		-- Put other clauses here
			AND ([LeadCreationTimeKey] IS NULL)
