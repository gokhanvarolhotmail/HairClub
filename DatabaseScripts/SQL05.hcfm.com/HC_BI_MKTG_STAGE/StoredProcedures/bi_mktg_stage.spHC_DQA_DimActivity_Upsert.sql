/* CreateDate: 08/05/2019 10:51:46.497 , ModifyDate: 09/10/2020 13:09:42.800 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DQA_DimActivity_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimActivity_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_mktg_stage].[spHC_DQA_DimActivity_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
--			11/20/2017  KMurdoch     Added SFDC_TaskID & SFDC_LeadID
--			08/05/2019	DLeiba		 Migrate ONC to SFDC
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_mktg_stage].[synHC_DQA_DimActivity] DQA ON
				DQA.SFDC_TaskID = STG.SFDC_TaskID
		...
		-----------------------
		INSERT INTO [bi_mktg_stage].[synHC_DQA_DimActivity]
					( [DataPkgKey]
				    , [ActivityKey]
				    , [ActivitySSID]
				    , [ActivityDueDate]
