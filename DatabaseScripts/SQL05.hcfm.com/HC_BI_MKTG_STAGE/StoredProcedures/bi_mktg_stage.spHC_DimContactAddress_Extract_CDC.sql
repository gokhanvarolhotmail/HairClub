/* CreateDate: 05/03/2010 12:26:34.160 , ModifyDate: 08/31/2021 00:24:43.900 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DimContactAddress_Extract_CDC]
		@DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DimContactAddress_Extract_CDC] is used to retrieve a
-- list Contact Addresses
--
--   exec [bi_mktg_stage].[spHC_DimContactAddress_Extract_CDC]  '2009-01-01 01:00:00'
--                                       , '2009-01-02 01:00:00'
--
-------------------------------------------------------------------------
-- Change History
...
BEGIN
	...
	DECLARE		  @TableName			varchar(150)	-- Name of table
 	...
 	SET @CDCTableName = N'dbo_oncd_contact_address'
...
/****** Object:  StoredProcedure [bi_mktg_stage].[spHC_DimContactEmail_Extract]    Script Date: 11/30/2018 12:33:25 PM ******/
SET ANSI_NULLS ON
GO
