/* CreateDate: 05/03/2010 12:26:50.237 , ModifyDate: 10/26/2011 10:18:13.713 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DQA_FactActivity_1002]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_FactActivity_1002] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_mktg_stage].[spHC_DQA_FactActivity_1002]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @RuleKey = 1002	--ActivityKey Foreign Key not defined
