/* CreateDate: 05/03/2010 12:26:59.377 , ModifyDate: 05/03/2010 12:26:59.377 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimEmployee_CompletedByEmployee]
			   @DataPkgKey					int
