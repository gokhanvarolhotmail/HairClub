/* CreateDate: 05/03/2010 12:26:42.667 , ModifyDate: 08/24/2021 18:29:13.810 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DimContact_Extract_CDC]
		@DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DimContact_Extract_CDC] is used to retrieve a
-- list Contact
--
--   exec [bi_mktg_stage].[spHC_DimContact_Extract_CDC]  '2009-01-01 01:00:00'
--                                       , '2009-01-02 01:00:00'
--
-------------------------------------------------------------------------
-- Change History
