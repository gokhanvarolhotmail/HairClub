/* CreateDate: 05/03/2010 12:26:59.443 , ModifyDate: 05/03/2010 12:26:59.443 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimHairLossType]
			   @DataPkgKey					int
...
AS
-------------------------------------------------------------------------
-- [spHC_FactActivity_LoadInferred_DimHairLossType] is used to load inferred
-- members to the DimHairLossType table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimHairLossType] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
