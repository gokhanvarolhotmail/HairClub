/* CreateDate: 05/03/2010 12:27:05.930 , ModifyDate: 05/03/2010 12:27:05.930 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimAgeRange]
			   @DataPkgKey					int


AS
-------------------------------------------------------------------------
-- [spHC_FactLead_LoadInferred_DimAgeRange] is used to load inferred
-- members to the DimAgeRange table.
--
--
--   exec [bi_mktg_stage].[spHC_FactLead_LoadInferred_DimAgeRange] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
