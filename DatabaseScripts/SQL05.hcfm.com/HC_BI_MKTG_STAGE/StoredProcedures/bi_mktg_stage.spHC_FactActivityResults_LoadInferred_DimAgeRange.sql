/* CreateDate: 05/03/2010 12:26:54.563 , ModifyDate: 05/03/2010 12:26:54.563 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivityResults_LoadInferred_DimAgeRange]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactActivityResults_LoadInferred_DimAgeRange] is used to load inferred
-- members to the DimAgeRange table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivityResults_LoadInferred_DimAgeRange] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
