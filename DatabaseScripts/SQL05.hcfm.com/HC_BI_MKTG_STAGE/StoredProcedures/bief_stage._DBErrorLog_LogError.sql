/* CreateDate: 05/03/2010 12:26:23.200 , ModifyDate: 05/03/2010 12:26:23.200 */
GO
CREATE PROCEDURE [bief_stage].[_DBErrorLog_LogError]
(
...
BEGIN
	...
	SET @IsErrorLoggingEnabled = (SELECT [bief_stage].[fn_IsErrorLoggingEnabled]())
    ...
    BEGIN CATCH
        ...
        EXECUTE [bief_stage].[_DBErrorLog_PrintError];
        RETURN -1;
    END CATCH
END;
GO
