/* CreateDate: 05/03/2010 12:26:49.557 , ModifyDate: 09/14/2020 15:04:55.500 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_DQA_DimContactEmail_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimContactEmail_Upsert] loads data to Data Quality
-- table
--
--
--   exec [bi_mktg_stage].[spHC_DQA_DimContactEmail_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_mktg_stage].[synHC_DQA_DimContactEmail] DQA ON
				DQA.[SFDC_LeadEmailID] = STG.[SFDC_LeadEmailID]
		...
		-----------------------
		INSERT INTO [bi_mktg_stage].[synHC_DQA_DimContactEmail]
					( [DataPkgKey]
				    , [ContactEmailKey]
				    , [ContactEmailSSID]
				    , [ContactSSID]
