/* CreateDate: 08/05/2019 11:22:25.470 , ModifyDate: 08/06/2019 09:09:46.687 */
GO
CREATE PROCEDURE [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimActivity]
			   @DataPkgKey					int
...
AS
-------------------------------------------------------------------------
-- [spHC_FactActivity_LoadInferred_DimActivity] is used to load inferred
-- members to the DimActivity table.
--
--
--   exec [bi_mktg_stage].[spHC_FactActivity_LoadInferred_DimActivity] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
--			08/06/2019  KMurdoch	 Removed check for ActivitySSID
-------------------------------------------------------------------------
BEGIN
