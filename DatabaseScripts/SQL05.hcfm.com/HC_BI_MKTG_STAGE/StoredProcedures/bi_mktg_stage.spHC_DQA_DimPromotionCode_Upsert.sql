/* CreateDate: 02/02/2011 17:34:34.633 , ModifyDate: 02/02/2011 17:34:34.633 */
GO
create PROCEDURE [bi_mktg_stage].[spHC_DQA_DimPromotionCode_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimPromotionCode_Upsert] loads data to Data Quality
-- table
--
--
--   exec [bi_mktg_stage].[spHC_DQA_DimPromotionCode_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_mktg_stage].[synHC_DQA_DimPromotionCode] DQA ON
				DQA.[PromotionCodeSSID] = STG.[PromotionCodeSSID]
		...
		-----------------------
		INSERT INTO [bi_mktg_stage].[synHC_DQA_DimPromotionCode]
					( [DataPkgKey]
					, [PromotionCodeKey]
					, [PromotionCodeSSID]
