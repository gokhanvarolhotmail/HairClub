/* CreateDate: 06/11/2020 16:05:24.580 , ModifyDate: 06/11/2020 16:05:24.580 */
GO
CREATE VIEW [dbo].[vw_LeadTest]
AS
...
WHERE	l.Status IN ( 'Lead', 'Client', 'HWLead', 'HWClient' )
