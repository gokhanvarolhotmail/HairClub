/* CreateDate: 06/20/2018 11:33:30.820 , ModifyDate: 05/07/2019 08:48:04.993 */
GO
/***********************************************************************
PROCEDURE:				spSvc_GetEXTRebootJourney08Data
...
AND DoNotContact = 0
AND 4th Appointment = Tomorrow
------------------------------------------------------------------------
SAMPLE EXECUTION:

EXEC spSvc_GetEXTRebootJourney08Data NULL, NULL
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_GetEXTRebootJourney08Data]
(
...
-- Get Clients whose fourth appointment is tomorrow
DELETE a FROM #Appointment a WHERE a.RowID <> 4 OR a.AppointmentDate NOT BETWEEN @StartDate AND @EndDate
