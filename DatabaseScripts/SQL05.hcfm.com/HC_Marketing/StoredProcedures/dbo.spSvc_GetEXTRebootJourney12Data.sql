/* CreateDate: 06/20/2018 11:37:07.403 , ModifyDate: 05/07/2019 08:52:58.740 */
GO
/***********************************************************************
PROCEDURE:				spSvc_GetEXTRebootJourney12Data
...
AND DoNotContact = 0
AND 6th Appointment = Tomorrow
------------------------------------------------------------------------
SAMPLE EXECUTION:

EXEC spSvc_GetEXTRebootJourney12Data NULL, NULL
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_GetEXTRebootJourney12Data]
(
...
-- Get Clients whose sixth appointment is tomorrow
DELETE a FROM #Appointment a WHERE a.RowID <> 6 OR a.AppointmentDate NOT BETWEEN @StartDate AND @EndDate
