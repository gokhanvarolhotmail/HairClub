/* CreateDate: 06/20/2018 11:24:32.170 , ModifyDate: 05/07/2019 08:40:45.913 */
GO
/***********************************************************************
PROCEDURE:				spSvc_GetEXTRebootJourney04Data
...
AND DoNotContact = 0
AND 2nd Appointment = Tomorrow
------------------------------------------------------------------------
SAMPLE EXECUTION:

EXEC spSvc_GetEXTRebootJourney04Data NULL, NULL
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_GetEXTRebootJourney04Data]
(
...
-- Get Clients whose second appointment is tomorrow
DELETE a FROM #Appointment a WHERE a.RowID <> 2 OR a.AppointmentDate NOT BETWEEN @StartDate AND @EndDate
