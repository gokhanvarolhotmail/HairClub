/* CreateDate: 06/20/2018 10:00:46.440 , ModifyDate: 10/22/2018 10:07:55.310 */
GO
/***********************************************************************
PROCEDURE:				spSvc_GetEXTRebootJourney01Data
...
AND DoNotContact = 0
AND ClientCreationDate = Yesterday
------------------------------------------------------------------------
SAMPLE EXECUTION:

EXEC spSvc_GetEXTRebootJourney01Data NULL, NULL
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_GetEXTRebootJourney01Data]
(
...
INSERT	INTO #ClientMembership
		...
		WHERE	( ( ctr.CenterNumber IN ( 283, 237, 284, 285, 263 ) AND dcm.BeginDate >= '8/1/2018' AND dcm.BeginDate BETWEEN @StartDate AND @EndDate )
					OR ( ctr.CenterNumber NOT IN ( 283, 237, 284, 285, 263 ) AND ctr.CenterNumber LIKE '[2]%' AND dcm.BeginDate >= '9/28/2018' AND dcm.BeginDate BETWEEN @StartDate AND @EndDate ) )
