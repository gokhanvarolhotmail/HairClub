/* CreateDate: 06/20/2018 11:21:08.157 , ModifyDate: 05/07/2019 08:46:18.190 */
GO
/***********************************************************************
PROCEDURE:				spSvc_GetEXTRebootJourney03Data
...
AND DoNotContact = 0
AND 1st Appointment = Yesterday
AND Client was Checked In & Out
------------------------------------------------------------------------
SAMPLE EXECUTION:

EXEC spSvc_GetEXTRebootJourney03Data NULL, NULL
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_GetEXTRebootJourney03Data]
(
...
-- Get Clients who showed for their first appointment yesterday
DELETE a FROM #Appointment a WHERE a.RowID <> 1 OR a.CheckedInFlag <> 1 OR a.AppointmentDate NOT BETWEEN @StartDate AND @EndDate
