/* CreateDate: 10/24/2017 18:10:17.257 , ModifyDate: 10/22/2018 10:34:54.820 */
GO
/***********************************************************************
PROCEDURE:				spSvc_GetNewBusinessNewClientData
...
AND ClientCreateDate is exactly 1 day ago
...
EXEC spSvc_GetNewBusinessNewClientData NULL, NULL
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_GetNewBusinessNewClientData]
(
...
INSERT	INTO #Client
		...
		WHERE	clt.CreateDate BETWEEN @StartDate AND @EndDate -- Client Created Yesterday
...
,		clt.SolutionOffered
,		clt.PerformerName
,		ISNULL(CONVERT(VARCHAR(11), CAST(clt.ClientCreationDate AS DATE), 101), '') AS 'ActivityDueDate'
,       clt.Language
...
WHERE	clt.EmailAddress <> '' -- Email Address cannot be empty
		...
		AND ( ( cm_xtrp.RevenueGroup = 'New Business' AND cm_xtrp.MembershipStatus = 'Active' AND cm_xtrp.Membership <> 'New Client (ShowNoSale)' ) -- Active Xtrands Plus Membership
				OR ( cm_ext.RevenueGroup = 'New Business' AND cm_ext.MembershipStatus = 'Active' ) -- Active EXT Membership
				OR ( cm_xtr.RevenueGroup = 'New Business' AND cm_xtr.MembershipStatus = 'Active' ) -- Active Xtrands Membership
				OR ( cm_sur.RevenueGroup = 'New Business' AND cm_sur.MembershipStatus = 'Active' AND cm_sur.Membership <> 'New Client (Surgery Offered)' ) ) -- Active Surgery Membership
