/* CreateDate: 06/20/2018 10:32:06.350 , ModifyDate: 05/07/2019 08:35:30.987 */
GO
/***********************************************************************
PROCEDURE:				spSvc_GetEXTRebootJourney02Data
...
AND DoNotContact = 0
AND 1st Appointment = Tomorrow
------------------------------------------------------------------------
SAMPLE EXECUTION:

EXEC spSvc_GetEXTRebootJourney02Data NULL, NULL
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_GetEXTRebootJourney02Data]
(
...
-- Get Clients whose first appointment is tomorrow
DELETE a FROM #Appointment a WHERE a.RowID <> 1 OR a.AppointmentDate NOT BETWEEN @StartDate AND @EndDate
