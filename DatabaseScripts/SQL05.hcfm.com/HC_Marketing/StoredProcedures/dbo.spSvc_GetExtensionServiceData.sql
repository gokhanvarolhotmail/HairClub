/* CreateDate: 05/22/2018 13:24:40.767 , ModifyDate: 10/22/2018 10:34:16.297 */
GO
/***********************************************************************
PROCEDURE:				spSvc_GetExtensionServiceData
...
EXEC spSvc_GetExtensionServiceData NULL, NULL
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_GetExtensionServiceData]
(
...
INSERT	INTO #Service
		...
		WHERE   so.OrderDate BETWEEN @StartDate AND @EndDate
				AND sc.SalesCodeDescriptionShort IN ( 'TAPESVC' )
