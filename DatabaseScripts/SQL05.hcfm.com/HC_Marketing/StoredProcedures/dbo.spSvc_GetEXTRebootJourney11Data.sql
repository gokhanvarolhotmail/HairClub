/* CreateDate: 06/20/2018 11:35:19.910 , ModifyDate: 05/07/2019 08:51:42.297 */
GO
/***********************************************************************
PROCEDURE:				spSvc_GetEXTRebootJourney11Data
...
AND DoNotContact = 0
AND 5th Appointment = Yesterday
AND Client was Checked In & Out
------------------------------------------------------------------------
SAMPLE EXECUTION:

EXEC spSvc_GetEXTRebootJourney11Data NULL, NULL
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_GetEXTRebootJourney11Data]
(
...
-- Get Clients who showed for their fifth appointment yesterday
DELETE a FROM #Appointment a WHERE a.RowID <> 5 OR a.CheckedInFlag <> 1 OR a.AppointmentDate NOT BETWEEN @StartDate AND @EndDate
