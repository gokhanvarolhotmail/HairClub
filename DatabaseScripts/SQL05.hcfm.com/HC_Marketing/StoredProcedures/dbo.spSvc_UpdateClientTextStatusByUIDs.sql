/* CreateDate: 10/19/2016 16:30:50.173 , ModifyDate: 10/19/2016 16:30:50.173 */
GO
/***********************************************************************
PROCEDURE:				spSvc_UpdateClientTextStatusByUIDs
...
EXEC spSvc_UpdateClientTextStatusByUIDs 'invalidRecipient', NULL, 'DLVR-Fail', '4080,4132'
***********************************************************************/
CREATE PROCEDURE [dbo].spSvc_UpdateClientTextStatusByUIDs
(
...
FROM    datClientMessageLog CML
		...
		INNER JOIN dbo.fnSplit(@UIDList, ',') s_UID
			ON s_UID.item = CML.ClientMessageLogID
