/* CreateDate: 10/24/2017 18:29:49.117 , ModifyDate: 10/22/2018 10:34:36.313 */
GO
/***********************************************************************
PROCEDURE:				spSvc_GetRecurringBusinessCancelData
...
AND RevenueGroup = Recurring Business
...
EXEC spSvc_GetRecurringBusinessCancelData NULL, NULL
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_GetRecurringBusinessCancelData]
(
