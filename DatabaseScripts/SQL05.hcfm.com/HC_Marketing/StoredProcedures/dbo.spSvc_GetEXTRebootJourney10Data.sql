/* CreateDate: 06/20/2018 11:34:50.170 , ModifyDate: 05/07/2019 08:50:43.420 */
GO
/***********************************************************************
PROCEDURE:				spSvc_GetEXTRebootJourney10Data
...
AND DoNotContact = 0
AND 5th Appointment = Tomorrow
------------------------------------------------------------------------
SAMPLE EXECUTION:

EXEC spSvc_GetEXTRebootJourney10Data NULL, NULL
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_GetEXTRebootJourney10Data]
(
...
-- Get Clients whose fifth appointment is tomorrow
DELETE a FROM #Appointment a WHERE a.RowID <> 5 OR a.AppointmentDate NOT BETWEEN @StartDate AND @EndDate
