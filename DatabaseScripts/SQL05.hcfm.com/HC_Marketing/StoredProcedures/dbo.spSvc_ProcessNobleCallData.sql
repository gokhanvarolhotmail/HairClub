/* CreateDate: 06/08/2020 15:24:00.003 , ModifyDate: 06/09/2020 16:26:03.497 */
GO
/***********************************************************************
PROCEDURE:				spSvc_ProcessNobleCallData
...
EXEC spSvc_ProcessNobleCallData
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_ProcessNobleCallData]
AS
BEGIN
