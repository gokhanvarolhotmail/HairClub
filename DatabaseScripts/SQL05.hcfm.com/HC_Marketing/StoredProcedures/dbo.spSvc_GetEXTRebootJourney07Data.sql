/* CreateDate: 06/20/2018 11:31:50.263 , ModifyDate: 05/07/2019 08:45:49.210 */
GO
/***********************************************************************
PROCEDURE:				spSvc_GetEXTRebootJourney07Data
...
AND DoNotContact = 0
AND 3rd Appointment = Yesterday
AND Client was Checked In & Out
------------------------------------------------------------------------
SAMPLE EXECUTION:

EXEC spSvc_GetEXTRebootJourney07Data NULL, NULL
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_GetEXTRebootJourney07Data]
(
...
-- Get Clients who showed for their third appointment yesterday
DELETE a FROM #Appointment a WHERE a.RowID <> 3 OR a.CheckedInFlag <> 1 OR a.AppointmentDate NOT BETWEEN @StartDate AND @EndDate
