/* CreateDate: 06/20/2018 11:34:01.803 , ModifyDate: 05/07/2019 08:49:07.843 */
GO
/***********************************************************************
PROCEDURE:				spSvc_GetEXTRebootJourney09Data
...
AND DoNotContact = 0
AND 4th Appointment = Yesterday
AND Client was Checked In & Out
------------------------------------------------------------------------
SAMPLE EXECUTION:

EXEC spSvc_GetEXTRebootJourney09Data NULL, NULL
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_GetEXTRebootJourney09Data]
(
...
-- Get Clients who showed for their fourth appointment yesterday
DELETE a FROM #Appointment a WHERE a.RowID <> 4 OR a.CheckedInFlag <> 1 OR a.AppointmentDate NOT BETWEEN @StartDate AND @EndDate
