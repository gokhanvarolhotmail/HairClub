/* CreateDate: 06/20/2018 11:31:05.943 , ModifyDate: 05/07/2019 08:44:20.643 */
GO
/***********************************************************************
PROCEDURE:				spSvc_GetEXTRebootJourney06Data
...
AND DoNotContact = 0
AND 3rd Appointment = Tomorrow
------------------------------------------------------------------------
SAMPLE EXECUTION:

EXEC spSvc_GetEXTRebootJourney06Data NULL, NULL
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_GetEXTRebootJourney06Data]
(
...
-- Get Clients whose third appointment is tomorrow
DELETE a FROM #Appointment a WHERE a.RowID <> 3 OR a.AppointmentDate NOT BETWEEN @StartDate AND @EndDate
