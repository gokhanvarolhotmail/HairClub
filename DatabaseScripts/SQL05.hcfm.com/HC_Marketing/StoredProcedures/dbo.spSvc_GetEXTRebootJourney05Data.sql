/* CreateDate: 06/20/2018 11:25:32.580 , ModifyDate: 05/07/2019 08:46:41.317 */
GO
/***********************************************************************
PROCEDURE:				spSvc_GetEXTRebootJourney05Data
...
AND DoNotContact = 0
AND 2nd Appointment = Yesterday
AND Client was Checked In & Out
------------------------------------------------------------------------
SAMPLE EXECUTION:

EXEC spSvc_GetEXTRebootJourney05Data NULL, NULL
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_GetEXTRebootJourney05Data]
(
...
-- Get Clients who showed for their second appointment yesterday
DELETE a FROM #Appointment a WHERE a.RowID <> 2 OR a.CheckedInFlag <> 1 OR a.AppointmentDate NOT BETWEEN @StartDate AND @EndDate
