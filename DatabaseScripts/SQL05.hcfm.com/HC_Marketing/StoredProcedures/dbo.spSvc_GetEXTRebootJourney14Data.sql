/* CreateDate: 06/20/2018 11:38:31.773 , ModifyDate: 05/07/2019 08:54:39.863 */
GO
/***********************************************************************
PROCEDURE:				spSvc_GetEXTRebootJourney14Data
...
AND DoNotContact = 0
AND 7th Appointment = Tomorrow
------------------------------------------------------------------------
SAMPLE EXECUTION:

EXEC spSvc_GetEXTRebootJourney14Data NULL, NULL
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_GetEXTRebootJourney14Data]
(
...
-- Get Clients whose seventh appointment is tomorrow
DELETE a FROM #Appointment a WHERE a.RowID <> 7 OR a.AppointmentDate NOT BETWEEN @StartDate AND @EndDate
