/* CreateDate: 06/20/2018 11:37:48.327 , ModifyDate: 05/07/2019 08:53:48.817 */
GO
/***********************************************************************
PROCEDURE:				spSvc_GetEXTRebootJourney13Data
...
AND DoNotContact = 0
AND 6th Appointment = Yesterday
AND Client was Checked In & Out
------------------------------------------------------------------------
SAMPLE EXECUTION:

EXEC spSvc_GetEXTRebootJourney13Data NULL, NULL
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_GetEXTRebootJourney13Data]
(
...
-- Get Clients who showed for their sixth appointment yesterday
DELETE a FROM #Appointment a WHERE a.RowID <> 6 OR a.CheckedInFlag <> 1 OR a.AppointmentDate NOT BETWEEN @StartDate AND @EndDate
