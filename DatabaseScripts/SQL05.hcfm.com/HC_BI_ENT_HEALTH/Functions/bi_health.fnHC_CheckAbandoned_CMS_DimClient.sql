/* CreateDate: 10/25/2011 14:47:10.280 , ModifyDate: 10/25/2011 14:47:10.280 */
GO
create    FUNCTION [bi_health].[fnHC_CheckAbandoned_CMS_DimClient] (@FromDate datetime, @ToDate DateTime)
-----------------------------------------------------------------------
-- [fnHC_CheckAbandoned_CMS_DimClient]
--
--SELECT * FROM [bi_health].[fnHC_CheckAbandoned_CMS_DimClient]('01/01/00',getdate()-1)
-----------------------------------------------------------------------
-- Change History
-----------------------------------------------------------------------
...
BEGIN
	...
	DECLARE	 @TableName				varchar(150)	-- Name of table
 	...
 	SET @TableName = N'[bi_cms_stage].[DimClient]'
	...
	,   meta.[Status]
	FROM [bi_health].[synHC_STG_TBL_CMS_DimClient] stg WITH (NOLOCK)
