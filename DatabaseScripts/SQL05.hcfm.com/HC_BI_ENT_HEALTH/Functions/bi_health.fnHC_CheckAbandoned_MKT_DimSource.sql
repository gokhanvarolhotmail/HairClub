/* CreateDate: 10/25/2011 14:39:51.587 , ModifyDate: 10/25/2011 14:39:51.587 */
GO
create    FUNCTION [bi_health].[fnHC_CheckAbandoned_MKT_DimSource] (@FromDate datetime, @ToDate DateTime)
-----------------------------------------------------------------------
-- [fnHC_CheckAbandoned_MKT_DimSource]
--
--SELECT * FROM [bi_health].[fnHC_CheckAbandoned_MKT_DimSource]('01/01/00',getdate()-1)
-----------------------------------------------------------------------
-- Change History
-----------------------------------------------------------------------
...
BEGIN
	...
	DECLARE	 @TableName				varchar(150)	-- Name of table
 	...
 	SET @TableName = N'[bi_mktg_stage].[DimSource]'
	...
	,   meta.[Status]
	FROM [bi_health].[synHC_STG_TBL_MKTG_DimSource] stg WITH (NOLOCK)
