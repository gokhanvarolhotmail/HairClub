/* CreateDate: 10/25/2011 15:49:26.853 , ModifyDate: 10/25/2011 15:49:26.853 */
GO
CREATE    FUNCTION [bi_health].[fnHC_CheckAbandoned_ENT_DimRegion] (@FromDate datetime, @ToDate DateTime)
-----------------------------------------------------------------------
-- [fnHC_CheckAbandoned_ENT_DimRegion]
--
--SELECT * FROM [bi_health].[fnHC_CheckAbandoned_ENT_DimRegion]('01/01/00',getdate()-1)
-----------------------------------------------------------------------
-- Change History
-----------------------------------------------------------------------
...
BEGIN
	...
	DECLARE	 @TableName				varchar(150)	-- Name of table
 	...
 	SET @TableName = N'[bi_ent_stage].[DimRegion]'
	...
	,   meta.[Status]
	FROM [bi_health].[synHC_STG_TBL_ENT_DimRegion] stg WITH (NOLOCK)
