/* CreateDate: 10/25/2011 15:08:24.407 , ModifyDate: 10/25/2011 15:08:24.407 */
GO
create    FUNCTION [bi_health].[fnHC_CheckAbandoned_CMS_FactSales] (@FromDate datetime, @ToDate DateTime)
-----------------------------------------------------------------------
-- [fnHC_CheckAbandoned_CMS_FactSales]
--
--SELECT * FROM [bi_health].[fnHC_CheckAbandoned_CMS_FactSales]('01/01/00',getdate()-1)
-----------------------------------------------------------------------
-- Change History
-----------------------------------------------------------------------
...
BEGIN
	...
	DECLARE	 @TableName				varchar(150)	-- Name of table
 	...
 	SET @TableName = N'[bi_cms_stage].[FactSales]'
	...
	,   meta.[Status]
	FROM [bi_health].[synHC_STG_TBL_CMS_FactSales] stg WITH (NOLOCK)
