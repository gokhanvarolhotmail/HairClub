/* CreateDate: 10/25/2011 14:35:25.983 , ModifyDate: 10/25/2011 14:35:25.983 */
GO
create    FUNCTION [bi_health].[fnHC_CheckAbandoned_MKT_DimContact] (@FromDate datetime, @ToDate DateTime)
-----------------------------------------------------------------------
-- [fnHC_CheckAbandoned_MKT_DimContact]
--
--SELECT * FROM [bi_health].[fnHC_CheckAbandoned_MKT_DimContact]('01/01/00',getdate()-1)
-----------------------------------------------------------------------
-- Change History
-----------------------------------------------------------------------
...
BEGIN
	...
	DECLARE	 @TableName				varchar(150)	-- Name of table
 	...
 	SET @TableName = N'[bi_mktg_stage].[DimContact]'
	...
	,   meta.[Status]
	FROM [bi_health].[synHC_STG_TBL_MKTG_DimContact] stg WITH (NOLOCK)
