/* CreateDate: 05/03/2010 19:50:21.207 , ModifyDate: 05/06/2010 16:42:26.833 */
GO
CREATE PROCEDURE [bi_health].[spHC_ListCDC_DimActivity]
		  @TimeIncrement		int = 1
...
-----------------------------------------------------------------------
-- [bi_health].[spHC_NumCDC_DimActivity]
--
-- EXEC [bi_health].[spHC_ListCDC_DimActivity] 5, 'DAY'
-----------------------------------------------------------------------
-- Change History
-----------------------------------------------------------------------
...
BEGIN
		...
		DECLARE	  @Start_Time			datetime = null
				...
				, @CDCTableName			varchar(150) = N'dbo_oncd_activity'	-- Name of CDC table
				, @From_LSN				binary(10)
				, @To_LSN				binary(10)
