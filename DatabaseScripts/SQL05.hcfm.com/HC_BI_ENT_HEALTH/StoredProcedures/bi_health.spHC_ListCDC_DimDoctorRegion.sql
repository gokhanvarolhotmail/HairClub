/* CreateDate: 04/25/2011 12:03:19.497 , ModifyDate: 04/25/2011 12:03:19.497 */
GO
CREATE PROCEDURE [bi_health].[spHC_ListCDC_DimDoctorRegion]
		  @TimeIncrement		int = 1
...
-----------------------------------------------------------------------
-- [bi_health].[spHC_NumCDC_DimDoctorRegion]
--
-- EXEC [bi_health].[spHC_ListCDC_DimDoctorRegion] 5, 'DAY'
-----------------------------------------------------------------------
-- Change History
-----------------------------------------------------------------------
...
BEGIN
		...
		DECLARE	  @Start_Time			datetime = null
				...
				, @CDCTableName			varchar(150) = N'dbo_lkpDoctorRegion'	-- Name of CDC table
				, @From_LSN				binary(10)
				, @To_LSN				binary(10)
