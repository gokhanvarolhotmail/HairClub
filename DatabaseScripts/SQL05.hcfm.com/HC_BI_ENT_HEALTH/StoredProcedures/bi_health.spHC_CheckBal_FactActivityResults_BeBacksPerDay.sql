/* CreateDate: 10/27/2011 13:06:45.153 , ModifyDate: 12/14/2012 15:13:54.820 */
GO
CREATE PROCEDURE [bi_health].[spHC_CheckBal_FactActivityResults_BeBacksPerDay]
(@BegDate date = null,@EndDate date = null)

AS

-----------------------------------------------------------------------
-- [bi_health].[spHC_CheckBal_FactActivityResults_BeBacksPerDay]
--
-- EXEC [bi_health].[spHC_CheckBal_FactActivityResults_BeBacksPerDay] '01/01/07', '10/26/11'
-----------------------------------------------------------------------
-- Change History
-----------------------------------------------------------------------
...
--
	...
	SELECT
		...
		,	sum(far.BeBack) as 'WarehouseCount'
	INTO #WHAudit
