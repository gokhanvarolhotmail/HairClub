/* CreateDate: 05/03/2010 19:54:18.623 , ModifyDate: 05/03/2010 19:54:18.623 */
GO
CREATE PROCEDURE [bi_health].[spHC_ListCDC_DimActionCode]
		  @TimeIncrement		int = 1
...
-----------------------------------------------------------------------
-- [bi_health].[spHC_NumCDC_DimActionCode]
--
-- EXEC [bi_health].[spHC_ListCDC_DimActionCode] 5, 'DAY'
-----------------------------------------------------------------------
-- Change History
-----------------------------------------------------------------------
...
BEGIN
		...
		DECLARE	  @Start_Time			datetime = null
				...
				, @CDCTableName			varchar(150) = N'dbo_onca_action'	-- Name of CDC table
				, @From_LSN				binary(10)
				, @To_LSN				binary(10)
