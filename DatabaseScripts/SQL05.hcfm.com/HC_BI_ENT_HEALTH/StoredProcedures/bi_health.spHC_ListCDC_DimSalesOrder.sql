/* CreateDate: 05/03/2010 15:57:08.840 , ModifyDate: 05/03/2010 16:02:03.713 */
GO
CREATE PROCEDURE [bi_health].[spHC_ListCDC_DimSalesOrder]
		  @TimeIncrement		int = 1
...
-----------------------------------------------------------------------
-- [bi_health].[spHC_NumCDC_DimSalesOrder]
--
-- EXEC [bi_health].[spHC_ListCDC_DimSalesOrder] 5, 'DAY'
-----------------------------------------------------------------------
-- Change History
-----------------------------------------------------------------------
...
BEGIN
		...
		DECLARE	  @Start_Time			datetime = null
				...
				, @CDCTableName			varchar(150) = N'dbo_datSalesOrder'	-- Name of CDC table
				, @From_LSN				binary(10)
				, @To_LSN				binary(10)
