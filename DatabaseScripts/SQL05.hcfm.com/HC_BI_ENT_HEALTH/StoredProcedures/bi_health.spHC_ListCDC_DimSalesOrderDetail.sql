/* CreateDate: 05/03/2010 16:03:43.797 , ModifyDate: 05/03/2010 16:03:43.797 */
GO
CREATE PROCEDURE [bi_health].[spHC_ListCDC_DimSalesOrderDetail]
		  @TimeIncrement		int = 1
...
-----------------------------------------------------------------------
-- [bi_health].[spHC_NumCDC_DimSalesOrderDetail]
--
-- EXEC [bi_health].[spHC_ListCDC_DimSalesOrderDetail] 5, 'DAY'
-----------------------------------------------------------------------
-- Change History
-----------------------------------------------------------------------
...
BEGIN
		...
		DECLARE	  @Start_Time			datetime = null
				...
				, @CDCTableName			varchar(150) = N'dbo_datSalesOrderDetail'	-- Name of CDC table
				, @From_LSN				binary(10)
				, @To_LSN				binary(10)
