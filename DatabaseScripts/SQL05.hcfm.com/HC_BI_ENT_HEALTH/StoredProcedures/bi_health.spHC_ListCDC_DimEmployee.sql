/* CreateDate: 05/03/2010 16:06:27.020 , ModifyDate: 05/03/2010 16:06:27.020 */
GO
CREATE PROCEDURE [bi_health].[spHC_ListCDC_DimEmployee]
		  @TimeIncrement		int = 1
...
BEGIN
		...
		DECLARE	  @Start_Time			datetime = null
				...
				, @CDCTableName			varchar(150) = N'dbo_datEmployee'	-- Name of CDC table
				, @From_LSN				binary(10)
				, @To_LSN				binary(10)
