/* CreateDate: 05/03/2010 16:05:13.267 , ModifyDate: 05/03/2010 16:05:13.267 */
GO
CREATE PROCEDURE [bi_health].[spHC_ListCDC_DimSalesOrderTender]
		  @TimeIncrement		int = 1
...
-----------------------------------------------------------------------
-- [bi_health].[spHC_NumCDC_DimSalesOrderTender]
--
-- EXEC [bi_health].[spHC_ListCDC_DimSalesOrderTender] 5, 'DAY'
-----------------------------------------------------------------------
-- Change History
-----------------------------------------------------------------------
...
BEGIN
		...
		DECLARE	  @Start_Time			datetime = null
				...
				, @CDCTableName			varchar(150) = N'dbo_datSalesOrderTender'	-- Name of CDC table
				, @From_LSN				binary(10)
				, @To_LSN				binary(10)
