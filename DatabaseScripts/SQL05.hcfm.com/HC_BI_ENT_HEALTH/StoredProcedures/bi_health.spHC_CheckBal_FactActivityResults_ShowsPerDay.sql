/* CreateDate: 10/27/2011 12:56:42.420 , ModifyDate: 12/14/2012 15:14:56.483 */
GO
CREATE PROCEDURE [bi_health].[spHC_CheckBal_FactActivityResults_ShowsPerDay]
(@BegDate date = null,@EndDate date = null)

AS

-----------------------------------------------------------------------
-- [bi_health].[spHC_CheckBal_FactActivityResults_ShowsPerDay]
--
-- EXEC [bi_health].[spHC_CheckBal_FactActivityResults_ShowsPerDay] '01/01/07', '10/26/11'
-----------------------------------------------------------------------
-- Change History
-----------------------------------------------------------------------
...
--
	...
	SELECT
		...
		,	sum(far.Show) as 'WarehouseCount'
	INTO #WHAudit
