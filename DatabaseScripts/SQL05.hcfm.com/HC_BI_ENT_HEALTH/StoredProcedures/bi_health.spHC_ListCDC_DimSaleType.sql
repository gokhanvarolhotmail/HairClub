/* CreateDate: 05/03/2010 20:10:50.633 , ModifyDate: 05/03/2010 20:10:50.633 */
GO
CREATE PROCEDURE [bi_health].[spHC_ListCDC_DimSaleType]
		  @TimeIncrement		int = 1
...
-----------------------------------------------------------------------
-- [bi_health].[spHC_NumCDC_DimSaleType]
--
-- EXEC [bi_health].[spHC_ListCDC_DimSaleType] 5, 'DAY'
-----------------------------------------------------------------------
-- Change History
-----------------------------------------------------------------------
...
BEGIN
		...
		DECLARE	  @Start_Time			datetime = null
				...
				, @CDCTableName			varchar(150) = N'dbo_csta_contact_saletype'	-- Name of CDC table
				, @From_LSN				binary(10)
				, @To_LSN				binary(10)
