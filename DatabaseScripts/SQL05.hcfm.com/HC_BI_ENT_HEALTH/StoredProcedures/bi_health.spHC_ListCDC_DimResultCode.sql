/* CreateDate: 05/03/2010 19:53:15.220 , ModifyDate: 05/03/2010 19:53:15.220 */
GO
CREATE PROCEDURE [bi_health].[spHC_ListCDC_DimResultCode]
		  @TimeIncrement		int = 1
...
-----------------------------------------------------------------------
-- [bi_health].[spHC_NumCDC_DimResultCode]
--
-- EXEC [bi_health].[spHC_ListCDC_DimResultCode] 5, 'DAY'
-----------------------------------------------------------------------
-- Change History
-----------------------------------------------------------------------
...
BEGIN
		...
		DECLARE	  @Start_Time			datetime = null
				...
				, @CDCTableName			varchar(150) = N'dbo_onca_result'	-- Name of CDC table
				, @From_LSN				binary(10)
				, @To_LSN				binary(10)
