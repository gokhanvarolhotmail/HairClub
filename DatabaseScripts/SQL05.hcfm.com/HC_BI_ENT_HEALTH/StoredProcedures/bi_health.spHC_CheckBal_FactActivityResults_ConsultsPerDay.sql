/* CreateDate: 10/27/2011 13:05:26.927 , ModifyDate: 12/14/2012 15:14:25.680 */
GO
CREATE PROCEDURE [bi_health].[spHC_CheckBal_FactActivityResults_ConsultsPerDay]
(@BegDate date = null,@EndDate date = null)

AS

-----------------------------------------------------------------------
-- [bi_health].[spHC_CheckBal_FactActivityResults_ConsultsPerDay]
--
-- EXEC [bi_health].[spHC_CheckBal_FactActivityResults_ConsultsPerDay] '01/01/07', '10/26/11'
-----------------------------------------------------------------------
-- Change History
-----------------------------------------------------------------------
...
--
	...
	SELECT
		...
		,	sum(far.Consultation) as 'WarehouseCount'
	INTO #WHAudit
