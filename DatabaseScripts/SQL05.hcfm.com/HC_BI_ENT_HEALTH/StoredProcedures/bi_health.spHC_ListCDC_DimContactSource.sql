/* CreateDate: 05/03/2010 19:59:07.823 , ModifyDate: 05/03/2010 20:00:11.037 */
GO
CREATE PROCEDURE [bi_health].[spHC_ListCDC_DimContactSource]
		  @TimeIncrement		int = 1
...
-----------------------------------------------------------------------
-- [bi_health].[spHC_NumCDC_DimContactSource]
--
-- EXEC [bi_health].[spHC_ListCDC_DimContactSource] 5, 'DAY'
-----------------------------------------------------------------------
-- Change History
-----------------------------------------------------------------------
...
BEGIN
		...
		DECLARE	  @Start_Time			datetime = null
				...
				, @CDCTableName			varchar(150) = N'dbo_oncd_contact_source'	-- Name of CDC table
				, @From_LSN				binary(10)
				, @To_LSN				binary(10)
