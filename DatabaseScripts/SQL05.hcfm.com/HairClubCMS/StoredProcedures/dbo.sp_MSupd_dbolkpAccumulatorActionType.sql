/* CreateDate: 05/05/2020 17:42:37.270 , ModifyDate: 05/05/2020 17:42:37.270 */
GO
create procedure [sp_MSupd_dbolkpAccumulatorActionType]
		@c1 int = NULL,
		@c2 int = NULL,
...
begin
update [dbo].[lkpAccumulatorActionType] set
		[AccumulatorActionTypeID] = case substring(@bitmap,1,1) & 1 when 1 then @c1 else [AccumulatorActionTypeID] end,
		[AccumulatorActionTypeSortOrder] = case substring(@bitmap,1,1) & 2 when 2 then @c2 else [AccumulatorActionTypeSortOrder] end,
	...
	where [AccumulatorActionTypeID] = @pkc1
if @@rowcount = 0
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				set @primarykey_text = @primarykey_text + '[AccumulatorActionTypeID] = ' + convert(nvarchar(100),@pkc1,1)
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[dbo].[lkpAccumulatorActionType]', @param2=@primarykey_text, @param3=13233
			End
			Else
