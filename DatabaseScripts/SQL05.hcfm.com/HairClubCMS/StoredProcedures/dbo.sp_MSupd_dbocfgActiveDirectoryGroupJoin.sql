/* CreateDate: 05/05/2020 17:42:38.447 , ModifyDate: 05/05/2020 17:42:38.447 */
GO
create procedure [sp_MSupd_dbocfgActiveDirectoryGroupJoin]
		@c1 int = NULL,
		@c2 int = NULL,
		@c3 datetime = NULL,
		@c4 nvarchar(25) = NULL,
...
begin
update [dbo].[cfgActiveDirectoryGroupJoin] set
		[ActiveDirectoryGroupID] = case substring(@bitmap,1,1) & 1 when 1 then @c1 else [ActiveDirectoryGroupID] end,
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[dbo].[cfgActiveDirectoryGroupJoin]', @param2=@primarykey_text, @param3=13233
			End
			Else
