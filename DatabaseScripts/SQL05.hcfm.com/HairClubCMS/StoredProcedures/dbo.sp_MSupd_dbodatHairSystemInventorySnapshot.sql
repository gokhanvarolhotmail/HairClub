/* CreateDate: 05/05/2020 17:42:50.060 , ModifyDate: 05/05/2020 17:42:50.060 */
GO
create procedure [sp_MSupd_dbodatHairSystemInventorySnapshot]
		@c1 int = NULL,
		@c2 datetime = NULL,
...
update [dbo].[datHairSystemInventorySnapshot] set
	...
	where [HairSystemInventorySnapshotID] = @pkc1
if @@rowcount = 0
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				set @primarykey_text = @primarykey_text + '[HairSystemInventorySnapshotID] = ' + convert(nvarchar(100),@pkc1,1)
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[dbo].[datHairSystemInventorySnapshot]', @param2=@primarykey_text, @param3=13233
			End
			Else
