/* CreateDate: 05/05/2020 17:42:43.340 , ModifyDate: 05/05/2020 17:42:43.340 */
GO
create procedure [sp_MSupd_dbocfgHairSystemHairMaterialJoin]
		@c1 int = NULL,
		@c2 int = NULL,
		@c3 int = NULL,
		@c4 datetime = NULL,
...
update [dbo].[cfgHairSystemHairMaterialJoin] set
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[dbo].[cfgHairSystemHairMaterialJoin]', @param2=@primarykey_text, @param3=13233
			End
			Else
