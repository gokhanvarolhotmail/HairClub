/* CreateDate: 05/05/2020 17:42:39.913 , ModifyDate: 05/05/2020 17:42:39.913 */
GO
create procedure [sp_MSupd_dbocfgCenterFeePayCycle]
		@c1 int = NULL,
		@c2 int = NULL,
		@c3 int = NULL,
		@c4 datetime = NULL,
...
update [dbo].[cfgCenterFeePayCycle] set
	...
	where [CenterFeePayCycleID] = @pkc1
if @@rowcount = 0
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				set @primarykey_text = @primarykey_text + '[CenterFeePayCycleID] = ' + convert(nvarchar(100),@pkc1,1)
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[dbo].[cfgCenterFeePayCycle]', @param2=@primarykey_text, @param3=13233
			End
			Else
