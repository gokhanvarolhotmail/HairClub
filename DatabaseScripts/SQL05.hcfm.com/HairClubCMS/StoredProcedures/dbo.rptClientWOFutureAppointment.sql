/* CreateDate: 12/12/2019 16:07:01.790 , ModifyDate: 12/12/2019 16:40:30.060 */
GO
/*===============================================================================================
...
CREATE NONCLUSTERED INDEX IDX_RevGroup_RevenueGroupID ON #RevGroup ( RevGroupID );
...
CREATE NONCLUSTERED INDEX IDX_BusSegment_BusinessSegmentID ON #BusSegment (  BusSegmentID );
...
CREATE NONCLUSTERED INDEX IDX_Multiples_item ON #Multiples ( MembershipID );
...
WHERE --CLT.CenterID = @CenterID
 ...
 CREATE NONCLUSTERED INDEX IDX_Membership_BeginDate ON #Membership ( BeginDate );
 CREATE NONCLUSTERED INDEX IDX_Membership_EndDate ON #Membership ( EndDate );
