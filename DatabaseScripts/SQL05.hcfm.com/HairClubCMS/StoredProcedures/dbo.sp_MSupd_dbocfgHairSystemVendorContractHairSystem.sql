/* CreateDate: 05/05/2020 17:42:44.240 , ModifyDate: 05/05/2020 17:42:44.240 */
GO
create procedure [sp_MSupd_dbocfgHairSystemVendorContractHairSystem]
		@c1 int = NULL,
		@c2 int = NULL,
		@c3 int = NULL,
		@c4 datetime = NULL,
...
update [dbo].[cfgHairSystemVendorContractHairSystem] set
	...
	where [HairSystemVendorContractHairSystemID] = @pkc1
if @@rowcount = 0
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				set @primarykey_text = @primarykey_text + '[HairSystemVendorContractHairSystemID] = ' + convert(nvarchar(100),@pkc1,1)
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[dbo].[cfgHairSystemVendorContractHairSystem]', @param2=@primarykey_text, @param3=13233
			End
			Else
