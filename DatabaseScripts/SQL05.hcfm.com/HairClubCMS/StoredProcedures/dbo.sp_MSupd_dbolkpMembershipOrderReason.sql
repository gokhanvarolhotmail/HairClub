/* CreateDate: 05/05/2020 17:42:45.790 , ModifyDate: 05/05/2020 17:42:45.790 */
GO
create procedure [sp_MSupd_dbolkpMembershipOrderReason]
		@c1 int = NULL,
		@c2 int = NULL,
		@c3 int = NULL,
...
begin
update [dbo].[lkpMembershipOrderReason] set
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[dbo].[lkpMembershipOrderReason]', @param2=@primarykey_text, @param3=13233
			End
			Else
