/* CreateDate: 05/05/2020 17:42:43.290 , ModifyDate: 05/05/2020 17:42:43.290 */
GO
create procedure [sp_MSupd_dbocfgHairSystemHairLengthJoin]
		@c1 int = NULL,
		@c2 int = NULL,
		@c3 int = NULL,
		@c4 datetime = NULL,
...
update [dbo].[cfgHairSystemHairLengthJoin] set
	...
	where [HairSystemHairLengthJoinID] = @pkc1
if @@rowcount = 0
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				set @primarykey_text = @primarykey_text + '[HairSystemHairLengthJoinID] = ' + convert(nvarchar(100),@pkc1,1)
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[dbo].[cfgHairSystemHairLengthJoin]', @param2=@primarykey_text, @param3=13233
			End
			Else
