/* CreateDate: 05/05/2020 17:42:53.707 , ModifyDate: 05/05/2020 17:42:53.707 */
GO
create procedure [sp_MSupd_dbolkpDaylightSavings]
		@c1 int = NULL,
		@c2 int = NULL,
		@c3 datetime = NULL,
		@c4 datetime = NULL,
...
update [dbo].[lkpDaylightSavings] set
		[Year] = case substring(@bitmap,1,1) & 2 when 2 then @c2 else [Year] end,
		[DSTStartDate] = case substring(@bitmap,1,1) & 4 when 4 then @c3 else [DSTStartDate] end,
		[DSTEndDate] = case substring(@bitmap,1,1) & 8 when 8 then @c4 else [DSTEndDate] end,
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[dbo].[lkpDaylightSavings]', @param2=@primarykey_text, @param3=13233
			End
			Else
