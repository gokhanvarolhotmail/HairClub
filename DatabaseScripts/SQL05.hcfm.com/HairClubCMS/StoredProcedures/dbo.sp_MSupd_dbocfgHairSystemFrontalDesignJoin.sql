/* CreateDate: 05/05/2020 17:42:43.203 , ModifyDate: 05/05/2020 17:42:43.203 */
GO
create procedure [sp_MSupd_dbocfgHairSystemFrontalDesignJoin]
		@c1 int = NULL,
		@c2 int = NULL,
		@c3 int = NULL,
		@c4 datetime = NULL,
...
update [dbo].[cfgHairSystemFrontalDesignJoin] set
		[HairSystemID] = case substring(@bitmap,1,1) & 2 when 2 then @c2 else [HairSystemID] end,
		[HairSystemFrontalDesignID] = case substring(@bitmap,1,1) & 4 when 4 then @c3 else [HairSystemFrontalDesignID] end,
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[dbo].[cfgHairSystemFrontalDesignJoin]', @param2=@primarykey_text, @param3=13233
			End
			Else
