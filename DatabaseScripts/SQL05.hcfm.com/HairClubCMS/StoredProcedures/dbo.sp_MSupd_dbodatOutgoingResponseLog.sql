/* CreateDate: 05/05/2020 17:42:51.553 , ModifyDate: 05/05/2020 17:42:51.553 */
GO
...
update [dbo].[datOutgoingResponseLog] set
		...
		[BosleySalesforceAccountID] = case substring(@bitmap,2,1) & 2 when 2 then @c10 else [BosleySalesforceAccountID] end
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				set @primarykey_text = @primarykey_text + '[OutgoingResponseID] = ' + convert(nvarchar(100),@pkc1,1)
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[dbo].[datOutgoingResponseLog]', @param2=@primarykey_text, @param3=13233
			End
			Else
