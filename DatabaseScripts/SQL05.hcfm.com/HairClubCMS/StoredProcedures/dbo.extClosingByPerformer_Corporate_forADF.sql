/* CreateDate: 10/15/2021 10:27:45.750 , ModifyDate: 11/04/2021 17:09:49.557 */
GO
-- =============================================
-- Author:		<Author,,Name>
...
CREATE PROCEDURE [dbo].[extClosingByPerformer_Corporate_forADF](
...
BEGIN
	...
	SET NOCOUNT ON;
			...
			truncate table dbo.ClosingByPerformer_Corporate_forADF

			insert into dbo.ClosingByPerformer_Corporate_forADF(
						[ConsultationDate]
				  ,[OrderDate]
				  ,[NetNB1Count]
				  ,[GrossNB1Count]
