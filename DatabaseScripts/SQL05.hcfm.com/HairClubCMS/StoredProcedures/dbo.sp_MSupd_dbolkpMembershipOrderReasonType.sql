/* CreateDate: 05/05/2020 17:42:45.740 , ModifyDate: 05/05/2020 17:42:45.740 */
GO
create procedure [sp_MSupd_dbolkpMembershipOrderReasonType]
		@c1 int = NULL,
		@c2 int = NULL,
...
begin
update [dbo].[lkpMembershipOrderReasonType] set
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[dbo].[lkpMembershipOrderReasonType]', @param2=@primarykey_text, @param3=13233
			End
			Else
