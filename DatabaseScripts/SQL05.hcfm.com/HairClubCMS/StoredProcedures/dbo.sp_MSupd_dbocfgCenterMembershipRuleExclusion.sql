/* CreateDate: 05/05/2020 17:42:41.027 , ModifyDate: 05/05/2020 17:42:41.027 */
GO
create procedure [sp_MSupd_dbocfgCenterMembershipRuleExclusion]
		@c1 int = NULL,
		@c2 int = NULL,
		@c3 int = NULL,
		@c4 int = NULL,
...
update [dbo].[cfgCenterMembershipRuleExclusion] set
		...
		[NewMembershipID] = case substring(@bitmap,1,1) & 8 when 8 then @c4 else [NewMembershipID] end,
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[dbo].[cfgCenterMembershipRuleExclusion]', @param2=@primarykey_text, @param3=13233
			End
			Else
