/* CreateDate: 05/05/2020 17:42:52.007 , ModifyDate: 05/05/2020 17:42:52.007 */
GO
create procedure [sp_MSupd_dbodatSurgeryCloseoutEmployee]
...
begin
update [dbo].[datSurgeryCloseoutEmployee] set
		[SurgeryCloseoutEmployeeGUID] = case substring(@bitmap,1,1) & 1 when 1 then @c1 else [SurgeryCloseoutEmployeeGUID] end,
	...
	where [SurgeryCloseoutEmployeeGUID] = @pkc1
if @@rowcount = 0
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				set @primarykey_text = @primarykey_text + '[SurgeryCloseoutEmployeeGUID] = ' + convert(nvarchar(100),@pkc1,1)
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[dbo].[datSurgeryCloseoutEmployee]', @param2=@primarykey_text, @param3=13233
			End
			Else
