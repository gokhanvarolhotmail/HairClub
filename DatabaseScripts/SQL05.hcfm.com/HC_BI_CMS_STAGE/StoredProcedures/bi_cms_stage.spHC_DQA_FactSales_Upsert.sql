/* CreateDate: 05/03/2010 12:20:20.637 , ModifyDate: 05/03/2010 12:20:20.637 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_FactSales_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_FactSales_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_cms_stage].[spHC_DQA_FactSales_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_FactSales] DQA ON
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_FactSales]
					( [DataPkgKey]
					, [OrderDateKey]
					, [OrderDate]
					, [SalesOrderKey]
