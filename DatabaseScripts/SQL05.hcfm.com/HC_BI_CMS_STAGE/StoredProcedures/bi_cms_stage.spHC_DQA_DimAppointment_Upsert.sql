/* CreateDate: 06/27/2011 17:23:48.163 , ModifyDate: 11/28/2017 16:21:04.920 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimAppointment_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimAppointment_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimAppointment_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
--			11/28/2018  KMurdoch     Add SFDC_Lead/Task_ID
-------------------------------------------------------------------------
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimAppointment] DQA ON
				DQA.[AppointmentSSID] = STG.[AppointmentSSID]
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimAppointment]
					( [DataPkgKey]
					   , [AppointmentKey]
					   , [AppointmentSSID]
					   , [CenterKey]
