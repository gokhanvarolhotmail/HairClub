/* CreateDate: 05/03/2010 12:20:19.857 , ModifyDate: 10/26/2011 11:43:14.123 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_FactSalesTransactionTender_0104]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_FactSalesTransactionTender_0104] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_FactSalesTransactionTender_0104]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @RuleKey = 104	--ClientMembershipKey Foreign Key not defined
	...
	BEGIN TRY
		...
		-- Put other clauses here
			AND ([ClientMembershipKey] IS NULL
			OR [ClientMembershipKey] = 0)
