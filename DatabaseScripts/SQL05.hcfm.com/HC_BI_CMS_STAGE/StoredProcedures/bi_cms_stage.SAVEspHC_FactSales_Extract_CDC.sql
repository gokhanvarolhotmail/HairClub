/* CreateDate: 05/24/2012 14:01:51.287 , ModifyDate: 05/24/2012 14:01:51.287 */
GO
CREATE PROCEDURE [bi_cms_stage].[SAVEspHC_FactSales_Extract_CDC]
		@DataPkgKey				int
					...
					BEGIN
						...
						UPDATE [bief_stage].[_DataFlow]
							...
							FROM [HairClubCMS].[cdc].[fn_cdc_get_net_changes_dbo_datSalesOrder](@From_LSN, @To_LSN, @row_filter_option) chg
									...
									--LEFT OUTER JOIN	[bi_cms_stage].[synHC_SRC_TBL_CMS_datSalesOrderTender] sot ON chg.SalesOrderGUID = sot.SalesOrderGUID
