/* CreateDate: 06/27/2011 17:23:12.180 , ModifyDate: 06/27/2011 17:23:12.180 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DimAppointment_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimAppointment_Cleanup] is used to Cleanup records
--
--
--   exec [bi_cms_stage].[spHC_DimAppointment_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
	...
	BEGIN TRY
		...
		WHILE ( 0 = 0 )
			BEGIN
				...
				FROM [bi_cms_stage].[DimAppointment]
