/* CreateDate: 05/03/2010 12:20:05.520 , ModifyDate: 05/03/2010 12:20:05.520 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DimSalesCode_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimSalesCode_Cleanup] is used to Cleanup records
--
--
--   exec [bi_cms_stage].[spHC_DimSalesCode_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
