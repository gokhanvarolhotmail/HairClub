/* CreateDate: 06/27/2011 17:23:48.477 , ModifyDate: 10/26/2011 11:14:59.253 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_FactHairSystemOrder_0141]
			  @DataPkgKey				int
...
BEGIN
	...
	SET @RuleKey = 141	--HairSystemDesignTemplateKey Foreign Key not defined
	...
	BEGIN TRY
		...
		-- Put other clauses here
			AND ([HairSystemDesignTemplateKey] IS NULL
			OR [HairSystemDesignTemplateKey] = 0)
