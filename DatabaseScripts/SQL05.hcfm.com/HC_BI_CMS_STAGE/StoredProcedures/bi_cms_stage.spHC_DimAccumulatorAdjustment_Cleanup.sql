/* CreateDate: 10/05/2010 14:04:31.060 , ModifyDate: 10/05/2010 14:04:31.060 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DimAccumulatorAdjustment_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimAccumulatorAdjustment_Cleanup] is used to Cleanup records
--
--
--   exec [bi_cms_stage].[spHC_DimAccumulatorAdjustment_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		-----------------------
		DELETE FROM [bi_cms_stage].[DimAccumulatorAdjustment]
