/* CreateDate: 05/03/2010 12:20:19.240 , ModifyDate: 05/03/2010 12:20:19.240 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimSalesCodeDepartment_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimSalesCodeDepartment_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimSalesCodeDepartment_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimSalesCodeDepartment] DQA ON
				DQA.[SalesCodeDepartmentSSID] = STG.[SalesCodeDepartmentSSID]
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimSalesCodeDepartment]
					( [DataPkgKey]
