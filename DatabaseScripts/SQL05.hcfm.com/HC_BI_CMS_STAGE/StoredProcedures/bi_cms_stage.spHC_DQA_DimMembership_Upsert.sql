/* CreateDate: 05/03/2010 12:20:19.143 , ModifyDate: 12/04/2012 10:03:50.717 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimMembership_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimMembership_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimMembership_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
--			12/04/2012  KMurdoch	 Added Business Segment Description
-------------------------------------------------------------------------
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimMembership] DQA ON
				DQA.[MembershipSSID] = STG.[MembershipSSID]
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimMembership]
					( [DataPkgKey]
					, [MembershipKey]
					, [MembershipSSID]
