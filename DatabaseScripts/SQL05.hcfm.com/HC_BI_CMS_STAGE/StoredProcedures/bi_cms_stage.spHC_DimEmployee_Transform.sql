/* CreateDate: 05/03/2010 12:19:59.010 , ModifyDate: 05/03/2010 12:19:59.010 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DimEmployee_Transform]
			  @DataPkgKey				int
...
--
--
--   exec [bi_cms_stage].[spHC_DimEmployee_Transform] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		-----------------------
		EXEC	@return_value = [bi_cms_stage].[spHC_DimEmployee_Transform_SalutationKey] @DataPkgKey


		-----------------------
		-- Set the ISNew and SCD fields
		-----------------------
		EXEC	@return_value = [bi_cms_stage].[spHC_DimEmployee_Transform_SetIsNewSCD] @DataPkgKey
