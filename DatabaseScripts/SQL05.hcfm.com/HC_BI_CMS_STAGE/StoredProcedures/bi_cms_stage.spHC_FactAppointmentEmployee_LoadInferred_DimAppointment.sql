/* CreateDate: 06/27/2011 17:23:05.257 , ModifyDate: 12/10/2012 14:08:05.597 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactAppointmentEmployee_LoadInferred_DimAppointment]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactAppointmentEmployee_LoadInferred_DimAppointment] is used to load inferred
-- members to the DimAppointment table.
--
--
--   exec [bi_cms_stage].[spHC_FactAppointmentEmployee_LoadInferred_DimAppointment] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
