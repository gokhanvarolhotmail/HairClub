/* CreateDate: 10/05/2010 14:04:36.660 , ModifyDate: 10/05/2010 14:04:36.660 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DimClientMembershipAccum_Transform_ClientMembershipKey]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimClientMembershipAccum_Transform_ClientMembershipKey] is used to
--  transform ClientMembershipKey
--
--
--   exec [bi_cms_stage].[spHC_DimClientMembershipAccum_Transform_ClientMembershipKey] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		-----------------------
		UPDATE STG SET
		     [ClientMembershipSSID] = '00000000-0000-0000-0000-000000000002'  -- Not Assigned
		FROM [bi_cms_stage].[DimClientMembershipAccum] STG
		WHERE STG.[DataPkgKey] = @DataPkgKey
