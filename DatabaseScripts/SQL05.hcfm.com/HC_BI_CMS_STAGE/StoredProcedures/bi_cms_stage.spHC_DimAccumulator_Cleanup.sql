/* CreateDate: 05/03/2010 12:19:50.370 , ModifyDate: 05/03/2010 12:19:50.370 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DimAccumulator_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimAccumulator_Cleanup] is used to Cleanup records
--
--
--   exec [bi_cms_stage].[spHC_DimAccumulator_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
