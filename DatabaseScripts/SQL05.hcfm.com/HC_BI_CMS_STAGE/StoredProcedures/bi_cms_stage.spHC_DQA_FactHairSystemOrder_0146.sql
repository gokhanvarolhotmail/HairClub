/* CreateDate: 06/27/2011 17:23:48.353 , ModifyDate: 10/26/2011 11:19:48.917 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_FactHairSystemOrder_0146]
			  @DataPkgKey				int
...
--
--
--   exec [bi_cms_stage].[spHC_DQA_FactHairSystemOrder_0146]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @RuleKey = 141	--HairSystemRecessionKey Foreign Key not defined
	...
	BEGIN TRY
		...
		-- Put other clauses here
			AND ([HairSystemRecessionKey] IS NULL
			OR [HairSystemRecessionKey] = 0)
