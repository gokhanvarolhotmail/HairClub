/* CreateDate: 06/27/2011 17:23:35.167 , ModifyDate: 06/27/2011 17:23:35.167 */
GO
create PROCEDURE [bi_cms_stage].[spHC_FactSurgeryCloseoutEmployee_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_FactSurgeryCloseoutEmployee_Cleanup] is used to Cleanup records
--
--
--   exec [bi_cms_stage].[spHC_FactSurgeryCloseoutEmployee_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
	...
	BEGIN TRY
		...
		WHILE ( 0 = 0 )
			BEGIN
				...
				FROM [bi_cms_stage].[FactSurgeryCloseoutEmployee]
