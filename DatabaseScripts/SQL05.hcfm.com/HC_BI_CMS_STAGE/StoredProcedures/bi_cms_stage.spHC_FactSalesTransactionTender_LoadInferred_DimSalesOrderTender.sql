/* CreateDate: 05/03/2010 12:20:22.843 , ModifyDate: 12/10/2012 14:15:29.637 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactSalesTransactionTender_LoadInferred_DimSalesOrderTender]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactSalesTransactionTender_LoadInferred_DimSalesOrderTender] is used to load inferred
-- members to the DimSalesOrderTender table.
--
--
--   exec [bi_cms_stage].[spHC_FactSalesTransactionTender_LoadInferred_DimSalesOrderTender] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
