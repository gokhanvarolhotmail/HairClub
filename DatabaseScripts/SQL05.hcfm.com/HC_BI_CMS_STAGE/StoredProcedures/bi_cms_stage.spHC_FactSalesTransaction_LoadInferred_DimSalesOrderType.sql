/* CreateDate: 05/03/2010 12:20:25.527 , ModifyDate: 12/10/2012 14:14:25.750 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactSalesTransaction_LoadInferred_DimSalesOrderType]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactSalesTransaction_LoadInferred_DimSalesOrderType] is used to load inferred
-- members to the DimSalesOrderType table.
--
--
--   exec [bi_cms_stage].[spHC_FactSalesTransaction_LoadInferred_DimSalesOrderType] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
