/* CreateDate: 06/27/2011 17:22:53.660 , ModifyDate: 06/27/2011 17:22:53.660 */
GO
create PROCEDURE [bi_cms_stage].[spHC_DQA_DimHairSystemType_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimHairSystemType_Upsert] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimHairSystemType_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimHairSystemType] DQA ON
				DQA.[HairSystemTypeSSID] = STG.[HairSystemTypeSSID]
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimHairSystemType]
					( [DataPkgKey]
					, [HairSystemTypeKey]
					, [HairSystemTypeSSID]
