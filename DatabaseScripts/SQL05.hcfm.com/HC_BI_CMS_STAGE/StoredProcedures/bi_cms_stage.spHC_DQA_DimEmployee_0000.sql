/* CreateDate: 05/03/2010 12:20:19.077 , ModifyDate: 05/03/2010 12:20:19.077 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimEmployee_0000]
			  @DataPkgKey				int
...
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimEmployee_0000]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @TableName = N'[bi_cms_dqa].[DimEmployee]'
	...
	BEGIN TRY
		...
		-----------------------
		EXEC	@return_value = [bi_cms_stage].[spHC_DQA_DimEmployee_Upsert] @DataPkgKey, @RuleKey, @RuleActionKey,
