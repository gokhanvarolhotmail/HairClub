/* CreateDate: 05/03/2010 12:20:28.037 , ModifyDate: 12/10/2012 14:11:42.557 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactSales_LoadInferred_DimSalesOrder]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactSales_LoadInferred_DimSalesOrder] is used to load inferred
-- members to the DimSalesOrder table.
--
--
--   exec [bi_cms_stage].[spHC_FactSales_LoadInferred_DimSalesOrder] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
