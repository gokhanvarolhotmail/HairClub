/* CreateDate: 06/27/2011 17:23:48.433 , ModifyDate: 10/26/2011 11:15:55.727 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_FactHairSystemOrder_0143]
			  @DataPkgKey				int
...
--
--
--   exec [bi_cms_stage].[spHC_DQA_FactHairSystemOrder_0143]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @RuleKey = 141	--HairSystemHairLengthKey Foreign Key not defined
	...
	BEGIN TRY
		...
		-- Put other clauses here
			AND ([HairSystemHairLengthKey] IS NULL
			OR [HairSystemHairLengthKey] = 0)
