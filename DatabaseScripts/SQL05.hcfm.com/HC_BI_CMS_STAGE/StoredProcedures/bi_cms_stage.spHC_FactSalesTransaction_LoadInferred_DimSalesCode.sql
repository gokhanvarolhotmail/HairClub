/* CreateDate: 05/03/2010 12:20:25.457 , ModifyDate: 12/10/2012 14:13:53.357 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactSalesTransaction_LoadInferred_DimSalesCode]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactSalesTransaction_LoadInferred_DimSalesCode] is used to load inferred
-- members to the DimSalesCode table.
--
--
--   exec [bi_cms_stage].[spHC_FactSalesTransaction_LoadInferred_DimSalesCode] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
