/* CreateDate: 05/03/2010 12:20:19.720 , ModifyDate: 05/03/2010 12:20:19.720 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimTenderType_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimTenderType_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimTenderType_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimTenderType] DQA ON
				DQA.[TenderTypeSSID] = STG.[TenderTypeSSID]
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimTenderType]
					( [DataPkgKey]
					, [TenderTypeKey]
					, [TenderTypeSSID]
