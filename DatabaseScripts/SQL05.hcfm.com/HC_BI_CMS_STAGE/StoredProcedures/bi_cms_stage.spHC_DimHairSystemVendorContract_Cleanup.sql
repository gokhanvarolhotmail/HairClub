/* CreateDate: 06/27/2011 17:23:31.830 , ModifyDate: 06/27/2011 17:23:31.830 */
GO
create PROCEDURE [bi_cms_stage].[spHC_DimHairSystemVendorContract_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimHairSystemVendorContract_Cleanup] is used to Cleanup records
--
--
--   exec [bi_cms_stage].[spHC_DimHairSystemVendorContract_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		-----------------------
		DELETE FROM [bi_cms_stage].[DimHairSystemVendorContract]
