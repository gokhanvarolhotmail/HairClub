/* CreateDate: 06/27/2011 17:23:04.887 , ModifyDate: 10/26/2011 11:08:25.320 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_FactAppointmentDetail_0109]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_FactAppointmentDetail_0109] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_FactAppointmentDetail_0109]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @RuleKey = 109	--SalesCodeKey Foreign Key not defined
	SET @TableName = N'[bi_cms_dqa].[FactAppointmentDetail]'
	...
	BEGIN TRY
		...
		-----------------------
		EXEC	@return_value = [bi_cms_stage].[spHC_DQA_FactAppointmentDetail_Upsert] @DataPkgKey, @RuleKey, @RuleActionKey,
