/* CreateDate: 06/27/2011 17:23:05.167 , ModifyDate: 06/27/2011 17:23:05.167 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactHairSystemOrder_LoadInferred_DimHairSystemHairLength]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactHairSystemOrder_LoadInferred_DimHairSystemHairLength] is used to load inferred
-- members to the DimHairSystemHairLength table.
--
--
--   exec [bi_cms_stage].[spHC_FactHairSystemOrder_LoadInferred_DimHairSystemHairLength] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	DECLARE		@DataPkgDetailKey	int
 	...
 	SET @TableName = N'[bi_ent_dds].[DimHairSystemHairLength]'
	...
	BEGIN TRY
		...
		INSERT INTO [bi_cms_stage].[synHC_DDS_DimHairSystemHairLength] (
			...
			SELECT
				  DISTINCT(STG.[HairSystemHairLengthSSID])
				, ''
				, ''
				, 0
				, -1
