/* CreateDate: 05/03/2010 12:20:19.440 , ModifyDate: 08/07/2017 10:25:11.637 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimSalesOrderDetail_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimSalesOrderDetail_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimSalesOrderDetail_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimSalesOrderDetail] DQA ON
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimSalesOrderDetail]
					( [DataPkgKey]
					, [SalesOrderDetailKey]
