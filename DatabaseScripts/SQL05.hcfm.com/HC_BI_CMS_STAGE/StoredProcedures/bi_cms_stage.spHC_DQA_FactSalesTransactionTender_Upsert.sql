/* CreateDate: 05/03/2010 12:20:20.027 , ModifyDate: 06/10/2014 08:03:56.670 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_FactSalesTransactionTender_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_FactSalesTransactionTender_Upsert] loads data to Data Quality
-- table
--
--
--   exec [bi_cms_stage].[spHC_DQA_FactSalesTransactionTender_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
--  v1.1    06/10/2014  KMurdoch     Added AccountID
-------------------------------------------------------------------------
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_FactSalesTransactionTender] DQA ON
				DQA.[SalesOrderTenderSSID] = STG.[SalesOrderTenderSSID]
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_FactSalesTransactionTender]
					( [DataPkgKey]
					, [OrderDateKey]
					, [OrderDate]
					, [SalesOrderKey]
