/* CreateDate: 06/27/2011 17:22:53.627 , ModifyDate: 06/27/2011 17:22:53.627 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_FactAppointmentDetail_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_FactAppointmentDetail_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_cms_stage].[spHC_DQA_FactAppointmentDetail_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_FactAppointmentDetail] DQA ON
				DQA.[SalesCodeSSID] = STG.[SalesCodeSSID]
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_FactAppointmentDetail]
					( [DataPkgKey]
