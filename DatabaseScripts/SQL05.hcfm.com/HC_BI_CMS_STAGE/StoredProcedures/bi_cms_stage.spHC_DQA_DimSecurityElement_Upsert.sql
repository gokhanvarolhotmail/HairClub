/* CreateDate: 08/09/2012 16:51:53.050 , ModifyDate: 08/09/2012 16:51:53.050 */
GO
create PROCEDURE [bi_cms_stage].[spHC_DQA_DimSecurityElement_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimSecurityElement_Upsert] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimSecurityElement_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimSecurityElement] DQA ON
				DQA.[SecurityElementSSID] = STG.[SecurityElementSSID]
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimSecurityElement]
					( [DataPkgKey]
					, [SecurityElementKey]
					, [SecurityElementSSID]
