/* CreateDate: 06/27/2011 17:22:53.687 , ModifyDate: 06/27/2011 17:22:53.687 */
GO
create PROCEDURE [bi_cms_stage].[spHC_DQA_DimHairSystemTexture_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimHairSystemTexture_Upsert] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimHairSystemTexture_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimHairSystemTexture] DQA ON
				DQA.[HairSystemTextureSSID] = STG.[HairSystemTextureSSID]
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimHairSystemTexture]
					( [DataPkgKey]
