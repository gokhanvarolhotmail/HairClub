/* CreateDate: 06/27/2011 17:23:05.017 , ModifyDate: 07/06/2011 16:58:29.397 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactHairSystemOrder_LoadInferred_DimHairSystemVendorContract]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactHairSystemOrder_LoadInferred_DimHairSystemVendorContract] is used to load inferred
-- members to the DimHairSystemVendorContract table.
--
--
--   exec [bi_cms_stage].[spHC_FactHairSystemOrder_LoadInferred_DimHairSystemVendorContract] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	DECLARE		@DataPkgDetailKey	int
 	...
 	SET @TableName = N'[bi_ent_dds].[DimHairSystemVendorContract]'
	...
	BEGIN TRY
		...
		INSERT INTO [bi_cms_stage].[synHC_DDS_DimHairSystemVendorContract] (
			...
			SELECT
				  DISTINCT(STG.[HairSystemVendorContractSSID])
			    , 'N' -- [HairSystemVendorContractName]
			    , 'N' -- [HairSystemVendorDescription]
			    , 'N' -- [HairSystemVendorDescriptionShort]
			    , CAST('1753-01-01 00:00:00' AS DateTime) -- [HairSystemVendorContractBeginDate]
			    , CAST('9999-12-31 00:00:00' AS DateTime) -- [HairSystemVendorContractEndDate]
			    , 'N' -- [IsRepair]
				, 'N' -- [Active]
				, 1 -- [RowIsCurrent]
