/* CreateDate: 06/27/2011 17:22:52.867 , ModifyDate: 06/27/2011 17:22:52.867 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimHairSystemHairColor_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimHairSystemHairColor_Upsert] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimHairSystemHairColor_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimHairSystemHairColor] DQA ON
				DQA.[HairSystemHairColorSSID] = STG.[HairSystemHairColorSSID]
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimHairSystemHairColor]
					( [DataPkgKey]
