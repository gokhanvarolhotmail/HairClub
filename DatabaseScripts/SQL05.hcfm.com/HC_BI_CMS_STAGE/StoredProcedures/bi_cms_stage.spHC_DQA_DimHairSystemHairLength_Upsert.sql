/* CreateDate: 06/27/2011 17:22:53.097 , ModifyDate: 06/27/2011 17:22:53.097 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimHairSystemHairLength_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimHairSystemHairLength_Upsert] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimHairSystemHairLength_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimHairSystemHairLength] DQA ON
				DQA.[HairSystemHairLengthSSID] = STG.[HairSystemHairLengthSSID]
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimHairSystemHairLength]
					( [DataPkgKey]
