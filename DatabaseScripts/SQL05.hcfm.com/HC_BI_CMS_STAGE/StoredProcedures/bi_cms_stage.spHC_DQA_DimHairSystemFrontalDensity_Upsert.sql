/* CreateDate: 06/27/2011 17:22:53.027 , ModifyDate: 06/27/2011 17:22:53.027 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimHairSystemFrontalDensity_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimHairSystemFrontalDensity_Upsert] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimHairSystemFrontalDensity_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimHairSystemFrontalDensity] DQA ON
				DQA.[HairSystemFrontalDensitySSID] = STG.[HairSystemFrontalDensitySSID]
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimHairSystemFrontalDensity]
					( [DataPkgKey]
