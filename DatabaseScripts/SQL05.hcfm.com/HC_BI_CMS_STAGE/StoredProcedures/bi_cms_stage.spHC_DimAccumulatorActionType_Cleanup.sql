/* CreateDate: 05/03/2010 12:19:48.193 , ModifyDate: 05/03/2010 12:19:48.193 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DimAccumulatorActionType_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimAccumulatorActionType_Cleanup] is used to Cleanup records
--
--
--   exec [bi_cms_stage].[spHC_DimAccumulatorActionType_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
