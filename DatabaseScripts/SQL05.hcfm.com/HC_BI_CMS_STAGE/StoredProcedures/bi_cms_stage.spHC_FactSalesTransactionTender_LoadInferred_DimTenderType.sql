/* CreateDate: 05/03/2010 12:20:22.920 , ModifyDate: 12/10/2012 14:15:48.823 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactSalesTransactionTender_LoadInferred_DimTenderType]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactSalesTransactionTender_LoadInferred_DimTenderType] is used to load inferred
-- members to the DimTenderType table.
--
--
--   exec [bi_cms_stage].[spHC_FactSalesTransactionTender_LoadInferred_DimTenderType] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
