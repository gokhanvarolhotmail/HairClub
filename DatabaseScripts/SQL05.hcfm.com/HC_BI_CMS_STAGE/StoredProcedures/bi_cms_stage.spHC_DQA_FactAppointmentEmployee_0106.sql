/* CreateDate: 06/27/2011 17:23:12.147 , ModifyDate: 10/26/2011 11:09:45.980 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_FactAppointmentEmployee_0106]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_FactAppointmentEmployee_0106] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_FactAppointmentEmployee_0106]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @TableName = N'[bi_cms_dqa].[FactAppointmentEmployee]'
	...
	BEGIN TRY
		...
		-----------------------
		EXEC	@return_value = [bi_cms_stage].[spHC_DQA_FactAppointmentEmployee_Upsert] @DataPkgKey, @RuleKey, @RuleActionKey,
