/* CreateDate: 06/27/2011 17:22:53.870 , ModifyDate: 12/10/2012 14:08:27.523 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactAppointmentEmployee_LoadInferred_DimEmployee]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactAppointmentEmployee_LoadInferred_DimEmployee] is used to load inferred
-- members to the DimEmployee table.
--
--
--   exec [bi_cms_stage].[spHC_FactAppointmentEmployee_LoadInferred_DimEmployee] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
