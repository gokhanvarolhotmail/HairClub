/* CreateDate: 05/03/2010 12:20:25.303 , ModifyDate: 08/25/2011 17:52:50.290 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactSalesTransaction_LoadInferred_DimClient]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactSalesTransaction_LoadInferred_DimClient] is used to load inferred
-- members to the DimClient table.
--
--
--   exec [bi_cms_stage].[spHC_FactSalesTransaction_LoadInferred_DimClient] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
