/* CreateDate: 06/27/2011 17:22:53.797 , ModifyDate: 06/27/2011 17:22:53.797 */
GO
create PROCEDURE [bi_cms_stage].[spHC_DQA_FactSurgeryCloseoutEmployee_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_FactSurgeryCloseoutEmployee_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_cms_stage].[spHC_DQA_FactSurgeryCloseoutEmployee_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_FactSurgeryCloseoutEmployee] DQA ON
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_FactSurgeryCloseoutEmployee]
					( [DataPkgKey]
