/* CreateDate: 08/02/2012 14:39:29.530 , ModifyDate: 08/02/2012 16:10:20.437 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimEmployeePosition_0000]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimEmployeePosition_0000] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimEmployeePosition_0000]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @TableName = N'[bi_cms_dqa].[DimEmployeePosition]'
	...
	BEGIN TRY
		...
		-----------------------
		EXEC	@return_value = [bi_cms_stage].[spHC_DQA_DimEmployeePosition_Upsert] @DataPkgKey, @RuleKey, @RuleActionKey,
