/* CreateDate: 06/27/2011 17:22:53.543 , ModifyDate: 06/27/2011 17:22:53.543 */
GO
create PROCEDURE [bi_cms_stage].[spHC_DQA_FactAppointmentEmployee_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_FactAppointmentEmployee_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_cms_stage].[spHC_DQA_FactAppointmentEmployee_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_FactAppointmentEmployee] DQA ON
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_FactAppointmentEmployee]
					( [DataPkgKey]
