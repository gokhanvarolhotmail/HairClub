/* CreateDate: 07/07/2017 11:51:52.030 , ModifyDate: 07/07/2017 11:51:52.030 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimClientPhone_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimClientPhone_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimClientPhone_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
--			06/18/2013  KMurdoch     Added ClientPhoneIdentifier
-------------------------------------------------------------------------
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimClientPhone] DQA ON
				DQA.[ClientPhoneSSID] = STG.[ClientPhoneSSID]
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimClientPhone]
					( [DataPkgKey]
					, [ClientPhoneKey]
           ,[ClientPhoneSSID]
           ,[ClientKey]
