/* CreateDate: 06/27/2011 17:23:48.297 , ModifyDate: 10/26/2011 11:21:12.777 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_FactHairSystemOrder_0149]
			  @DataPkgKey				int
...
--
--
--   exec [bi_cms_stage].[spHC_DQA_FactHairSystemOrder_0149]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @RuleKey = 141	--HairSystemTypeKey Foreign Key not defined
	...
	BEGIN TRY
		...
		-- Put other clauses here
			AND ([HairSystemTypeKey] IS NULL
			OR [HairSystemTypeKey] = 0)
