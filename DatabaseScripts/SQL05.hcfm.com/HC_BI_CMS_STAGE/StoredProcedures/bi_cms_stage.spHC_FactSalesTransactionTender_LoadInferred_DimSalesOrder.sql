/* CreateDate: 05/03/2010 12:20:22.810 , ModifyDate: 12/10/2012 14:15:19.633 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactSalesTransactionTender_LoadInferred_DimSalesOrder]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactSalesTransactionTender_LoadInferred_DimSalesOrder] is used to load inferred
-- members to the DimSalesOrder table.
--
--
--   exec [bi_cms_stage].[spHC_FactSalesTransactionTender_LoadInferred_DimSalesOrder] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
