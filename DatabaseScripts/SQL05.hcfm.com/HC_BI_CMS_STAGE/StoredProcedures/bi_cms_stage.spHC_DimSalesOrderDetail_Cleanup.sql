/* CreateDate: 05/03/2010 12:20:07.683 , ModifyDate: 05/03/2010 12:20:07.683 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DimSalesOrderDetail_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimSalesOrderDetail_Cleanup] is used to Cleanup records
--
--
--   exec [bi_cms_stage].[spHC_DimSalesOrderDetail_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
