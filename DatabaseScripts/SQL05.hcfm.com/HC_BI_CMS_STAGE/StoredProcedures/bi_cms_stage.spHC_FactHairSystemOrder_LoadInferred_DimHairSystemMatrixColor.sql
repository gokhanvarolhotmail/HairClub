/* CreateDate: 06/27/2011 17:23:05.150 , ModifyDate: 06/27/2011 17:23:05.150 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactHairSystemOrder_LoadInferred_DimHairSystemMatrixColor]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactHairSystemOrder_LoadInferred_DimHairSystemMatrixColor] is used to load inferred
-- members to the DimHairSystemMatrixColor table.
--
--
--   exec [bi_cms_stage].[spHC_FactHairSystemOrder_LoadInferred_DimHairSystemMatrixColor] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	DECLARE		@DataPkgDetailKey	int
 	...
 	SET @TableName = N'[bi_ent_dds].[DimHairSystemMatrixColor]'
	...
	BEGIN TRY
		...
		INSERT INTO [bi_cms_stage].[synHC_DDS_DimHairSystemMatrixColor] (
			...
			SELECT
				  DISTINCT(STG.[HairSystemMatrixColorSSID])
				, '' -- [HairSystemMatrixColorDescription]
				, '' -- [HairSystemMatrixColorDescriptionShort]
				, -1 -- [HairSystemMatrixColorSortOrder]
				, 'N' -- [Active]
				, 1 -- [RowIsCurrent]
