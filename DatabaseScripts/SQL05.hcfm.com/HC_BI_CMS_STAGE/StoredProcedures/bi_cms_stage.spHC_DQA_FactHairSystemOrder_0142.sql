/* CreateDate: 06/27/2011 17:23:48.460 , ModifyDate: 10/26/2011 11:15:28.783 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_FactHairSystemOrder_0142]
			  @DataPkgKey				int
...
--
--
--   exec [bi_cms_stage].[spHC_DQA_FactHairSystemOrder_0142]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @RuleKey = 141	--HairSystemFrontalDensityKey Foreign Key not defined
	...
	BEGIN TRY
		...
		-- Put other clauses here
			AND ([HairSystemFrontalDensityKey] IS NULL
			OR [HairSystemFrontalDensityKey] = 0)
