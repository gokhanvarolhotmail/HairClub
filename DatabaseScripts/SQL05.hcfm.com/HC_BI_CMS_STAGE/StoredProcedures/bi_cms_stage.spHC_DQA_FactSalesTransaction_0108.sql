/* CreateDate: 05/03/2010 12:20:20.240 , ModifyDate: 10/26/2011 11:39:25.540 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_FactSalesTransaction_0108]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_FactSalesTransaction_0108] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_FactSalesTransaction_0108]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @RuleKey = 108	--MembershipKey Foreign Key not defined
