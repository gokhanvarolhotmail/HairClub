/* CreateDate: 05/03/2010 12:20:18.900 , ModifyDate: 05/03/2010 12:20:18.900 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimAccumulator_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimAccumulator_Upsert] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimAccumulator_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimAccumulator] DQA ON
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimAccumulator]
					( [DataPkgKey]
					, [AccumulatorKey]
					, [AccumulatorSSID]
