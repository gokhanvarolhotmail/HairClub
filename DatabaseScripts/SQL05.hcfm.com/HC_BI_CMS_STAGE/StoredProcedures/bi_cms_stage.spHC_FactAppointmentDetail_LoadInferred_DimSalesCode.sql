/* CreateDate: 06/27/2011 17:23:08.553 , ModifyDate: 12/10/2012 14:07:42.640 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactAppointmentDetail_LoadInferred_DimSalesCode]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactAppointmentDetail_LoadInferred_DimSalesCode] is used to load inferred
-- members to the DimSalesCode table.
--
--
--   exec [bi_cms_stage].[spHC_FactAppointmentDetail_LoadInferred_DimSalesCode] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
