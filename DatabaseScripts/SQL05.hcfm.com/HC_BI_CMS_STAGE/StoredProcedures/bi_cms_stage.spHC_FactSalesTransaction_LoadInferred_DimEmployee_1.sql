/* CreateDate: 05/03/2010 12:20:25.347 , ModifyDate: 12/10/2012 14:12:55.780 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactSalesTransaction_LoadInferred_DimEmployee_1]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactSalesTransaction_LoadInferred_DimEmployee_1] is used to load inferred
-- members to the DimEmployee table.
--
--
--   exec [bi_cms_stage].[spHC_FactSalesTransaction_LoadInferred_DimEmployee_1] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
