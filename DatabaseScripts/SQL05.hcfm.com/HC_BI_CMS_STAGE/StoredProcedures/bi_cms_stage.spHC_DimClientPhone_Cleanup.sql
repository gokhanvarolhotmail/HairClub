/* CreateDate: 07/06/2017 11:51:40.637 , ModifyDate: 07/06/2017 11:52:23.943 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DimClientPhone_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimClientPhone_Cleanup] is used to Cleanup records
--
--
--   exec [bi_cms_stage].[spHC_DimClientPhone_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		-----------------------
		DELETE FROM [bi_cms_stage].[DimClientPhone]
