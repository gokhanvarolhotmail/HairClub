/* CreateDate: 06/27/2011 17:23:05.183 , ModifyDate: 06/27/2011 17:23:05.183 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactHairSystemOrder_LoadInferred_DimHairSystemHairColor]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactHairSystemOrder_LoadInferred_DimHairSystemHairColor] is used to load inferred
-- members to the DimHairSystemHairColor table.
--
--
--   exec [bi_cms_stage].[spHC_FactHairSystemOrder_LoadInferred_DimHairSystemHairColor] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	DECLARE		@DataPkgDetailKey	int
 	...
 	SET @TableName = N'[bi_ent_dds].[DimHairSystemHairColor]'
	...
	BEGIN TRY
		...
		INSERT INTO [bi_cms_stage].[synHC_DDS_DimHairSystemHairColor] (
			...
			SELECT
				  DISTINCT(STG.[HairSystemTopHairColorSSID])
				, '' -- [HairSystemHairColorDescription]
				, '' -- [HairSystemHairColorDescriptionShort]
				, -1 -- [HairSystemHairColorSortOrder]
				, 'N' -- [Active]
				, 1 -- [RowIsCurrent]
			...
			WHERE COALESCE(STG.[HairSystemTopHairColorSSID], 0) = 0
