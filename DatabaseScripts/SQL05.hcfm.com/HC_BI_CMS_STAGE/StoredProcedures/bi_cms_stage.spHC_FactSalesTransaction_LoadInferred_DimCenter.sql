/* CreateDate: 05/03/2010 12:20:25.257 , ModifyDate: 05/03/2010 12:20:25.257 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactSalesTransaction_LoadInferred_DimCenter]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactSalesTransaction_LoadInferred_DimCenter] is used to load inferred
-- members to the DimCenter table.
--
--
--   exec [bi_cms_stage].[spHC_FactSalesTransaction_LoadInferred_DimCenter] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
