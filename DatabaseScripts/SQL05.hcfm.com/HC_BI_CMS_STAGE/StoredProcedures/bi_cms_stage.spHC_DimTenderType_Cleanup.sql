/* CreateDate: 05/03/2010 12:20:16.633 , ModifyDate: 05/03/2010 12:20:16.633 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DimTenderType_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimTenderType_Cleanup] is used to Cleanup records
--
--
--   exec [bi_cms_stage].[spHC_DimTenderType_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
