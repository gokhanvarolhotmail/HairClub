/* CreateDate: 05/03/2010 12:20:03.257 , ModifyDate: 05/03/2010 12:20:03.257 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DimSalesCodeDivision_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimSalesCodeDivision_Cleanup] is used to Cleanup records
--
--
--   exec [bi_cms_stage].[spHC_DimSalesCodeDivision_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
