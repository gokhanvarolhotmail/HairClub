/* CreateDate: 10/05/2010 14:04:36.873 , ModifyDate: 10/05/2010 14:04:36.873 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimAccumulatorAdjustment_0000]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimAccumulatorAdjustment_0000] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimAccumulatorAdjustment_0000]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @TableName = N'[bi_cms_dqa].[DimAccumulatorAdjustment]'
	...
	BEGIN TRY
		...
		-----------------------
		EXEC	@return_value = [bi_cms_stage].[spHC_DQA_DimAccumulatorAdjustment_Upsert] @DataPkgKey, @RuleKey, @RuleActionKey,
