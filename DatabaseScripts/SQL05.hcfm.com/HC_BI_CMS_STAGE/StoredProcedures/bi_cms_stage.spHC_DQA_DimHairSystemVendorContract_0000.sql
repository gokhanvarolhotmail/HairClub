/* CreateDate: 06/27/2011 17:23:05.077 , ModifyDate: 06/27/2011 17:23:05.077 */
GO
create PROCEDURE [bi_cms_stage].[spHC_DQA_DimHairSystemVendorContract_0000]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimHairSystemVendorContract_0000] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimHairSystemVendorContract_0000]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @TableName = N'[bi_cms_dqa].[DimHairSystemVendorContract]'
	...
	BEGIN TRY
		...
		-----------------------
		EXEC	@return_value = [bi_cms_stage].[spHC_DQA_DimHairSystemVendorContract_Upsert] @DataPkgKey, @RuleKey, @RuleActionKey,
