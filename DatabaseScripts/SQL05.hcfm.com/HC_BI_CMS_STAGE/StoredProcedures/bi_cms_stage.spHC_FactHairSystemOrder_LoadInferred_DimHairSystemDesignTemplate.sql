/* CreateDate: 06/27/2011 17:23:05.220 , ModifyDate: 06/27/2011 17:23:05.220 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactHairSystemOrder_LoadInferred_DimHairSystemDesignTemplate]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactHairSystemOrder_LoadInferred_DimHairSystemDesignTemplate] is used to load inferred
-- members to the DimHairSystemDesignTemplate table.
--
--
--   exec [bi_cms_stage].[spHC_FactHairSystemOrder_LoadInferred_DimHairSystemDesignTemplate] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	DECLARE		@DataPkgDetailKey	int
 	...
 	SET @TableName = N'[bi_ent_dds].[DimHairSystemDesignTemplate]'
	...
	BEGIN TRY
		...
		INSERT INTO [bi_cms_stage].[synHC_DDS_DimHairSystemDesignTemplate] (
			...
			SELECT
				  DISTINCT(STG.[HairSystemDesignTemplateSSID])
				, '' -- [HairSystemDesignTemplateDescription]
				, '' -- [HairSystemDesignTemplateDescriptionShort]
				, -1 -- [HairSystemDesignTemplateSortOrder]
				, 'N' -- [Active]
				, 1 -- [RowIsCurrent]
