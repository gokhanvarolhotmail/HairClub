/* CreateDate: 06/27/2011 17:22:53.913 , ModifyDate: 10/26/2011 11:46:24.320 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_FactSurgeryCloseoutEmployee_0106]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_FactSurgeryCloseoutEmployee_0106] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_FactSurgeryCloseoutEmployee_0106]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @RuleKey = 106	--EmployeeKey Foreign Key not defined
	SET @TableName = N'[bi_cms_dqa].[FactSurgeryCloseoutEmployee]'
	...
	BEGIN TRY
		...
		-----------------------
		EXEC	@return_value = [bi_cms_stage].[spHC_DQA_FactSurgeryCloseoutEmployee_Upsert] @DataPkgKey, @RuleKey, @RuleActionKey,
