/* CreateDate: 05/03/2010 12:20:19.380 , ModifyDate: 05/03/2010 12:20:19.380 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimSalesCode_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimSalesCode_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimSalesCode_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimSalesCode] DQA ON
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimSalesCode]
					( [DataPkgKey]
					, [SalesCodeKey]
					, [SalesCodeSSID]
