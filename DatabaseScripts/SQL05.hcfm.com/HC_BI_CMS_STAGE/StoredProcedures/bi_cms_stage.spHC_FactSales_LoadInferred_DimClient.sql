/* CreateDate: 05/03/2010 12:20:27.973 , ModifyDate: 08/25/2011 17:46:58.500 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactSales_LoadInferred_DimClient]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactSales_LoadInferred_DimClient] is used to load inferred
-- members to the DimClient table.
--
--
--   exec [bi_cms_stage].[spHC_FactSales_LoadInferred_DimClient] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
