/* CreateDate: 06/27/2011 17:23:48.337 , ModifyDate: 10/26/2011 11:20:18.070 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_FactHairSystemOrder_0147]
			  @DataPkgKey				int
...
--
--
--   exec [bi_cms_stage].[spHC_DQA_FactHairSystemOrder_0147]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @RuleKey = 141	--HairSystemStyleKey Foreign Key not defined
	...
	BEGIN TRY
		...
		-- Put other clauses here
			AND ([HairSystemStyleKey] IS NULL
			OR [HairSystemStyleKey] = 0)
