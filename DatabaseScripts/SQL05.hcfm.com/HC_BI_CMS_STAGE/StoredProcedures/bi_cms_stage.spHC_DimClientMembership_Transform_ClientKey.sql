/* CreateDate: 05/03/2010 12:19:54.647 , ModifyDate: 10/26/2011 14:10:24.087 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DimClientMembership_Transform_ClientKey]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimClientMembership_Transform_ClientKey] is used to
--  transform ClientKey
--
--
--   exec [bi_cms_stage].[spHC_DimClientMembership_Transform_ClientKey] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
