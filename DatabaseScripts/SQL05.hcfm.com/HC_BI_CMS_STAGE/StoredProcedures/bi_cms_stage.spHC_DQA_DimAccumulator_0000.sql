/* CreateDate: 05/03/2010 12:20:18.880 , ModifyDate: 05/03/2010 12:20:18.880 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimAccumulator_0000]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimAccumulator_0000] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimAccumulator_0000]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @TableName = N'[bi_cms_dqa].[DimAccumulator]'
	...
	BEGIN TRY
		...
		-----------------------
		EXEC	@return_value = [bi_cms_stage].[spHC_DQA_DimAccumulator_Upsert] @DataPkgKey, @RuleKey, @RuleActionKey,
