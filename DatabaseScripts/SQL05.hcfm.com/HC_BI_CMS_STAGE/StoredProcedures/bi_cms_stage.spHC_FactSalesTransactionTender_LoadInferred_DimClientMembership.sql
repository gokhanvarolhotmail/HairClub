/* CreateDate: 05/03/2010 12:20:22.793 , ModifyDate: 12/10/2012 14:15:07.047 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactSalesTransactionTender_LoadInferred_DimClientMembership]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactSalesTransactionTender_LoadInferred_DimClientMembership] is used to load inferred
-- members to the DimClientMembership table.
--
--
--   exec [bi_cms_stage].[spHC_FactSalesTransactionTender_LoadInferred_DimClientMembership] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
