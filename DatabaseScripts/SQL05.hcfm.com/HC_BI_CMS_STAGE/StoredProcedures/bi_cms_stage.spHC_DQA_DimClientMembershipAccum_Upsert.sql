/* CreateDate: 10/05/2010 14:04:37.040 , ModifyDate: 10/05/2010 14:04:37.040 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimClientMembershipAccum_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimClientMembershipAccum_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimClientMembershipAccum_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimClientMembershipAccum] DQA ON
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimClientMembershipAccum]
					( [DataPkgKey]
