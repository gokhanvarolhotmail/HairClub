/* CreateDate: 05/03/2010 12:20:23.170 , ModifyDate: 05/03/2010 12:20:23.170 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactSalesTransaction_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_FactSalesTransaction_Cleanup] is used to Cleanup records
--
--
--   exec [bi_cms_stage].[spHC_FactSalesTransaction_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
	...
	BEGIN TRY
		...
		WHILE ( 0 = 0 )
			BEGIN
				...
				FROM [bi_cms_stage].[FactSalesTransaction]
