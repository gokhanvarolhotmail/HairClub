/* CreateDate: 05/03/2010 12:20:25.510 , ModifyDate: 12/10/2012 14:14:15.463 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactSalesTransaction_LoadInferred_DimSalesOrderDetail]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactSalesTransaction_LoadInferred_DimSalesOrderDetail] is used to load inferred
-- members to the DimSalesOrderDetail table.
--
--
--   exec [bi_cms_stage].[spHC_FactSalesTransaction_LoadInferred_DimSalesOrderDetail] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
