/* CreateDate: 10/05/2010 14:04:36.930 , ModifyDate: 10/05/2010 14:04:36.930 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimAccumulatorAdjustment_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimAccumulatorAdjustment_Upsert] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimAccumulatorAdjustment_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimAccumulatorAdjustment] DQA ON
				DQA.[AccumulatorSSID] = STG.[AccumulatorSSID]
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimAccumulatorAdjustment]
					( [DataPkgKey]
