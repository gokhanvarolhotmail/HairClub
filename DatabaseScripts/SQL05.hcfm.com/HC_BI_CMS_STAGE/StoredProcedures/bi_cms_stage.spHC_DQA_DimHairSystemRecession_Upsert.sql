/* CreateDate: 06/27/2011 17:22:53.193 , ModifyDate: 06/27/2011 17:22:53.193 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimHairSystemRecession_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimHairSystemRecession_Upsert] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimHairSystemRecession_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimHairSystemRecession] DQA ON
				DQA.[HairSystemRecessionSSID] = STG.[HairSystemRecessionSSID]
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimHairSystemRecession]
					( [DataPkgKey]
