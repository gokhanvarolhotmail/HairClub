/* CreateDate: 05/03/2010 12:20:25.810 , ModifyDate: 10/26/2011 11:42:13.707 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactSalesTransaction_Transform_Lkup_SalesOrderKey]
			   @DataPkgKey					int
