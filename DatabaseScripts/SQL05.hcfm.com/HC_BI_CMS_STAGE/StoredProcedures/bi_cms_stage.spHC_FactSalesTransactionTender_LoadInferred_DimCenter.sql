/* CreateDate: 05/03/2010 12:20:22.743 , ModifyDate: 05/03/2010 12:20:22.743 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactSalesTransactionTender_LoadInferred_DimCenter]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactSalesTransactionTender_LoadInferred_DimCenter] is used to load inferred
-- members to the DimCenter table.
--
--
--   exec [bi_cms_stage].[spHC_FactSalesTransactionTender_LoadInferred_DimCenter] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
