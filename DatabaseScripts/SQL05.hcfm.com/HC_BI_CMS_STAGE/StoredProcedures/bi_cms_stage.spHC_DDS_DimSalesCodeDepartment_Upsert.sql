/* CreateDate: 05/03/2010 12:19:47.683 , ModifyDate: 05/03/2010 12:19:47.683 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DDS_DimSalesCodeDepartment_Upsert]
			   @DataPkgKey					int
...
AS
-------------------------------------------------------------------------
-- [spHC_DDS_DimSalesCodeDepartment_Upsert] is used to update
-- SCD Type 1 records, update SCD Type 2 records and insert
-- New records
--
--
--   exec [bi_cms_stage].[spHC_DDS_DimSalesCodeDepartment_Upsert] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT @InitialRowCnt = COUNT(1) FROM [bi_cms_stage].[synHC_DDS_DimSalesCodeDepartment]
		...
		-- New Records
		------------------------
		INSERT INTO [bi_cms_stage].[synHC_DDS_DimSalesCodeDepartment] (
			...
			SELECT
				...
				, STG.[SalesCodeDepartmentDescription]
				, STG.[SalesCodeDepartmentDescriptionShort]
				, STG.[SalesCodeDivisionKey]
				, STG.[SalesCodeDivisionSSID]
				, 1 -- [RowIsCurrent]
		...
		UPDATE DW SET
				  DW.[SalesCodeDepartmentDescription] = STG.[SalesCodeDepartmentDescription]
				, DW.[SalesCodeDepartmentDescriptionShort] = STG.[SalesCodeDepartmentDescriptionShort]
				, DW.[SalesCodeDivisionKey] = STG.[SalesCodeDivisionKey]
				, DW.[SalesCodeDivisionSSID] = STG.[SalesCodeDivisionSSID]
				, DW.[RowChangeReason] = 'Updated Inferred Member'
				, DW.[RowIsInferred] = 0
				, DW.[UpdateAuditKey] = @DataPkgKey
		FROM [bi_cms_stage].[DimSalesCodeDepartment] STG
		JOIN [bi_cms_stage].[synHC_DDS_DimSalesCodeDepartment] DW ON
		...
		SELECT @FinalRowCnt = COUNT(1) FROM [bi_cms_stage].[synHC_DDS_DimSalesCodeDepartment]
