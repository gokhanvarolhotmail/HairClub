/* CreateDate: 05/03/2010 12:20:25.320 , ModifyDate: 12/10/2012 14:12:38.433 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactSalesTransaction_LoadInferred_DimClientMembership]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactSalesTransaction_LoadInferred_DimClientMembership] is used to load inferred
-- members to the DimClientMembership table.
--
--
--   exec [bi_cms_stage].[spHC_FactSalesTransaction_LoadInferred_DimClientMembership] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
