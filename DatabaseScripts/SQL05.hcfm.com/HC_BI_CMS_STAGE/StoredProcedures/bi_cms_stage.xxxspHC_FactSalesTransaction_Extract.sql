/* CreateDate: 09/11/2012 14:00:03.410 , ModifyDate: 09/11/2012 14:00:03.410 */
GO
create PROCEDURE [bi_cms_stage].[xxxspHC_FactSalesTransaction_Extract]
		@DataPkgKey				int
				...
				INSERT INTO [bi_cms_stage].[FactSalesTransaction]
					...
					FROM	[bi_cms_stage].[synHC_SRC_TBL_CMS_datSalesOrder] so
							...
							INNER JOIN bi_cms_stage.synHC_DDS_DimClientMembership dcm
								ON so.ClientMembershipGUID = dcm.ClientMembershipSSID
