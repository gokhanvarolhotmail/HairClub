/* CreateDate: 05/03/2010 12:20:28.010 , ModifyDate: 12/10/2012 14:11:28.273 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactSales_LoadInferred_DimEmployee]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactSales_LoadInferred_DimEmployee] is used to load inferred
-- members to the DimEmployee table.
--
--
--   exec [bi_cms_stage].[spHC_FactSales_LoadInferred_DimEmployee] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
