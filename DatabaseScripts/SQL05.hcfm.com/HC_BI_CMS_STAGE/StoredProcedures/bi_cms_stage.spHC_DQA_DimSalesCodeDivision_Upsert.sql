/* CreateDate: 05/03/2010 12:20:19.340 , ModifyDate: 05/03/2010 12:20:19.340 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimSalesCodeDivision_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimSalesCodeDivision_Upsert] loads data to Data Quality
-- table
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimSalesCodeDivision_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimSalesCodeDivision] DQA ON
				DQA.[SalesCodeDivisionSSID] = STG.[SalesCodeDivisionSSID]
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimSalesCodeDivision]
					( [DataPkgKey]
