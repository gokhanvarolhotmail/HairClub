/* CreateDate: 06/27/2011 17:23:05.130 , ModifyDate: 06/27/2011 17:23:05.130 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactHairSystemOrder_LoadInferred_DimHairSystemOrderStatus]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactHairSystemOrder_LoadInferred_DimHairSystemOrderStatus] is used to load inferred
-- members to the DimHairSystemOrderStatus table.
--
--
--   exec [bi_cms_stage].[spHC_FactHairSystemOrder_LoadInferred_DimHairSystemOrderStatus] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	DECLARE		@DataPkgDetailKey	int
 	...
 	SET @TableName = N'[bi_ent_dds].[DimHairSystemOrderStatus]'
	...
	BEGIN TRY
		...
		INSERT INTO [bi_cms_stage].[synHC_DDS_DimHairSystemOrderStatus] (
			...
			SELECT
				  DISTINCT(STG.[HairSystemOrderStatusSSID])
			    , -1 -- [HairSystemOrderStatusSortOrder]
			    , '' -- [HairSystemOrderStatusDescription]
			    , '' -- [HairSystemOrderStatusDescriptionShort]
			    , '' -- [CanApplyFlag]
			    , '' -- [CanTransferFlag]
