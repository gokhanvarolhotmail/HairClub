/* CreateDate: 06/27/2011 17:23:05.110 , ModifyDate: 06/27/2011 17:23:05.110 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_FactHairSystemOrder_LoadInferred_DimHairSystemRecession]
			   @DataPkgKey					int

AS
-------------------------------------------------------------------------
-- [spHC_FactHairSystemOrder_LoadInferred_DimHairSystemRecession] is used to load inferred
-- members to the DimHairSystemRecession table.
--
--
--   exec [bi_cms_stage].[spHC_FactHairSystemOrder_LoadInferred_DimHairSystemRecession] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	DECLARE		@DataPkgDetailKey	int
 	...
 	SET @TableName = N'[bi_ent_dds].[DimHairSystemRecession]'
	...
	BEGIN TRY
		...
		INSERT INTO [bi_cms_stage].[synHC_DDS_DimHairSystemRecession] (
			...
			SELECT
				  DISTINCT(STG.[HairSystemRecessionSSID])
				, '' -- [HairSystemRecessionDescription]
				, '' -- [HairSystemRecessionDescriptionShort]
				, -1 -- [HairSystemRecessionSortOrder]
				, 'N' -- [Active]
				, 1 -- [RowIsCurrent]
