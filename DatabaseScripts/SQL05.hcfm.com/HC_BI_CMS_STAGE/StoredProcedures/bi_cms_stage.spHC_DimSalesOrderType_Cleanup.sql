/* CreateDate: 05/03/2010 12:20:12.107 , ModifyDate: 05/03/2010 12:20:12.107 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DimSalesOrderType_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimSalesOrderType_Cleanup] is used to Cleanup records
--
--
--   exec [bi_cms_stage].[spHC_DimSalesOrderType_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
