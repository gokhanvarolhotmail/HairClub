/* CreateDate: 08/02/2012 14:45:28.397 , ModifyDate: 08/02/2012 14:45:28.397 */
GO
create PROCEDURE [bi_cms_stage].[spHC_DimEmployeePosition_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimEmployeePosition_Cleanup] is used to Cleanup records
--
--
--   exec [bi_cms_stage].[spHC_DimEmployeePosition_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		-----------------------
		DELETE FROM [bi_cms_stage].[DimEmployeePosition]
