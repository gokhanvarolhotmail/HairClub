/* CreateDate: 06/27/2011 17:23:04.807 , ModifyDate: 06/27/2011 17:23:04.807 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DimHairSystemType_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimHairSystemType_Cleanup] is used to Cleanup records
--
--
--   exec [bi_cms_stage].[spHC_DimHairSystemType_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		-----------------------
		DELETE FROM [bi_cms_stage].[DimHairSystemType]
