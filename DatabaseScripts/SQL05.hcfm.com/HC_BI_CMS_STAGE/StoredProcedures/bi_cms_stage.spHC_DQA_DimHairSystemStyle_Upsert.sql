/* CreateDate: 06/27/2011 17:22:53.160 , ModifyDate: 06/27/2011 17:22:53.160 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_DimHairSystemStyle_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimHairSystemStyle_Upsert] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimHairSystemStyle_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_DimHairSystemStyle] DQA ON
				DQA.[HairSystemStyleSSID] = STG.[HairSystemStyleSSID]
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_DimHairSystemStyle]
					( [DataPkgKey]
					, [HairSystemStyleKey]
					, [HairSystemStyleSSID]
