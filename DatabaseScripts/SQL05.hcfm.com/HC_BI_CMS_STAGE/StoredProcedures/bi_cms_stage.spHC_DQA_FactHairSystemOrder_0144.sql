/* CreateDate: 06/27/2011 17:23:48.410 , ModifyDate: 10/26/2011 11:16:23.870 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_FactHairSystemOrder_0144]
			  @DataPkgKey				int
...
--
--
--   exec [bi_cms_stage].[spHC_DQA_FactHairSystemOrder_0144]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @RuleKey = 141	--HairSystemMatrixcolorKey Foreign Key not defined
	...
	BEGIN TRY
		...
		-- Put other clauses here
			AND ([HairSystemMatrixcolorKey] IS NULL
			OR [HairSystemMatrixcolorKey] = 0)
