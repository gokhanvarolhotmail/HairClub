/* CreateDate: 05/03/2010 12:20:20.327 , ModifyDate: 06/10/2014 08:02:21.933 */
GO
CREATE PROCEDURE [bi_cms_stage].[spHC_DQA_FactSalesTransaction_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_FactSalesTransaction_Upsert] loads data to Data Quality
-- table
--
--
--   exec [bi_cms_stage].[spHC_DQA_FactSalesTransaction_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_cms_stage].[synHC_DQA_FactSalesTransaction] DQA ON
				DQA.[SalesOrderDetailSSID] = STG.[SalesOrderDetailSSID]
		...
		-----------------------
		INSERT INTO [bi_cms_stage].[synHC_DQA_FactSalesTransaction]
					( [DataPkgKey]
					, [OrderDateKey]
					, [OrderDate]
					, [SalesOrderKey]
