/* CreateDate: 08/09/2012 16:52:30.780 , ModifyDate: 08/09/2012 16:52:30.780 */
GO
create PROCEDURE [bi_cms_stage].[spHC_DQA_DimSecurityElement_0000]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimSecurityElement_0000] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_cms_stage].[spHC_DQA_DimSecurityElement_0000]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @TableName = N'[bi_cms_dqa].[DimSecurityElement]'
	...
	BEGIN TRY
		...
		-----------------------
		EXEC	@return_value = [bi_cms_stage].[spHC_DQA_DimSecurityElement_Upsert] @DataPkgKey, @RuleKey, @RuleActionKey,
