/* CreateDate: 02/24/2022 11:43:09.420 , ModifyDate: 02/24/2022 11:43:09.420 */
GO
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER OFF
GO
CREATE FUNCTION [dbo].[ParseDelimitedColumns32](@record [nvarchar](max), @delim [nvarchar](255))
RETURNS  TABLE (
	[Cnt] [int] NULL,
...
AS
EXTERNAL NAME [StringUtilClr].[StringUtilClr.ParseDelimitedColumns32class].[ParseDelimitedColumns32]
GO
