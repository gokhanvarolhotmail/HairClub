/* CreateDate: 05/03/2010 12:19:13.287 , ModifyDate: 06/26/2019 08:58:54.677 */
GO
CREATE TABLE [bi_cms_dqa].[FactSalesTransaction](
...
GO
ALTER TABLE [bi_cms_dqa].[FactSalesTransaction] ADD  CONSTRAINT [DF_FactSalesTransaction_TaxRate1]  DEFAULT ((0)) FOR [TaxRate1]
GO
ALTER TABLE [bi_cms_dqa].[FactSalesTransaction] ADD  CONSTRAINT [DF_FactSalesTransaction_TaxRate2]  DEFAULT ((0)) FOR [TaxRate2]
GO
ALTER TABLE [bi_cms_dqa].[FactSalesTransaction] ADD  CONSTRAINT [DF_FactSalesTransaction_IsException1]  DEFAULT ((0)) FOR [IsVoided]
GO
ALTER TABLE [bi_cms_dqa].[FactSalesTransaction] ADD  CONSTRAINT [DF_FactSalesTransaction_IsException1_1]  DEFAULT ((0)) FOR [IsClosed]
GO
ALTER TABLE [bi_cms_dqa].[FactSalesTransaction] ADD  CONSTRAINT [DF_FactSalesTransaction_IsNew]  DEFAULT ((0)) FOR [IsNew]
GO
ALTER TABLE [bi_cms_dqa].[FactSalesTransaction] ADD  CONSTRAINT [DF_FactSalesTransaction_IsUpdate]  DEFAULT ((0)) FOR [IsUpdate]
GO
ALTER TABLE [bi_cms_dqa].[FactSalesTransaction] ADD  CONSTRAINT [DF_FactSalesTransaction_IsDelete]  DEFAULT ((0)) FOR [IsDelete]
GO
ALTER TABLE [bi_cms_dqa].[FactSalesTransaction] ADD  CONSTRAINT [DF_FactSalesTransaction_IsDuplicate]  DEFAULT ((0)) FOR [IsDuplicate]
GO
ALTER TABLE [bi_cms_dqa].[FactSalesTransaction] ADD  CONSTRAINT [DF_FactSalesTransaction_IsException]  DEFAULT ((0)) FOR [IsException]
GO
ALTER TABLE [bi_cms_dqa].[FactSalesTransaction] ADD  CONSTRAINT [DF_FactSalesTransaction_IsHealthy]  DEFAULT ((0)) FOR [IsHealthy]
GO
ALTER TABLE [bi_cms_dqa].[FactSalesTransaction] ADD  CONSTRAINT [DF_FactSalesTransaction_IsRejected]  DEFAULT ((0)) FOR [IsRejected]
GO
ALTER TABLE [bi_cms_dqa].[FactSalesTransaction] ADD  CONSTRAINT [DF_FactSalesTransaction_IsAllowed]  DEFAULT ((0)) FOR [IsAllowed]
GO
ALTER TABLE [bi_cms_dqa].[FactSalesTransaction] ADD  CONSTRAINT [DF_FactSalesTransaction_IsFixed]  DEFAULT ((0)) FOR [IsFixed]
GO
ALTER TABLE [bi_cms_dqa].[FactSalesTransaction] ADD  CONSTRAINT [DF_FactSalesTransaction_CreateTimestamp]  DEFAULT (getdate()) FOR [CreateTimestamp]
GO
