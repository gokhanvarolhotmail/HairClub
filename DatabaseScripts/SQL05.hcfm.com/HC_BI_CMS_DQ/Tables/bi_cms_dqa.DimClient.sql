/* CreateDate: 06/29/2011 09:46:29.927 , ModifyDate: 05/12/2020 13:49:22.110 */
GO
CREATE TABLE [bi_cms_dqa].[DimClient](
...
GO
ALTER TABLE [bi_cms_dqa].[DimClient] ADD  CONSTRAINT [DF_DimClient_Phone1TypeSSID]  DEFAULT ((-2)) FOR [Phone1TypeSSID]
GO
ALTER TABLE [bi_cms_dqa].[DimClient] ADD  CONSTRAINT [DF_DimClient_Phone2TypeSSID]  DEFAULT ((-2)) FOR [Phone2TypeSSID]
GO
ALTER TABLE [bi_cms_dqa].[DimClient] ADD  CONSTRAINT [DF_DimClient_Phone3TypeSSID]  DEFAULT ((-2)) FOR [Phone3TypeSSID]
GO
ALTER TABLE [bi_cms_dqa].[DimClient] ADD  CONSTRAINT [DF_DimClient_IsNew]  DEFAULT ((0)) FOR [IsNew]
GO
ALTER TABLE [bi_cms_dqa].[DimClient] ADD  CONSTRAINT [DF_DimClient_IsType1]  DEFAULT ((0)) FOR [IsType1]
GO
ALTER TABLE [bi_cms_dqa].[DimClient] ADD  CONSTRAINT [DF_DimClient_IsType2]  DEFAULT ((0)) FOR [IsType2]
GO
ALTER TABLE [bi_cms_dqa].[DimClient] ADD  CONSTRAINT [DF_DimClient_IsDelete]  DEFAULT ((0)) FOR [IsDelete]
GO
ALTER TABLE [bi_cms_dqa].[DimClient] ADD  CONSTRAINT [DF_DimClient_IsDuplicate]  DEFAULT ((0)) FOR [IsDuplicate]
GO
ALTER TABLE [bi_cms_dqa].[DimClient] ADD  CONSTRAINT [DF_DimClient_IsInferredMember]  DEFAULT ((0)) FOR [IsInferredMember]
GO
ALTER TABLE [bi_cms_dqa].[DimClient] ADD  CONSTRAINT [DF_DimClient_IsException]  DEFAULT ((0)) FOR [IsException]
GO
ALTER TABLE [bi_cms_dqa].[DimClient] ADD  CONSTRAINT [DF_DimClient_IsHealthy]  DEFAULT ((0)) FOR [IsHealthy]
GO
ALTER TABLE [bi_cms_dqa].[DimClient] ADD  CONSTRAINT [DF_DimClient_IsRejected]  DEFAULT ((0)) FOR [IsRejected]
GO
ALTER TABLE [bi_cms_dqa].[DimClient] ADD  CONSTRAINT [DF_DimClient_IsAllowed]  DEFAULT ((0)) FOR [IsAllowed]
GO
ALTER TABLE [bi_cms_dqa].[DimClient] ADD  CONSTRAINT [DF_DimClient_IsFixed]  DEFAULT ((0)) FOR [IsFixed]
GO
ALTER TABLE [bi_cms_dqa].[DimClient] ADD  CONSTRAINT [DF_DimClient_CreateTimestamp]  DEFAULT (getdate()) FOR [CreateTimestamp]
GO
