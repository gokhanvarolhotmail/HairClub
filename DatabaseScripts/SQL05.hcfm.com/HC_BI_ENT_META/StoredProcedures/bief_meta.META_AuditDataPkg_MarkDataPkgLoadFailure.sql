/* CreateDate: 05/03/2010 12:09:21.760 , ModifyDate: 05/03/2010 12:09:21.760 */
GO
CREATE PROCEDURE [bief_meta].[META_AuditDataPkg_MarkDataPkgLoadFailure]
			 @DataPkgKey				int
AS
-------------------------------------------------------------------------
-- [META_AuditDataPkg_MarkDataPkgLoadFailure] is used to update
--            status of Data Package
--
--
--
--   exec [bief_meta].[META_AuditDataPkg_MarkDataPkgLoadFailure] 23
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
