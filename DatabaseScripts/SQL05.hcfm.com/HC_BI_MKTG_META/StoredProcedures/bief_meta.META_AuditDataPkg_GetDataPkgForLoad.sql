/* CreateDate: 05/03/2010 12:23:09.213 , ModifyDate: 06/07/2011 13:27:13.487 */
GO
CREATE PROCEDURE [bief_meta].[META_AuditDataPkg_GetDataPkgForLoad]
			  @DataPkgProcess           varchar(50) = null
			 ,@DataPkgKey				int output
AS
-------------------------------------------------------------------------
-- [META_AuditDataPkg_GetDataPkgForLoad] is used to update
--            status of Data Package
--
--
--
--   exec [bief_meta].[META_AuditDataPkg_GetDataPkgForLoad] 23
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		WHERE [Status] = 'Validation Complete'
