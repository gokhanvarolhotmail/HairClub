/* CreateDate: 05/03/2010 12:23:09.240 , ModifyDate: 06/07/2011 13:27:13.343 */
GO
CREATE PROCEDURE [bief_meta].[META_AuditDataPkg_GetDataPkgForValidation]
			 @DataPkgProcess            varchar(50) = null
			 ,@DataPkgKey				int output
AS
-------------------------------------------------------------------------
-- [META_AuditDataPkg_GetDataPkgForValidation] is used to update
--            status of Data Package
--
--
--
--   exec [bief_meta].[META_AuditDataPkg_GetDataPkgForValidation] 23
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		WHERE [Status] = 'Transformation Complete'
