/* CreateDate: 05/03/2010 12:09:37.847 , ModifyDate: 05/03/2010 12:09:37.847 */
GO
CREATE PROCEDURE [bi_ent_stage].[spHC_DDS_DimBusinessSegment_Upsert]
			   @DataPkgKey					int
...
AS
-------------------------------------------------------------------------
-- [spHC_DDS_DimBusinessSegment_Upsert] is used to update
-- SCD Type 1 records, update SCD Type 2 records and insert
-- New records
--
--
--   exec [bi_ent_stage].[spHC_DDS_DimBusinessSegment_Upsert] -1
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT @InitialRowCnt = COUNT(1) FROM [bi_ent_stage].[synHC_DDS_DimBusinessSegment]
		...
		-- New Records
		------------------------
		INSERT INTO [bi_ent_stage].[synHC_DDS_DimBusinessSegment] (
					  [BusinessSegmentSSID]
		...
		SELECT @FinalRowCnt = COUNT(1) FROM [bi_ent_stage].[synHC_DDS_DimBusinessSegment]
