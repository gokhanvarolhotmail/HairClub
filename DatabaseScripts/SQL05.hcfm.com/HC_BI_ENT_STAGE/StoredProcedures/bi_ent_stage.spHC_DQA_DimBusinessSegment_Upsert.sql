/* CreateDate: 05/03/2010 12:10:02.093 , ModifyDate: 05/03/2010 12:10:02.093 */
GO
CREATE PROCEDURE [bi_ent_stage].[spHC_DQA_DimBusinessSegment_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimBusinessSegment_Upsert] loads data to Data Quality
-- table
--
--
--   exec [bi_ent_stage].[spHC_DQA_DimBusinessSegment_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_ent_stage].[synHC_DQA_DimBusinessSegment] DQA ON
				DQA.[BusinessSegmentSSID] = STG.[BusinessSegmentSSID]
		...
		-----------------------
		INSERT INTO [bi_ent_stage].[synHC_DQA_DimBusinessSegment]
					( [DataPkgKey]
					, [BusinessSegmentKey]
					, [BusinessSegmentSSID]
