/* CreateDate: 05/03/2010 12:10:02.790 , ModifyDate: 07/11/2011 12:44:34.007 */
GO
CREATE procedure [bi_ent_stage].[spHC_DQA_DimRegion_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimRegion_Upsert] loads data to Data Quality
-- table
--
--
--   exec [bi_ent_stage].[spHC_DQA_DimRegion_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_ent_stage].[synHC_DQA_DimRegion] DQA ON
				DQA.[RegionSSID] = STG.[RegionSSID]
		...
		-----------------------
		INSERT INTO [bi_ent_stage].[synHC_DQA_DimRegion]
					( [DataPkgKey]
					, [RegionKey]
					, [RegionSSID]
					, [RegionDescription]
