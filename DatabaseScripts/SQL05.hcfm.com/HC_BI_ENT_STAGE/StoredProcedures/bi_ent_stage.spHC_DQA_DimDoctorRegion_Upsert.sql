/* CreateDate: 05/03/2010 12:10:02.617 , ModifyDate: 05/03/2010 12:10:02.617 */
GO
CREATE PROCEDURE [bi_ent_stage].[spHC_DQA_DimDoctorRegion_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimDoctorRegion_Upsert] loads data to Data Quality
-- table
--
--
--   exec [bi_ent_stage].[spHC_DQA_DimDoctorRegion_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_ent_stage].[synHC_DQA_DimDoctorRegion] DQA ON
				DQA.[DoctorRegionSSID] = STG.[DoctorRegionSSID]
		...
		-----------------------
		INSERT INTO [bi_ent_stage].[synHC_DQA_DimDoctorRegion]
					( [DataPkgKey]
					, [DoctorRegionKey]
					, [DoctorRegionSSID]
