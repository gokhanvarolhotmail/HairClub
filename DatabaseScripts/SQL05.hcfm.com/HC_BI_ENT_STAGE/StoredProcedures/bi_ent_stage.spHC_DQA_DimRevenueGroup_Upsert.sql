/* CreateDate: 05/03/2010 12:10:02.847 , ModifyDate: 05/03/2010 12:10:02.847 */
GO
CREATE PROCEDURE [bi_ent_stage].[spHC_DQA_DimRevenueGroup_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimRevenueGroup_Upsert] loads data to Data Quality
-- table
--
--
--   exec [bi_ent_stage].[spHC_DQA_DimRevenueGroup_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_ent_stage].[synHC_DQA_DimRevenueGroup] DQA ON
				DQA.[RevenueGroupSSID] = STG.[RevenueGroupSSID]
		...
		-----------------------
		INSERT INTO [bi_ent_stage].[synHC_DQA_DimRevenueGroup]
					( [DataPkgKey]
					, [RevenueGroupKey]
					, [RevenueGroupSSID]
