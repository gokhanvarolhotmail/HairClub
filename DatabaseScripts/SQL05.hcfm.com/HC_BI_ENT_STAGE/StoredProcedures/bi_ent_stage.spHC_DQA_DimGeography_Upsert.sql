/* CreateDate: 05/03/2010 12:10:02.720 , ModifyDate: 05/03/2010 12:10:02.720 */
GO
CREATE PROCEDURE [bi_ent_stage].[spHC_DQA_DimGeography_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimGeography_Upsert] loads data to Data Quality
-- table
--
--
--   exec [bi_ent_stage].[spHC_DQA_DimGeography_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_ent_stage].[synHC_DQA_DimGeography] DQA ON
					DQA.[PostalCode]		= STG.[PostalCode]
				AND DQA.[City]			= STG.[City]
		...
		-----------------------
		INSERT INTO [bi_ent_stage].[synHC_DQA_DimGeography]
					( [DataPkgKey]
				    , [GeographyKey]
				   , [PostalCode]
