/* CreateDate: 05/03/2010 12:09:53.427 , ModifyDate: 05/03/2010 12:09:53.427 */
GO
CREATE PROCEDURE [bi_ent_stage].[spHC_DimGeography_Cleanup]
       (
			  @DataPkgKey				int
       )
...
AS
-------------------------------------------------------------------------
-- [spHC_DimGeography_Cleanup] is used to Cleanup records
--
--
-- EXEC [spHC_DimGeography_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
  ...
  BEGIN TRY
		...
		DELETE FROM [bi_ent_stage].[DimGeography]
