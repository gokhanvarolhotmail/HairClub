/* CreateDate: 05/03/2010 12:09:46.930 , ModifyDate: 05/03/2010 12:09:46.930 */
GO
CREATE PROCEDURE [bi_ent_stage].[spHC_DimCenterType_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimCenterType_Cleanup] is used to Cleanup records
--
--
--   exec [bi_ent_stage].[spHC_DimCenterType_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
