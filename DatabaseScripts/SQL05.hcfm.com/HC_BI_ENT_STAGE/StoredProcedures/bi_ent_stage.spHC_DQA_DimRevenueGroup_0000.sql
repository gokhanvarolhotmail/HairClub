/* CreateDate: 05/03/2010 12:10:02.827 , ModifyDate: 05/03/2010 12:10:02.827 */
GO
CREATE PROCEDURE [bi_ent_stage].[spHC_DQA_DimRevenueGroup_0000]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimRevenueGroup_0000] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_ent_stage].[spHC_DQA_DimRevenueGroup_0000]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @TableName = N'[bi_ent_dqa].[DimRevenueGroup]'
	...
	BEGIN TRY
		...
		-----------------------
		EXEC	@return_value = [bi_ent_stage].[spHC_DQA_DimRevenueGroup_Upsert] @DataPkgKey, @RuleKey, @RuleActionKey,
