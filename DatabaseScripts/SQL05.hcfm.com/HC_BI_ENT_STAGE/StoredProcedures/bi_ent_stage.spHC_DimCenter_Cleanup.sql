/* CreateDate: 05/03/2010 12:09:49.080 , ModifyDate: 05/03/2010 12:09:49.080 */
GO
CREATE PROCEDURE [bi_ent_stage].[spHC_DimCenter_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimCenter_Cleanup] is used to Cleanup records
--
--
--   exec [bi_ent_stage].[spHC_DimCenter_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
