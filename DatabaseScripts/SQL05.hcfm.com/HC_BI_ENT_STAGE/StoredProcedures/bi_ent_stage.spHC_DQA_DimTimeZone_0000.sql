/* CreateDate: 05/03/2010 12:10:02.880 , ModifyDate: 05/03/2010 12:10:02.880 */
GO
CREATE PROCEDURE [bi_ent_stage].[spHC_DQA_DimTimeZone_0000]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimTimeZone_0000] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_ent_stage].[spHC_DQA_DimTimeZone_0000]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @TableName = N'[bi_dqa].[DimTimeZone]'
	...
	BEGIN TRY
		...
		-----------------------
		EXEC	@return_value = [bi_ent_stage].[spHC_DQA_DimTimeZone_Upsert] @DataPkgKey, @RuleKey, @RuleActionKey,
