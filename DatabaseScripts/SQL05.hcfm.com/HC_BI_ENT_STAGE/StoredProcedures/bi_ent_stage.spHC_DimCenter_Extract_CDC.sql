/* CreateDate: 05/03/2010 12:09:51.227 , ModifyDate: 05/06/2019 11:02:23.107 */
GO
CREATE procedure [bi_ent_stage].[spHC_DimCenter_Extract_CDC]
		@DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DimCenter_Extract_CDC] is used to retrieve a
-- list Center
--
--   exec [bi_ent_stage].[spHC_DimCenter_Extract_CDC]  '2009-01-01 01:00:00'
--                                       , '2009-01-02 01:00:00'
--
-------------------------------------------------------------------------
-- Change History
...
--			08/03/2018	KMurdoch	 Changed ReportingCenterSSID to come from center Number
-------------------------------------------------------------------------
BEGIN
	...
	DECLARE		  @TableName			varchar(150)	-- Name of table
 	...
 	SET @CDCTableName = N'dbo_cfgCenter'
