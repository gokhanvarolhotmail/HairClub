/* CreateDate: 05/03/2010 12:09:55.550 , ModifyDate: 05/03/2010 12:09:55.550 */
GO
CREATE PROCEDURE [bi_ent_stage].[spHC_DimRegion_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimRegion_Cleanup] is used to Cleanup records
--
--
--   exec [bi_ent_stage].[spHC_DimRegion_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
		...
		-----------------------
		DELETE FROM [bi_ent_stage].[DimRegion]
