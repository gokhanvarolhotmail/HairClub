/* CreateDate: 05/03/2010 12:10:02.693 , ModifyDate: 05/03/2010 12:10:02.693 */
GO
CREATE PROCEDURE [bi_ent_stage].[spHC_DQA_DimGeography_0000]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimGeography_0000] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_ent_stage].[spHC_DQA_DimGeography_0000]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @TableName = N'[bi_ent_dqa].[DimGeography]'
	...
	BEGIN TRY
		...
		-----------------------
		EXEC	@return_value = [bi_ent_stage].[spHC_DQA_DimGeography_Upsert] @DataPkgKey, @RuleKey, @RuleActionKey,
