/* CreateDate: 05/03/2010 12:10:02.247 , ModifyDate: 03/26/2018 15:55:39.713 */
GO
CREATE PROCEDURE [bi_ent_stage].[spHC_DQA_DimBusinessUnit_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimBusinessUnit_Upsert]  loads data to Data Quality
-- table
--
--
--   exec [bi_ent_stage].[spHC_DQA_DimBusinessUnit_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
/*
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_ent_stage].[synHC_DQA_DimBusinessUnit] DQA ON
				DQA.[BusinessUnitSSID] = STG.[BusinessUnitSSID]
		...
		-----------------------
		INSERT INTO [bi_ent_stage].[synHC_DQA_DimBusinessUnit]
					( [DataPkgKey]
					, [BusinessUnitKey]
					, [BusinessUnitSSID]
