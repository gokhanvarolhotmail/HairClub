/* CreateDate: 05/03/2010 12:10:02.077 , ModifyDate: 05/03/2010 12:10:02.077 */
GO
CREATE PROCEDURE [bi_ent_stage].[spHC_DQA_DimBusinessSegment_0012]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimBusinessSegment_0012] is used to perform the Data Quality
-- check on the data to be loaded into the data warehouse
--
--
--   exec [bi_ent_stage].[spHC_DQA_DimBusinessSegment_0012]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	SET @RuleKey = 12	--Log for Information
	SET @TableName = N'[bi_ent_dqa].[DimBusinessSegment]'
	...
	BEGIN TRY
		...
		-----------------------
		EXEC	@return_value = [bi_ent_stage].[spHC_DQA_DimBusinessSegment_Upsert] @DataPkgKey, @RuleKey, @RuleActionKey,
