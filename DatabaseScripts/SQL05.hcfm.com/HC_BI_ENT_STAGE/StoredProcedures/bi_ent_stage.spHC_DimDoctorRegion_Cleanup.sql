/* CreateDate: 05/03/2010 12:09:51.363 , ModifyDate: 05/03/2010 12:09:51.363 */
GO
CREATE PROCEDURE [bi_ent_stage].[spHC_DimDoctorRegion_Cleanup]
			  @DataPkgKey				int


AS
-------------------------------------------------------------------------
-- [spHC_DimDoctorRegion_Cleanup] is used to Cleanup records
--
--
--   exec [bi_ent_stage].[spHC_DimDoctorRegion_Cleanup] 422
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
