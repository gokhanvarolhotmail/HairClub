/* CreateDate: 05/03/2010 12:10:02.913 , ModifyDate: 05/03/2010 12:10:02.913 */
GO
CREATE PROCEDURE [bi_ent_stage].[spHC_DQA_DimTimeZone_Upsert]
			  @DataPkgKey				int
...
AS
-------------------------------------------------------------------------
-- [spHC_DQA_DimTimeZone_Upsert] loads data to Data Quality
-- table
--
--
--   exec [bi_ent_stage].[spHC_DQA_DimTimeZone_Upsert]
--
-------------------------------------------------------------------------
-- Change History
-------------------------------------------------------------------------
...
BEGIN
	...
	BEGIN TRY
	   ...
	   -- Put parameters in name value list to aid in reporting
		...
		LEFT OUTER JOIN [bi_ent_stage].[synHC_DQA_DimTimeZone] DQA ON
				DQA.[TimeZoneSSID] = STG.[TimeZoneSSID]
		...
		-----------------------
		INSERT INTO [bi_ent_stage].[synHC_DQA_DimTimeZone]
					( [DataPkgKey]
					, [TimeZoneKey]
					, [TimeZoneSSID]
					, [TimeZoneDescription]
