/* CreateDate: 04/26/2018 12:15:39.297 , ModifyDate: 05/09/2018 16:04:22.983 */
GO
/***********************************************************************
...
,		CASE WHEN #Conv.ActualConversions >= C.TargetConversions THEN 1 ELSE 0 END AS 'OnTarget'
FROM    #Centers C
