/* CreateDate: 07/28/2014 16:14:44.980 , ModifyDate: 07/13/2018 16:45:42.200 */
GO
/*
==============================================================================
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spRpt_WarBoardRegionalSalesManagers] 7, 2018
==============================================================================
*/
...
BEGIN
	...
	SELECT  CTR.CenterNumber AS 'CenterID'
	...
	WHERE   --CONVERT(VARCHAR, DC.CenterSSID) LIKE '[2]%'
	    DCT.CenterTypeDescriptionShort = 'C'
		AND DC.Active = 'Y'
	...
	FROM HC_Accounting.dbo.FactAccounting FA
		...
		INNER JOIN #Managers man
			ON C.CenterID = man.CenterNumber
