...
EXEC [dbo].[spRpt_ContestCircusOfStyle]

***********************************************************************/
CREATE PROCEDURE [dbo].[spRpt_ContestCircusOfStyle]
...
SET @ContestSSID = (SELECT C.ContestSSID FROM Contest C WHERE C.ContestName = 'CircusOfStyle')
SET @StartDate = '4/03/2018'
SET @EndDate = '5/12/2018'
...
INSERT  INTO #Centers
		...
		FROM    HC_BI_ENT_DDS.bi_ent_dds.DimCenter DC
				...
				INNER JOIN ContestCenterReportGroup CCRG
					ON DC.CenterNumber = CCRG.CenterSSID  ---Join on CenterNumber to CenterSSID (in the Contest tables)
				...
				INNER JOIN ContestCenterTarget CCT
					ON DC.CenterNumber = CCT.CenterSSID  ---Join on CenterNumber to CenterSSID (in the Contest tables)
