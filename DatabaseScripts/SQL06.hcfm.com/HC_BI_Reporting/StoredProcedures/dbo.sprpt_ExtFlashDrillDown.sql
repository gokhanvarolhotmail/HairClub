/* CreateDate: 09/18/2012 17:21:42.690 , ModifyDate: 03/08/2018 11:52:26.177 */
GO
SET ANSI_NULLS ON
GO
...
03/08/2018 - RH - (#145957) Changed CenterSSID to CenterNumber
==============================================================================
SAMPLE EXECUTION:
EXEC sprpt_ExtFlashDrillDown 292, 15,'12/1/2017', '12/31/2017', 3  --RRExtServices

EXEC sprpt_ExtFlashDrillDown 292, 1, '12/1/2017', '12/31/2017', 3 --NBCount

EXEC sprpt_ExtFlashDrillDown 292, 6, '12/1/2017', '12/31/2017', 3 --NBconv

EXEC sprpt_ExtFlashDrillDown 292, 8, '12/1/2017', '12/31/2017', 3 --Recurring Revenue Sales

EXEC sprpt_ExtFlashDrillDown 292, 11, '12/1/2017', '12/31/2017', 3  --RRcancels

EXEC sprpt_ExtFlashDrillDown 292, 10, '12/1/2017', '12/31/2017', 3 --RRrenewals

EXEC sprpt_ExtFlashDrillDown 250, 12, '12/1/2017', '12/31/2017', 3 --NB NetCount
...
SET NOCOUNT OFF
	...
	/*
		...
		--4 = New Business Expirations --This is a separate stored procedure
...
ELSE IF @type = 11 --Recurring Revenue Cancels
	BEGIN
		SELECT 'RB Cancels' AS ReportType,*
		FROM #Final
		WHERE RRcancels<>0
		AND FirstRank = 1
	END
ELSE IF @type = 12 --New Business Net Count
	BEGIN
		SELECT 'NB Net Count' AS ReportType,*
		FROM #Final
		WHERE NBcountnet<>0
		AND FirstRank = 1
	END
ELSE IF @type = 15 --Recurring Revenue Ext Services
	BEGIN
		SELECT 'RB EXT Services' AS ReportType,*
		FROM #Final
