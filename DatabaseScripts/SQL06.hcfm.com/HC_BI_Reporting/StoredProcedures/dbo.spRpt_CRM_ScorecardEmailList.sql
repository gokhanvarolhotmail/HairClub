...
,	CASE WHEN e.UserLogin IN('amallard') THEN 'tgoldsmith@hairclub.com'		--amallard
		WHEN CTR.CenterSSID = 286 THEN 'dgarrison@hairclub.com'				--DGarrison
		WHEN CTR.CenterSSID = 214 THEN 'mfaresh@hairclub.com'					--MFaresh
	ELSE '' END AS 'Copy'
,	'CRM' AS Position
