/* CreateDate: 04/14/2021 11:36:04.390 , ModifyDate: 04/15/2021 15:52:55.873 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
PROCEDURE:				spSvc_GetAcquiredClientDataForSaltLakeCity
...
EXEC spSvc_GetAcquiredClientDataForSaltLakeCity
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_GetAcquiredClientDataForSaltLakeCity]
AS
BEGIN
...
WHERE	ctr.CenterNumber = @CenterID
		...
		AND cm.ClientMembershipBeginDate >= '8/31/2020'
