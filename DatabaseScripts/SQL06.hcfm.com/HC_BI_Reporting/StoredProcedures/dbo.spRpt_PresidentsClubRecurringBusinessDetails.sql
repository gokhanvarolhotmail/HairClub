/* CreateDate: 10/04/2013 09:03:14.693 , ModifyDate: 05/17/2018 17:23:24.550 */
GO
SET ANSI_NULLS ON
GO
...
05/01/2018  RH  (#149654) Changed to VARCHAR(50) from 40 for MembershipDescription
05/17/2018	RH	(#150159) Added CenterNumber for Colorado Springs (238)
------------------------------------------------------------------------
SAMPLE EXECUTION:

EXEC spRpt_PresidentsClubRecurringBusinessDetails 10, '4/1/2018', '5/1/2018', 238

EXEC spRpt_PresidentsClubRecurringBusinessDetails 28, '4/1/2018', '5/1/2018', 238
...
,	CenterManagementAreaSSID INT
,	CenterManagementAreaDescription VARCHAR(255)
...
/********************************** Get Center/Area Data - Franchises are no longer using the President's Club **********/

IF LEN(@Center) >= 3  --A center has been selected
BEGIN
    INSERT  INTO #Centers
            ...
            WHERE   DC.CenterNumber = @Center
                    AND DC.Active = 'Y'
END
ELSE IF LEN(@Center) < 3 --An Area has been selected
BEGIN
    INSERT  INTO #Centers
            SELECT  DC.CenterSSID
				,	DC.CenterNumber
            ...
            WHERE   DCT.CenterTypeDescriptionShort = 'C'
					AND CMA.CenterManagementAreaSSID = @Center
                    AND DC.Active = 'Y'
END

/********************************** Get Transaction Data *************************************/
INSERT  INTO #Transactions
		SELECT  C.CenterSSID AS 'CenterSSID'
