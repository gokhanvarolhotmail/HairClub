/* CreateDate: 08/13/2012 11:24:11.203 , ModifyDate: 05/11/2020 15:39:42.930 */
GO
SET ANSI_NULLS ON
GO
...
08/22/2017 - RH - Changed join on DimRegion to DC.RegionKey = DR.RegionKey - Franchise Regions were showing incorrectly (#141550)
------------------------------------------------------------------------
SAMPLE EXECUTION:

EXEC spRpt_ManagementFeesPCPPerClient 5, 2020
***********************************************************************/
CREATE PROCEDURE [dbo].[spRpt_ManagementFeesPCPPerClient]
(
	@Month INT
,	@Year INT
)
...
INSERT  INTO #PCPRevenue
		...
		,       ISNULL(DC.CenterManagementAreaSSID, DR.RegionSSID)
		,		ISNULL(DC.CenterManagementAreaDescription, DR.RegionDescription)
