/* CreateDate: 07/22/2019 14:22:01.057 , ModifyDate: 04/20/2020 09:07:51.450 */
GO
SET ANSI_NULLS ON
GO
...
,	CASE WHEN CMA.CenterManagementAreaDescription IN('South') THEN 'moakes@hairclub.com;tgoldsmith@hairclub.com;dlittle@hairclub.com'
		WHEN CMA.CenterManagementAreaDescription IN('Canada') THEN 'moakes@hairclub.com;tgoldsmith@hairclub.com;nwahl@hairclub.com'
		WHEN CMA.CenterManagementAreaDescription IN('East') THEN 'moakes@hairclub.com;tgoldsmith@hairclub.com;nwahl@hairclub.com'
		WHEN CMA.CenterManagementAreaDescription IN('West') THEN 'moakes@hairclub.com;tgoldsmith@hairclub.com;dlittle@hairclub.com'
		WHEN CMA.CenterManagementAreaDescription IN('Central') THEN 'moakes@hairclub.com;tgoldsmith@hairclub.com;dlittle@hairclub.com;nwahl@hairclub.com'
	END AS 'Copy'
,	'MULTI' AS Position
