/* CreateDate: 08/12/2015 10:13:20.357 , ModifyDate: 02/19/2018 13:23:09.127 */
GO
SET ANSI_NULLS ON
GO
...
IF @CenterType = 2
	BEGIN
		INSERT  INTO #Centers
				...
				WHERE   CONVERT(VARCHAR, DC.CenterNumber) LIKE '[2]%'
						AND DC.Active = 'Y'
	END
...
IF @CenterType = 8
	BEGIN
		INSERT  INTO #Centers
				...
				WHERE   CONVERT(VARCHAR, DC.CenterNumber) LIKE '[78]%'
						AND DC.Active = 'Y'
	END
