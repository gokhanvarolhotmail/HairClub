/* CreateDate: 02/22/2022 15:53:35.850 , ModifyDate: 02/22/2022 15:53:35.850 */
GO
/***********************************************************************
...
***********************************************************************/
CREATE PROCEDURE [dbo].[spRpt_ClosingByConsultant_GVAROL_2022022]( @CenterType INT, @StartDate DATETIME, @EndDate DATETIME )
AS
SET FMTONLY OFF ;
