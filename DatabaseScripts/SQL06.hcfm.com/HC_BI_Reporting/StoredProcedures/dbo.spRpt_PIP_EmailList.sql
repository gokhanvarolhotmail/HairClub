...
,	CASE WHEN CMA.CenterManagementAreaDescription IN('South') THEN	'rkalra@hairclub.com;moakes@hairclub.com;nkridel@hairclub.com;nbowman@hairclub.com;gdebono@hairclub.com;dlittle@hairclub.com'
		 WHEN CMA.CenterManagementAreaDescription IN('Canada') THEN 'JEl-Dick@hairclub.com;moakes@hairclub.com;nkridel@hairclub.com;nbowman@hairclub.com;AAbusafieh@hairclub.com'
		 WHEN CMA.CenterManagementAreaDescription IN('East') THEN	'AChristy@hairclub.com;moakes@hairclub.com;nkridel@hairclub.com;nbowman@hairclub.com;hmatthews@hairclub.com'
		 WHEN CMA.CenterManagementAreaDescription IN('West') THEN	'AGonzales@hairclub.com;moakes@hairclub.com;nkridel@hairclub.com;nbowman@hairclub.com;gdebono@hairclub.com'
		 WHEN CMA.CenterManagementAreaDescription IN('Central') THEN 'moakes@hairclub.com;nkridel@hairclub.com;nbowman@hairclub.com;gdebono@hairclub.com'
		 WHEN CMA.CenterManagementAreaDescription IN('Mid-Atlantic') THEN 'moakes@hairclub.com;nkridel@hairclub.com;nbowman@hairclub.com;gdebono@hairclub.com'
		 WHEN CMA.CenterManagementAreaDescription IN('Midwest') THEN 'moakes@hairclub.com;nkridel@hairclub.com;nbowman@hairclub.com;gdebono@hairclub.com'
	END AS 'Copy'
