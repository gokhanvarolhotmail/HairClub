...
EXEC spSvc_BarthSourceCodeExport
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_BarthSourceCodeExport]
AS
BEGIN
...
SELECT  sc.SourceCodeID AS 'CampaignID'
,       sc.CampaignName
,       sc.CampaignName AS 'Description'
,		sc.CampaignType
,		sc.Type AS 'OwnerType'
,       sc.SourceCode
,		sc.PromoCode
,       sc.Number
,       sc.Media
