/* CreateDate: 01/20/2016 13:00:37.350 , ModifyDate: 01/09/2018 14:54:19.703 */
GO
SET ANSI_NULLS ON
GO
...
UNION
SELECT	AM.CenterManagementAreaKey AS 'CenterSSID'	--By Areas
	,	AM.CenterManagementAreaKey AS 'CenterKey'
	,	DD.FirstDateOfMonth
	,	SUM(ISNULL(FST.NB_BIOConvCnt,0)) AS 'NB_BIOConvCnt'
	,	SUM(ISNULL(FST.NB_EXTConvCnt,0)) AS 'NB_EXTConvCnt'
	,	SUM(ISNULL(FST.NB_XTRConvCnt,0)) AS 'NB_XTRConvCnt'
