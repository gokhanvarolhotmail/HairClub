/* CreateDate: 12/28/2018 13:07:43.060 , ModifyDate: 12/28/2018 13:07:43.060 */
GO
/***********************************************************************
NAME:					fnGetCurrentMembershipDetailsByClientKey
...
SELECT * FROM dbo.fnGetCurrentMembershipDetailsByClientKey(394826)
***********************************************************************/
CREATE FUNCTION [dbo].[fnGetCurrentMembershipDetailsByClientKey]
(
	@ClientKey INT
)
RETURNS TABLE
