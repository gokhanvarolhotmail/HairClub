/* CreateDate: 02/27/2020 07:44:10.147 , ModifyDate: 11/23/2021 12:37:22.493 */
GO
/***********************************************************************
PROCEDURE:				spSVC_Extreme_Step2_CreateDetails
...
EXEC spSVC_Extreme_Step2_CreateDetails '9/2/2018'
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_Extreme_Step2_CreateDetails]
(
	@Month DATETIME
)
AS
...
INSERT	INTO #DetailsToProcess
		...
		,       fst.ExtendedPrice
		,		CASE WHEN sc.SalesCodeDescriptionShort IN ( 'CANCEL', 'CONV', 'NB1XPR' ) THEN 1 ELSE 0 END AS 'MembershipCancelled'
		...
		WHERE   dd.FullDate BETWEEN @StartDate AND @EndDate
				...
				AND ( fst.NB_ExtCnt <> 0
						OR fst.NB_ExtAmt <> 0
						OR sc.SalesCodeDescriptionShort IN ( 'CONV', 'NB1XPR' ) )
