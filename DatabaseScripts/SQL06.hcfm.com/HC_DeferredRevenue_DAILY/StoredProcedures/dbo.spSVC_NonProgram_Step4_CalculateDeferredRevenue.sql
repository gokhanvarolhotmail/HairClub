...
EXEC spSVC_NonProgram_Step4_CalculateDeferredRevenue '9/2/2018'
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_NonProgram_Step4_CalculateDeferredRevenue]
(
	@Month DATETIME
)
AS
...
INSERT	INTO #Services
		...
		WHERE	sc.SalesCodeDescriptionShort IN ( 'APP', 'APPSOL', 'NB1A' )
