/* CreateDate: 01/24/2013 11:41:45.143 , ModifyDate: 10/24/2019 13:57:26.337 */
GO
SET ANSI_NULLS ON
GO
...
PROCEDURE:				[spSVC_CommissionTypeID_25_Step01_CreateHeader]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_25_Step01_CreateHeader]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_25_Step01_CreateHeader] AS
BEGIN
	SET NOCOUNT ON
	...
	WHERE C.CenterTypeKey=2
		...
		AND SC.SalesCodeDepartmentSSID IN (7030)
