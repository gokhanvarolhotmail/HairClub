/* CreateDate: 03/30/2019 12:34:59.070 , ModifyDate: 07/03/2019 09:40:31.587 */
GO
/***********************************************************************
PROCEDURE:				spSvc_CRM_Conversions_Step06_RetractCommission
DESTINATION SERVER:		SQL06
DESTINATION DATABASE:	HC_Commission
AUTHOR:					Dominic Leiba
IMPLEMENTOR:			Dominic Leiba
DATE IMPLEMENTED:		3/23/2019
DESCRIPTION:			Used to retract commissions for CRM Conversions
------------------------------------------------------------------------
NOTES:
...
EXEC spSvc_CRM_Conversions_Step06_RetractCommission
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_CRM_Conversions_Step06_RetractCommission]
AS
BEGIN
...
,		GETDATE()
,		'spSvc_CRM_Conversions_Step06_RetractCommission' AS 'CreateUser'
,		GETDATE()
,		'spSvc_CRM_Conversions_Step06_RetractCommission' AS 'UpdateUser'
FROM	#Refunds r
