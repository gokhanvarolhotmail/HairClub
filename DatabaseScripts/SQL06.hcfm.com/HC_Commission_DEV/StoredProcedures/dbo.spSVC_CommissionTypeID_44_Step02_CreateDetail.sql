/* CreateDate: 10/07/2016 14:34:51.613 , ModifyDate: 02/24/2017 08:51:46.100 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
PROCEDURE:				spSVC_CommissionTypeID_44_Step02_CreateDetail
...
EXEC spSVC_CommissionTypeID_44_Step02_CreateDetail
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_44_Step02_CreateDetail]
AS
BEGIN
...
INSERT  INTO #Details (
		...
		WHERE   ( FST.NB_XTRCnt > 0 OR FST.NB_XTRAmt <> 0 OR SC.SalesCodeKey IN ( 469, 637, 638, 1724, 1729, 1731, 1804, 1805, 1822, 1823 ) OR FST.NB_BIOConvCnt <> 0 )
