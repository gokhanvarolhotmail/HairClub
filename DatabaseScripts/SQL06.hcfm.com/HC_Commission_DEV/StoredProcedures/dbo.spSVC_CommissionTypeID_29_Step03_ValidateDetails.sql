/* CreateDate: 01/02/2014 14:50:21.010 , ModifyDate: 05/08/2020 14:43:02.383 */
GO
/*
==============================================================================

PROCEDURE:				[spSVC_CommissionTypeID_29_Step03_ValidateDetails]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_29_Step03_ValidateDetails]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_29_Step03_ValidateDetails] AS
BEGIN
	SET NOCOUNT ON
	...
	BEGIN
		...
		BEGIN
			...
			IF @CurrentDetailsSalesCodeKey IN (469, 642, 1683, 1684, 1685)
				...
				AND @CurrentDetailsOrderDateDate > DATEADD(DAY, 90, ISNULL(@InitialApplicationDate, GETDATE()))
				BEGIN
					UPDATE FactCommissionDetail
					SET IsValidTransaction = 0
