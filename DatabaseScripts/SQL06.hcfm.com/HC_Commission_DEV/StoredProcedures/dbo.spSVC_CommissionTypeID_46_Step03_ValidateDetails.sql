/* CreateDate: 08/07/2017 13:42:32.133 , ModifyDate: 12/11/2020 13:23:11.370 */
GO
/***********************************************************************
...
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_46_Step03_ValidateDetails]
AS
BEGIN
...
BEGIN
    ...
    WHERE   CommissionHeaderKey = @CurrentCommissionHeaderKey
            AND SalesCodeDescriptionShort IN ( 'MEDADDONTG', 'MEDADDONTG9', 'HMEDADDON', 'HMEDADDON3' )
