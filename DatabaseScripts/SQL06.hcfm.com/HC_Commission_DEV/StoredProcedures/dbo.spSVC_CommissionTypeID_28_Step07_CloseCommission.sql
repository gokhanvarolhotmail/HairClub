/* CreateDate: 06/20/2013 15:43:26.293 , ModifyDate: 06/20/2013 15:43:26.293 */
GO
SET ANSI_NULLS ON
GO
...
PROCEDURE:				[spSVC_CommissionTypeID_28_Step07_CloseCommission]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_28_Step07_CloseCommission]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_28_Step07_CloseCommission] AS
BEGIN
	SET NOCOUNT ON
