/* CreateDate: 10/06/2015 12:00:21.190 , ModifyDate: 10/07/2015 15:54:59.950 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
PROCEDURE:				spSVC_CommissionTypeID_11_Step02_CreateDetail
...
EXEC spSVC_CommissionTypeID_11_Step02_CreateDetail
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_11_Step02_CreateDetail]
AS
BEGIN
...
INSERT  INTO #Details (
        ...
        FROM    HC_BI_CMS_DDS.bi_cms_dds.FactSalesTransaction FST
                ...
                INNER JOIN #OpenCommissions OC
                    ON OC.ClientMembershipKey = cm.ClientMembershipKey
        ...
        WHERE   DD.FullDate BETWEEN @TransactionStartDate AND @TransactionEndDate
                ...
                AND ( FST.S_SurCnt > 0 OR FST.S_SurAmt <> 0 OR SC.SalesCodeKey = 1701 )
