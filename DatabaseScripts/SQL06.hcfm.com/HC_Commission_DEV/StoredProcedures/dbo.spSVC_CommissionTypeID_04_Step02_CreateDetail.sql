/* CreateDate: 10/09/2012 15:16:24.343 , ModifyDate: 08/12/2020 16:42:35.113 */
GO
/*
==============================================================================

PROCEDURE:				[spSVC_CommissionTypeID_04_Step02_CreateDetail]
...
07/24/2014 - DL - Added WHERE clause check for Surgery Performed transactions (SalesCode 1701)
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_04_Step02_CreateDetail]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_04_Step02_CreateDetail] AS
BEGIN
	SET NOCOUNT ON
	...
	FROM HC_BI_CMS_DDS.bi_cms_dds.FactSalesTransaction FST
		...
		INNER JOIN HC_BI_CMS_DDS.bi_cms_dds.DimSalesOrder SO
			ON FST.ClientMembershipKey = SO.ClientMembershipKey
	...
	WHERE DD.FullDate BETWEEN @TransactionStartDate AND @TransactionEndDate
		...
		AND ( FST.S_SurCnt > 0 OR FST.S_SurAmt <> 0 OR SC.SalesCodeKey IN ( 1701, 481 ) )
