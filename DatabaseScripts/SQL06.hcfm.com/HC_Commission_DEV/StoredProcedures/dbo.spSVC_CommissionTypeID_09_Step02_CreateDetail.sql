/* CreateDate: 10/09/2012 16:29:55.413 , ModifyDate: 03/29/2017 11:22:27.487 */
GO
/*
==============================================================================

PROCEDURE:				[spSVC_CommissionTypeID_09_Step02_CreateDetail]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_09_Step02_CreateDetail]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_09_Step02_CreateDetail] AS
BEGIN
	SET NOCOUNT ON
	...
	WHERE DD.FullDate BETWEEN @TransactionStartDate AND @TransactionEndDate
		...
		AND M.MembershipKey NOT IN ( 114, 115, 116, 117, 118, 119, 120, 121, 136, 137, 138, 139 )
