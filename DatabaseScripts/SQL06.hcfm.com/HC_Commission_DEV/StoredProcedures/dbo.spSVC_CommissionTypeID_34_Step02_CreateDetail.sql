/* CreateDate: 11/21/2014 09:09:48.750 , ModifyDate: 07/27/2017 16:54:05.160 */
GO
/***********************************************************************
PROCEDURE:				spSVC_CommissionTypeID_34_Step02_CreateDetail
...
EXEC spSVC_CommissionTypeID_34_Step02_CreateDetail
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_34_Step02_CreateDetail]
AS
BEGIN
        ...
        FROM    HC_BI_CMS_DDS.bi_cms_dds.FactSalesTransaction FST
                INNER JOIN #OpenCommissions OC
					ON OC.ClientMembershipKey = FST.ClientMembershipKey
						AND OC.SalesOrderKey = FST.SalesOrderDetailKey
