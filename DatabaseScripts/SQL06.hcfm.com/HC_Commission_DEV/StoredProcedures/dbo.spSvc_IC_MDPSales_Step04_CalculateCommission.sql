/* CreateDate: 03/30/2019 12:38:30.320 , ModifyDate: 03/06/2020 15:17:53.067 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
PROCEDURE:				spSvc_IC_MDPSales_Step04_CalculateCommission
DESTINATION SERVER:		SQL06
DESTINATION DATABASE:	HC_Commission
AUTHOR:					Dominic Leiba
IMPLEMENTOR:			Dominic Leiba
DATE IMPLEMENTED:		3/23/2019
DESCRIPTION:			Used to calculate commissions for IC MDP Sales
------------------------------------------------------------------------
NOTES:
...
EXEC spSvc_IC_MDPSales_Step04_CalculateCommission
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_IC_MDPSales_Step04_CalculateCommission]
AS
BEGIN
...
/********************************** Get Stylists (if any) associated with sale *************************************/
INSERT	INTO #Stylist
		SELECT	oc.CommissionHeaderKey
		,		sty.EmployeeKey
...
UPDATE	oc
SET		oc.CommissionPercentage = CASE WHEN CAST(oc.SalesOrderDate AS DATE) >= '7/27/2019' AND STYEmployeeKey <> -1 THEN dbo.DIVIDE_DECIMAL(@CommissionPercentage, 2) ELSE @CommissionPercentage END
FROM	#OpenCommissions oc
