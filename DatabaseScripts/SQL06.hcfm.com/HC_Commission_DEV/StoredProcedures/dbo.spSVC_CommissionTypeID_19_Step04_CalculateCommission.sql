/* CreateDate: 11/01/2012 16:37:36.607 , ModifyDate: 07/07/2014 15:55:23.057 */
GO
SET ANSI_NULLS ON
GO
...
PROCEDURE:				[spSVC_CommissionTypeID_19_Step04_CalculateCommission]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_19_Step04_CalculateCommission]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_19_Step04_CalculateCommission] AS
BEGIN
	SET NOCOUNT ON
