/* CreateDate: 10/30/2012 14:42:36.597 , ModifyDate: 07/24/2017 15:12:40.190 */
GO
SET ANSI_NULLS ON
GO
...
PROCEDURE:				[spSVC_CommissionTypeID_10_Step03_ValidateDetails]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_10_Step03_ValidateDetails]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_10_Step03_ValidateDetails] AS
BEGIN
	SET NOCOUNT ON
	...
	BEGIN
		...
		WHERE CommissionHeaderKey = @CurrentCommissionHeaderKey
			AND SalesCodeDescriptionShort = 'CONV'
