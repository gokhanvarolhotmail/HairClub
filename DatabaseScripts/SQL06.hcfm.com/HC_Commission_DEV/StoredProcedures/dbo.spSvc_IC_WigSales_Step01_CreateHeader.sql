/* CreateDate: 02/06/2020 08:04:03.090 , ModifyDate: 09/16/2020 15:09:35.320 */
GO
/***********************************************************************
...
DESCRIPTION:			Used to generate a commission header record for IC Wig Sales
------------------------------------------------------------------------
NOTES:
...
EXEC spSvc_IC_WigSales_Step01_CreateHeader
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_IC_WigSales_Step01_CreateHeader]
AS
BEGIN
...
-- Get all wig sales within the specified time frame
