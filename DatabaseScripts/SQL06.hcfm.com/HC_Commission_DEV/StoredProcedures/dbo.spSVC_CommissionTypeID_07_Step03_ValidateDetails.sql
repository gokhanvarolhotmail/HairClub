/* CreateDate: 10/25/2012 09:52:07.473 , ModifyDate: 05/08/2020 15:02:10.620 */
GO
SET ANSI_NULLS ON
GO
...
PROCEDURE:				[spSVC_CommissionTypeID_07_Step03_ValidateDetails]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_07_Step03_ValidateDetails]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_07_Step03_ValidateDetails] AS
BEGIN
	SET NOCOUNT ON
