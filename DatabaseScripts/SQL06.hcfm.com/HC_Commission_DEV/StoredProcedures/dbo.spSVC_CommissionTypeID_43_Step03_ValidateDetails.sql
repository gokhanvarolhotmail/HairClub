/* CreateDate: 10/07/2016 14:33:33.950 , ModifyDate: 02/23/2017 14:10:01.173 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
PROCEDURE:				spSVC_CommissionTypeID_43_Step03_ValidateDetails
...
EXEC spSVC_CommissionTypeID_43_Step03_ValidateDetails
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_43_Step03_ValidateDetails]
AS
BEGIN
      ...
      BEGIN
            ...
            WHILE @CurrentDetailsCount <= @TotalDetailsCount
                  BEGIN
						...
						------------------------------------------------------------------------------------------
                        IF @CurrentDetailsSalesCodeKey IN ( 469, 1684, 1822, 1823 )
                        ...
                        WHERE   CommissionDetailKey = @CommissionDetailKey
                                ...
                                AND @CurrentDetailsSalesCodeKey IN ( 469, 1684, 1822, 1823 )
                                AND @CurrentIsRefund = 1
                                AND @CurrentDetailsOrderDateDate > @InitialApplicationDate
