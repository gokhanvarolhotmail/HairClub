/* CreateDate: 03/30/2019 12:40:07.800 , ModifyDate: 03/30/2019 12:40:07.800 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
PROCEDURE:				spSvc_STY_LaserSales_Step04_AdvanceCommission
DESTINATION SERVER:		SQL06
DESTINATION DATABASE:	HC_Commission
AUTHOR:					Dominic Leiba
IMPLEMENTOR:			Dominic Leiba
DATE IMPLEMENTED:		3/23/2019
DESCRIPTION:			Used to advance commissions for IC Laser Sales
------------------------------------------------------------------------
NOTES:
...
EXEC spSvc_STY_LaserSales_Step04_AdvanceCommission
***********************************************************************/
CREATE PROCEDURE spSvc_STY_LaserSales_Step04_AdvanceCommission
AS
BEGIN
