/* CreateDate: 10/08/2015 11:10:09.220 , ModifyDate: 05/08/2020 15:19:43.157 */
GO
/***********************************************************************
PROCEDURE:				spSVC_CommissionTypeID_41_Step03_ValidateDetails
...
EXEC spSVC_CommissionTypeID_41_Step03_ValidateDetails
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_41_Step03_ValidateDetails]
AS
BEGIN
      ...
      BEGIN
            ...
            WHILE @CurrentDetailsCount <= @TotalDetailsCount
                  BEGIN
						...
						------------------------------------------------------------------------------------------
                        IF @CurrentDetailsSalesCodeKey IN ( 469, 1683, 1684, 1685, 1729, 637, 638, 1731 )
                        ...
                        IF @CurrentDetailsSalesCodeKey IN ( 469, 1683, 1684, 1685, 1729, 637, 638, 1731 )
                           ...
                           AND @CurrentDetailsOrderDateDate > DATEADD(DAY, 30, ISNULL(@CurrentInitialServiceDate, GETDATE()))
                           BEGIN
                                 UPDATE FactCommissionDetail
                                 SET    IsValidTransaction = 0
                        ...
                        WHERE   CommissionDetailKey = @CommissionDetailKey
                                ...
                                AND @CurrentDetailsSalesCodeKey IN ( 469, 1683, 1684, 1685, 1729, 637, 638, 1731 )
                                AND @CurrentIsRefund = 1
                                AND @CurrentDetailsOrderDateDate > @CurrentInitialServiceDate
