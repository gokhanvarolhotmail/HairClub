/* CreateDate: 03/30/2019 12:35:32.470 , ModifyDate: 12/01/2020 10:05:06.490 */
GO
SET ANSI_NULLS ON
GO
...
DESCRIPTION:			Used to generate a commission detail record for CRM Conversions
------------------------------------------------------------------------
NOTES:
...
EXEC spSvc_CRM_Conversions_Step02_CreateDetail
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_CRM_Conversions_Step02_CreateDetail]
AS
BEGIN
