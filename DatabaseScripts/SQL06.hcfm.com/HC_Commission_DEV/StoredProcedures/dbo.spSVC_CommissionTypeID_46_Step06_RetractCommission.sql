/* CreateDate: 08/07/2017 13:42:57.297 , ModifyDate: 12/11/2020 13:37:08.610 */
GO
/***********************************************************************
...
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_46_Step06_RetractCommission]
AS
BEGIN
...
BEGIN
    ...
    BEGIN
        ...
        ,       PlanPercentage = CASE WHEN @CurrentCenterSSID = 1001 THEN @TriGenPercentageHW ELSE @TriGenPercentage END
        ,       UpdateDate = GETDATE()
    ...
    BEGIN
        ...
        ,       AdvancedCommission = ( ISNULL(@CurrentTotalPayments, 0) * CASE WHEN @CurrentCenterSSID = 1001 THEN @TriGenPercentageHW ELSE @TriGenPercentage END ) - ISNULL(@CurrentTotalPaidCommission, 0)
        ,       AdvancedCommissionDate = @CurrentRetractionTransactionDate
        ,       AdvancedPayPeriodKey = @CurrentPayPeriodKey
