/* CreateDate: 01/12/2022 10:27:55.590 , ModifyDate: 01/12/2022 10:27:55.590 */
GO
--drop view vw_Fragmented_Indexes;

create view vw_Fragmented_Indexes as
SELECT
TOP 100 PERCENT
...
/*
select top 1 FullyQualifiedObjectName, ProposedIndex, max(AvgUserImpact) as MaxImpact
from vw_Fragmented_Indexes
group by FullyQualifiedObjectName
having max(AvgUserImpact) > 75
