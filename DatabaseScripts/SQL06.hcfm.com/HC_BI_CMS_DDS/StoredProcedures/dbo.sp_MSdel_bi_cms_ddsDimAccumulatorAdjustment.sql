...
begin
	...
	delete [bi_cms_dds].[DimAccumulatorAdjustment]
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[bi_cms_dds].[DimAccumulatorAdjustment]', @param2=@primarykey_text, @param3=13234
			End
			Else
