/* CreateDate: 10/03/2019 23:03:41.580 , ModifyDate: 10/03/2019 23:03:41.580 */
GO
create procedure [sp_MSupd_bi_cms_ddsDimSalesCodeDepartment]
		@c1 int = NULL,
		@c2 int = NULL,
		@c3 nvarchar(50) = NULL,
		@c4 nvarchar(10) = NULL,
...
update [bi_cms_dds].[DimSalesCodeDepartment] set
		[SalesCodeDepartmentSSID] = case substring(@bitmap,1,1) & 2 when 2 then @c2 else [SalesCodeDepartmentSSID] end,
		...
		[SalesCodeDivisionKey] = case substring(@bitmap,1,1) & 16 when 16 then @c5 else [SalesCodeDivisionKey] end,
		[SalesCodeDivisionSSID] = case substring(@bitmap,1,1) & 32 when 32 then @c6 else [SalesCodeDivisionSSID] end,
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[bi_cms_dds].[DimSalesCodeDepartment]', @param2=@primarykey_text, @param3=13233
			End
			Else
