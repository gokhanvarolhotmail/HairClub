/* CreateDate: 10/03/2019 23:03:41.647 , ModifyDate: 10/03/2019 23:03:41.647 */
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [sp_MSupd_bi_cms_ddsDimSalesCodeDivision]
		@c1 int = NULL,
		@c2 int = NULL,
		@c3 nvarchar(50) = NULL,
		@c4 nvarchar(10) = NULL,
...
update [bi_cms_dds].[DimSalesCodeDivision] set
		[SalesCodeDivisionSSID] = case substring(@bitmap,1,1) & 2 when 2 then @c2 else [SalesCodeDivisionSSID] end,
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[bi_cms_dds].[DimSalesCodeDivision]', @param2=@primarykey_text, @param3=13233
			End
			Else
