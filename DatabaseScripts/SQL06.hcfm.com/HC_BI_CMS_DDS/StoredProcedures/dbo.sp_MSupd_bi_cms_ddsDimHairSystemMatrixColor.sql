/* CreateDate: 10/03/2019 23:03:40.820 , ModifyDate: 10/03/2019 23:03:40.820 */
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [sp_MSupd_bi_cms_ddsDimHairSystemMatrixColor]
		@c1 int = NULL,
		@c2 nvarchar(50) = NULL,
		@c3 nvarchar(50) = NULL,
		@c4 nvarchar(10) = NULL,
...
update [bi_cms_dds].[DimHairSystemMatrixColor] set
		[HairSystemMatrixColorSSID] = case substring(@bitmap,1,1) & 2 when 2 then @c2 else [HairSystemMatrixColorSSID] end,
		...
		[HairSystemMatrixColorSortOrder] = case substring(@bitmap,1,1) & 16 when 16 then @c5 else [HairSystemMatrixColorSortOrder] end,
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[bi_cms_dds].[DimHairSystemMatrixColor]', @param2=@primarykey_text, @param3=13233
			End
			Else
