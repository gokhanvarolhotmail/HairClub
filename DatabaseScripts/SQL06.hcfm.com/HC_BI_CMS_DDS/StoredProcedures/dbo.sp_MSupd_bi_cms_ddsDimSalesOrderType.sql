/* CreateDate: 10/03/2019 23:03:41.950 , ModifyDate: 10/03/2019 23:03:41.950 */
GO
create procedure [sp_MSupd_bi_cms_ddsDimSalesOrderType]
		@c1 int = NULL,
		@c2 int = NULL,
		@c3 nvarchar(50) = NULL,
		@c4 nvarchar(10) = NULL,
...
update [bi_cms_dds].[DimSalesOrderType] set
		[SalesOrderTypeSSID] = case substring(@bitmap,1,1) & 2 when 2 then @c2 else [SalesOrderTypeSSID] end,
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				set @primarykey_text = @primarykey_text + '[SalesOrderTypeKey] = ' + convert(nvarchar(100),@pkc1,1)
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[bi_cms_dds].[DimSalesOrderType]', @param2=@primarykey_text, @param3=13233
			End
			Else
