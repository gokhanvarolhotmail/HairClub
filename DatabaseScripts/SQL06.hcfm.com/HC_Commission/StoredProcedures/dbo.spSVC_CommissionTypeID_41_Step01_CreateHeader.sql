/* CreateDate: 10/08/2015 11:06:10.897 , ModifyDate: 08/25/2016 09:42:25.693 */
GO
/***********************************************************************
PROCEDURE:				spSVC_CommissionTypeID_41_Step01_CreateHeader
...
EXEC spSVC_CommissionTypeID_41_Step01_CreateHeader
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_41_Step01_CreateHeader]
AS
BEGIN
...
INSERT  INTO #Header (
		...
		,       ISNULL(SVC.EmployeeKey, -1) AS 'EmployeeKey'
		,       ISNULL(SVC.EmployeeFullName, 'Unknown, Unknown') AS 'EmployeeFullName'
		...
		WHERE   CTR.CenterTypeKey = 2
				...
				AND DM_From.MembershipKey IN ( 59, 60, 61, 62, 66, 93, 94, 106, 112, 113, 131, 132, 133, 134 )
				AND DM_To.MembershipKey IN ( 122, 124 )
