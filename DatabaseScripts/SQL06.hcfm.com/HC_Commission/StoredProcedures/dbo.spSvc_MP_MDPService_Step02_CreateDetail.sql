...
DESCRIPTION:			Used to generate a commission detail record for MP MDP Services
------------------------------------------------------------------------
NOTES:
...
EXEC spSvc_MP_MDPService_Step02_CreateDetail
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_MP_MDPService_Step02_CreateDetail]
AS
BEGIN
...
INSERT	INTO #DetailsToProcess
		...
		WHERE	ctr.CenterNumber LIKE '[2]%'
				...
				AND sc.SalesCodeDescriptionShort = 'MEMPMTMDP'
