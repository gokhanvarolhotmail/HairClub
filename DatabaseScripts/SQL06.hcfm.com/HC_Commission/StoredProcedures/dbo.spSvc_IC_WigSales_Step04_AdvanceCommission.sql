...
DESCRIPTION:			Used to advance commissions for IC Wig Sales
------------------------------------------------------------------------
NOTES:
...
EXEC spSvc_IC_WigSales_Step04_AdvanceCommission
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_IC_WigSales_Step04_AdvanceCommission]
AS
BEGIN
