/* CreateDate: 10/30/2012 15:28:03.667 , ModifyDate: 01/17/2013 17:04:36.827 */
GO
/*
==============================================================================

PROCEDURE:				[spSVC_CommissionTypeID_10_Step07_CloseCommission]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_10_Step07_CloseCommission]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_10_Step07_CloseCommission] AS
BEGIN
	SET NOCOUNT ON
	...
	WHERE FCH.CommissionTypeID = @CommissionTypeID
		...
		AND FCD.SalesCodeKey IN (475, 476)
		AND FCH.IsClosed = 0
