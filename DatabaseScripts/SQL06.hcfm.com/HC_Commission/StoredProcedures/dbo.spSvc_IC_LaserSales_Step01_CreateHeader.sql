/* CreateDate: 03/30/2019 12:37:17.170 , ModifyDate: 03/17/2021 09:25:10.953 */
GO
/***********************************************************************
PROCEDURE:				spSvc_IC_LaserSales_Step01_CreateHeader
DESTINATION SERVER:		SQL06
DESTINATION DATABASE:	HC_Commission
AUTHOR:					Dominic Leiba
IMPLEMENTOR:			Dominic Leiba
DATE IMPLEMENTED:		3/23/2019
DESCRIPTION:			Used to generate a commission header record for IC Laser Sales
------------------------------------------------------------------------
NOTES:
...
EXEC spSvc_IC_LaserSales_Step01_CreateHeader
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_IC_LaserSales_Step01_CreateHeader]
AS
BEGIN
...
-- Get all laser sales within the specified time frame
INSERT	INTO #HeadersToProcess
		...
		WHERE	ctr.CenterTypeKey = 2
				...
				AND ( fst.LaserCnt >= 1 OR fst.LaserAmt > ($0.0000) )
