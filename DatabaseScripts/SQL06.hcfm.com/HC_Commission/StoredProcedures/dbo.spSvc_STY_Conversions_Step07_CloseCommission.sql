...
DESCRIPTION:			Used to close commission records for STY Conversions
------------------------------------------------------------------------
NOTES:
...
EXEC spSvc_STY_Conversions_Step07_CloseCommission
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_STY_Conversions_Step07_CloseCommission]
AS
BEGIN
