/* CreateDate: 11/21/2014 11:32:20.990 , ModifyDate: 12/03/2014 13:14:44.690 */
GO
/***********************************************************************
PROCEDURE:				spSVC_CommissionTypeID_36_Step03_ValidateDetails
...
EXEC spSVC_CommissionTypeID_36_Step03_ValidateDetails
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_36_Step03_ValidateDetails]
AS
BEGIN
      ...
      BEGIN
            ...
            WHILE @CurrentDetailsCount <= @TotalDetailsCount
                  BEGIN
						...
						------------------------------------------------------------------------------------------
                        IF @CurrentDetailsSalesCodeKey = 1738
