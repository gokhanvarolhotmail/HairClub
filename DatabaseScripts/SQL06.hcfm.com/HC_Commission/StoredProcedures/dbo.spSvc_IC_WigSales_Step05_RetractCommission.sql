/* CreateDate: 02/06/2020 08:14:19.357 , ModifyDate: 03/17/2021 09:21:23.583 */
GO
/***********************************************************************
PROCEDURE:				spSvc_IC_WigSales_Step05_RetractCommission
DESTINATION SERVER:		SQL06
DESTINATION DATABASE:	HC_Commission
AUTHOR:					Dominic Leiba
IMPLEMENTOR:			Dominic Leiba
DATE IMPLEMENTED:		3/23/2019
DESCRIPTION:			Used to retract commissions for IC Wig Sales
------------------------------------------------------------------------
NOTES:
...
EXEC spSvc_IC_WigSales_Step05_RetractCommission
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_IC_WigSales_Step05_RetractCommission]
AS
BEGIN
...
-- Refunds must be within 90 days of the original sale of the wig
INSERT	INTO #Refunds
		...
		WHERE	ctr.CenterTypeKey = 2
				...
				AND dd.FullDate >= CAST(oc.SalesOrderDate AS DATE)
				AND DATEDIFF(DAY, oc.SalesOrderDate, so.OrderDate) <= 90
				AND sc.SalesCodeDepartmentSSID = 7052
				AND fst.ExtendedPrice < ($0.0000)
