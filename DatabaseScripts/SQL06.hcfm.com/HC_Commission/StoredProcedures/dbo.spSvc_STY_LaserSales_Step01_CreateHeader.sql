...
DESCRIPTION:			Used to generate a commission header record for STY Laser Sales
------------------------------------------------------------------------
NOTES:
...
EXEC spSvc_STY_LaserSales_Step01_CreateHeader
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_STY_LaserSales_Step01_CreateHeader]
AS
BEGIN
...
INSERT	INTO #HeadersToProcess
		...
		WHERE	ctr.CenterNumber LIKE '[2]%'
				...
				AND m.MembershipDescriptionShort NOT IN ( 'EMPLOYEE', 'EMPLOYEXT', 'EMPLOYXTR', 'EMPLOYMDP', 'LASER82' )
