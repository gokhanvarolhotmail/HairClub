/* CreateDate: 10/03/2012 15:31:09.987 , ModifyDate: 03/04/2013 17:39:27.293 */
GO
/*
==============================================================================

PROCEDURE:				[spSVC_CommissionTypeID_01_Step01_CreateHeader]
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CommissionTypeID_01_Step01_CreateHeader]
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_CommissionTypeID_01_Step01_CreateHeader] AS
BEGIN
	SET NOCOUNT ON
	...
	WHERE C.CenterTypeKey=2
		...
		AND ((FST.NB_TradCnt>=1
			...
			OR (FST.SalesCodeKey IN (668)
				AND M.MembershipKey IN (63, 98, 100))
			)
