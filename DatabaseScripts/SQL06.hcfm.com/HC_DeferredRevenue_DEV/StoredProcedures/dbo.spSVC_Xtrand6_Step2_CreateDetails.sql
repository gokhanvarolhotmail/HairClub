/* CreateDate: 02/27/2020 07:44:11.240 , ModifyDate: 02/27/2020 07:44:11.240 */
GO
SET ANSI_NULLS ON
GO
...
EXEC spSVC_Xtrand6_Step2_CreateDetails '9/2/2018'
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_Xtrand6_Step2_CreateDetails]
(
	@Month DATETIME
)
AS
...
INSERT	INTO #DetailsToProcess
		...
		WHERE   dd.FullDate BETWEEN @StartDate AND @EndDate
				...
				AND ( fst.NB_XTRCnt <> 0
						OR fst.NB_XTRAmt <> 0
						OR sc.SalesCodeDescriptionShort IN ( 'XTRNEWSRV', 'CONV', 'NB1XPR' ) )
