/* CreateDate: 02/27/2020 07:44:10.833 , ModifyDate: 02/27/2020 07:44:10.833 */
GO
/***********************************************************************
...
EXEC spSVC_PCP_ProcessData '11/2/2019'
***********************************************************************/
...
UPDATE	htp
SET		htp.DeferredCalc = CASE WHEN ( ( htp.MembershipCancelled = 1 OR htp.MonthsRemaining <= 0 OR htp.MembershipRank <> 1 ) OR htp.CurrentDeferredAmount < 0 ) THEN 0 ELSE ( htp.CurrentDeferredAmount - htp.MembershipRateCalc ) END
FROM	#HeadersToProcess htp


UPDATE	htp
SET		htp.RevenueCalc = CASE WHEN ( ( htp.MembershipCancelled = 1 OR htp.MonthsRemaining <= 0 OR htp.MembershipRank <> 1 ) OR htp.CurrentDeferredAmount < 0 ) THEN htp.CurrentDeferredAmount ELSE htp.MembershipRateCalc END
FROM	#HeadersToProcess htp
