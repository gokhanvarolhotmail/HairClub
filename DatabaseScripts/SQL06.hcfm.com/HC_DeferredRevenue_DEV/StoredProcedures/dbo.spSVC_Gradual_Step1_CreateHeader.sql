...
EXEC spSVC_Gradual_Step1_CreateHeader '8/2/2018'
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_Gradual_Step1_CreateHeader]
(
	@Month DATETIME
)
AS
...
-- Get Initial Assignments to Xtrands+ Initial 6 during specified date range
INSERT	INTO #HeadersToProcess
		...
		WHERE	dd.FullDate BETWEEN @StartDate AND @EndDate
				...
				AND m.MembershipDescriptionShort IN ( 'GRAD', 'GRADSOL6', 'GRADSOL12', 'GRDSV12', 'GRDSVSOL12', 'GRDSV', 'GRDSVSOL', 'GRAD12', 'GRDSVEZ' )
