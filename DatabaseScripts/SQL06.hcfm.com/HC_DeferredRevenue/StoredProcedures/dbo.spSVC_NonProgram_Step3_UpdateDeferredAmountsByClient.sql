/* CreateDate: 04/24/2013 14:01:19.343 , ModifyDate: 02/21/2019 14:38:51.147 */
GO
SET ANSI_NULLS ON
GO
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_NonProgram_Step3_UpdateDeferredAmountsByClient] '1/1/11'
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_NonProgram_Step3_UpdateDeferredAmountsByClient] (@Month DATETIME)
AS
BEGIN
	SET NOCOUNT ON
