/* CreateDate: 12/07/2012 09:15:35.810 , ModifyDate: 08/01/2014 15:47:42.313 */
GO
/*
==============================================================================

PROCEDURE:				[spSVC_CreateHeader_Tradition]
...
==============================================================================
DESCRIPTION:	Create NB - Traditional membership headers
==============================================================================
NOTES:
...
==============================================================================
SAMPLE EXECUTION:
EXEC [spSVC_CreateHeader_Tradition] '1/1/11'
==============================================================================
*/
CREATE PROCEDURE [dbo].[spSVC_Tradition_Step1_CreateHeader] (@Month DATETIME)
AS
BEGIN
	SET NOCOUNT ON
	...
	WHERE DD.FullDate BETWEEN @StartDate AND @EndDate
		AND (FST.NB_TradCnt > 0
			OR SC.SalesCodeDepartmentSSID IN (1015))
		AND CASE WHEN CONVERT(INT, RIGHT(CM1.ClientMembershipIdentifier, 2)) > CONVERT(INT, RIGHT(CM2.ClientMembershipIdentifier, 2)) THEN M1.MembershipKey ELSE M2.MembershipKey END = 63
