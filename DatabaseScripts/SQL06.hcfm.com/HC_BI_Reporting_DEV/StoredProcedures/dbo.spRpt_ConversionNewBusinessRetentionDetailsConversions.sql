/* CreateDate: 03/22/2017 15:18:51.560 , ModifyDate: 04/26/2019 17:49:41.110 */
GO
SET ANSI_NULLS ON
GO
...
--DROP TABLE testSum
--SELECT * FROM testDetail WHERE clientkey NOT IN (SELECT clientkey FROM testSum)
--select * from testSum


--SELECT * FROM testDetail
--WHERE clientkey NOT IN (SELECT clientkey FROM testSum)
--select * from testSum
GO
