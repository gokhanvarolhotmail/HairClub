/* CreateDate: 05/05/2015 16:15:23.413 , ModifyDate: 10/10/2018 14:21:16.763 */
GO
/*
==============================================================================
...
==============================================================================
SAMPLE EXECUTION:
EXEC spRpt_WarBoardManager 5, 2018, 0
EXEC spRpt_WarBoardManager 3, 2018, 1
==============================================================================
*/
CREATE PROCEDURE [dbo].[xxxspRpt_WarBoardManager] (
	@Month INT
,	@Year INT
...
,	dbo.DIVIDE_DECIMAL(ISNULL(RS.RetailSales, 0), ISNULL(A.Retail_Budget, 0)) AS 'RetailToBudgetPercent'
INTO #Final
FROM #Centers C
