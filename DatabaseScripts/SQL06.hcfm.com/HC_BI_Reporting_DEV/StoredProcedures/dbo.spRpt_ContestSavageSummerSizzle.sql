...
EXEC [dbo].[spRpt_ContestSavageSummerSizzle]

***********************************************************************/
CREATE PROCEDURE [dbo].[spRpt_ContestSavageSummerSizzle]
...
SET @ContestSSID = (SELECT C.ContestSSID FROM Contest C WHERE C.ContestName = 'SavageSummerSizzle')
