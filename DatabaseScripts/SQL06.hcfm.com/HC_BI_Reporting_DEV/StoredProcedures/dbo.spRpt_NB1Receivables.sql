...
-------------------------------------------------------------------------------------------------------
SAMPLE EXECUTION:
EXEC [spRpt_NB1Receivables] '1/1/2018', '1/31/2018', 'C', 1, 50

EXEC [spRpt_NB1Receivables] '1/1/2018', '1/31/2018', 'C', 2, 50
...
SELECT *
FROM #Display
WHERE ClientKey NOT IN(SELECT ClientKey FROM #Guarantees)
