/* CreateDate: 07/07/2014 10:56:55.930 , ModifyDate: 11/14/2014 09:46:39.460 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
PROCEDURE:				spSvc_AmplifierDataExport_ShowSales
...
EXEC spSvc_AmplifierDataExport_ShowSales
***********************************************************************/
CREATE PROCEDURE [dbo].[spSvc_AmplifierDataExport_ShowSales]
AS
BEGIN
...
,       DAR.ContractAmount AS 'ServiceRevenue'
,       DS.SourceName AS 'LeadSource'
,       '' AS 'uservarchar1'
,       '' AS 'uservarchar2'
,       DAG.EthnicityDescription AS 'uservarchar3'
,       '' AS 'uservarchar4'
,       '' AS 'userdate1'
,       CONVERT(VARCHAR(11), DD_ActivityDueDate.FullDate, 101) AS 'userdate2'
,       '' AS 'userdate3'
,       '' AS 'userdate4'
,       '' AS 'userreal1'
,       '' AS 'userreal2'
