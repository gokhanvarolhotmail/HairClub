...
EXEC [spRpt_ContestNewBusinessSales]

***********************************************************************/
CREATE PROCEDURE [dbo].[spRpt_ContestNewBusinessSales]
...
SET @ContestSSID = (SELECT C.ContestSSID FROM Contest C WHERE C.ContestName = 'NewBusinessSales')
--SET @StartDate = '7/1/2017'
--SET @EndDate = '9/1/2017'
...
INSERT  INTO #Sales
    ...
    --            + SUM(ISNULL(FST.S_PostExtAmt, 0))
				+ SUM(ISNULL(FST.NB_XTRAmt, 0)) AS 'NetNB1Sales'--Remind Rev that without Surgery and Post EXT it will not match the Flash
