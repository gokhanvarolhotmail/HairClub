/* CreateDate: 02/27/2020 07:44:10.427 , ModifyDate: 02/27/2020 07:44:10.427 */
GO
SET ANSI_NULLS ON
GO
...
EXEC spSVC_Gradual_Step3_UpdateDeferredAmountsByClient '8/2/2018'
***********************************************************************/
CREATE PROCEDURE [dbo].[spSVC_Gradual_Step3_UpdateDeferredAmountsByClient]
(
	@Month DATETIME
)
AS
