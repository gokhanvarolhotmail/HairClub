/* CreateDate: 09/03/2021 09:37:07.650 , ModifyDate: 09/03/2021 09:37:07.650 */
GO
create procedure [sp_MSdel_bi_mktg_ddsFactActivityResultsMonthly]
		@pkc1 int,
		@pkc2 int,
		@pkc3 int
as
begin
	...
	delete [bi_mktg_dds].[FactActivityResultsMonthly]
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[bi_mktg_dds].[FactActivityResultsMonthly]', @param2=@primarykey_text, @param3=13234
			End
			Else
