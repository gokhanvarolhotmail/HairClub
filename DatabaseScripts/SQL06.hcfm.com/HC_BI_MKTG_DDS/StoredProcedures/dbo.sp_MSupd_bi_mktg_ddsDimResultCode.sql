/* CreateDate: 09/03/2021 09:37:06.197 , ModifyDate: 09/03/2021 09:37:06.197 */
GO
create procedure [sp_MSupd_bi_mktg_ddsDimResultCode]
		@c1 int = NULL,
		@c2 nvarchar(10) = NULL,
		@c3 nvarchar(50) = NULL,
		@c4 nvarchar(10) = NULL,
...
update [bi_mktg_dds].[DimResultCode] set
		[ResultCodeSSID] = case substring(@bitmap,1,1) & 2 when 2 then @c2 else [ResultCodeSSID] end,
		[ResultCodeDescription] = case substring(@bitmap,1,1) & 4 when 4 then @c3 else [ResultCodeDescription] end,
		[ResultCodeDescriptionShort] = case substring(@bitmap,1,1) & 8 when 8 then @c4 else [ResultCodeDescriptionShort] end,
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[bi_mktg_dds].[DimResultCode]', @param2=@primarykey_text, @param3=13233
			End
			Else
