/* CreateDate: 09/03/2021 09:37:06.767 , ModifyDate: 09/03/2021 09:37:06.767 */
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [sp_MSdel_bi_mktg_ddsFactActivity]
		@pkc1 int,
		@pkc2 int,
		@pkc3 int
as
begin
	...
	delete [bi_mktg_dds].[FactActivity]
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[bi_mktg_dds].[FactActivity]', @param2=@primarykey_text, @param3=13234
			End
			Else
