/* CreateDate: 09/03/2021 09:37:05.097 , ModifyDate: 09/03/2021 09:37:05.097 */
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [sp_MSupd_bi_mktg_ddsDimActionCode]
		@c1 int = NULL,
		@c2 nvarchar(10) = NULL,
		@c3 nvarchar(50) = NULL,
		@c4 nvarchar(10) = NULL,
...
update [bi_mktg_dds].[DimActionCode] set
		[ActionCodeSSID] = case substring(@bitmap,1,1) & 2 when 2 then @c2 else [ActionCodeSSID] end,
		[ActionCodeDescription] = case substring(@bitmap,1,1) & 4 when 4 then @c3 else [ActionCodeDescription] end,
		[ActionCodeDescriptionShort] = case substring(@bitmap,1,1) & 8 when 8 then @c4 else [ActionCodeDescriptionShort] end,
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[bi_mktg_dds].[DimActionCode]', @param2=@primarykey_text, @param3=13233
			End
			Else
