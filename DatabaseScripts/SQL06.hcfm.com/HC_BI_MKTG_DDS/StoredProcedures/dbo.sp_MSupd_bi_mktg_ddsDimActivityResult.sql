/* CreateDate: 09/03/2021 09:37:05.347 , ModifyDate: 09/03/2021 09:37:05.347 */
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [sp_MSupd_bi_mktg_ddsDimActivityResult]
		@c1 int = NULL,
		@c2 varchar(10) = NULL,
		@c3 nvarchar(10) = NULL,
		@c4 varchar(10) = NULL,
...
update [bi_mktg_dds].[DimActivityResult] set
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[bi_mktg_dds].[DimActivityResult]', @param2=@primarykey_text, @param3=13233
			End
			Else
