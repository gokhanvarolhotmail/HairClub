/* CreateDate: 09/03/2021 09:37:06.850 , ModifyDate: 09/03/2021 09:37:06.850 */
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [sp_MSupd_bi_mktg_ddsFactActivityResults]
		@c1 int = NULL,
		@c2 int = NULL,
		@c3 int = NULL,
		@c4 int = NULL,
...
begin
update [bi_mktg_dds].[FactActivityResults] set
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[bi_mktg_dds].[FactActivityResults]', @param2=@primarykey_text, @param3=13233
			End
			Else
