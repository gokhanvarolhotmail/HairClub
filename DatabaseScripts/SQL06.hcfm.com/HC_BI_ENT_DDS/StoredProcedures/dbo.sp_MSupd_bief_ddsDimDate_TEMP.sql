/* CreateDate: 01/08/2021 15:21:53.660 , ModifyDate: 01/08/2021 15:21:53.660 */
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [sp_MSupd_bief_ddsDimDate_TEMP]
		@c1 int = NULL,
		@c2 datetime = NULL,
		@c3 char(12) = NULL,
		@c4 smallint = NULL,
...
begin
update [bief_dds].[DimDate_TEMP] set
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[bief_dds].[DimDate_TEMP]', @param2=@primarykey_text, @param3=13233
			End
			Else
