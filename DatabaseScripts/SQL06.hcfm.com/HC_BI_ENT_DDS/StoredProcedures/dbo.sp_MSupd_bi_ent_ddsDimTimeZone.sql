/* CreateDate: 01/08/2021 15:21:54.120 , ModifyDate: 01/08/2021 15:21:54.120 */
GO
create procedure [sp_MSupd_bi_ent_ddsDimTimeZone]
		@c1 int = NULL,
		@c2 int = NULL,
		@c3 nvarchar(50) = NULL,
		@c4 nvarchar(10) = NULL,
...
update [bi_ent_dds].[DimTimeZone] set
		[TimeZoneSSID] = case substring(@bitmap,1,1) & 2 when 2 then @c2 else [TimeZoneSSID] end,
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				set @primarykey_text = @primarykey_text + '[TimeZoneKey] = ' + convert(nvarchar(100),@pkc1,1)
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[bi_ent_dds].[DimTimeZone]', @param2=@primarykey_text, @param3=13233
			End
			Else
