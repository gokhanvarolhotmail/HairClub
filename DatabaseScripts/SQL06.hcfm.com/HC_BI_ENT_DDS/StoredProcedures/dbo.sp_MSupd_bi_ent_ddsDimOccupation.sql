/* CreateDate: 01/08/2021 15:21:53.980 , ModifyDate: 01/08/2021 15:21:53.980 */
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [sp_MSupd_bi_ent_ddsDimOccupation]
		@c1 int = NULL,
		@c2 int = NULL,
		@c3 nvarchar(50) = NULL,
		@c4 nvarchar(10) = NULL,
...
update [bi_ent_dds].[DimOccupation] set
		[OccupationSSID] = case substring(@bitmap,1,1) & 2 when 2 then @c2 else [OccupationSSID] end,
		[OccupationDescription] = case substring(@bitmap,1,1) & 4 when 4 then @c3 else [OccupationDescription] end,
		[OccupationDescriptionShort] = case substring(@bitmap,1,1) & 8 when 8 then @c4 else [OccupationDescriptionShort] end,
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				set @primarykey_text = @primarykey_text + '[OccupationKey] = ' + convert(nvarchar(100),@pkc1,1)
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[bi_ent_dds].[DimOccupation]', @param2=@primarykey_text, @param3=13233
			End
			Else
