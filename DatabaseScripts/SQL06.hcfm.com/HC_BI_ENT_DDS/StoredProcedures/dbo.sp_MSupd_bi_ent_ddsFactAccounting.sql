/* CreateDate: 01/08/2021 15:21:54.160 , ModifyDate: 01/08/2021 15:21:54.160 */
GO
SET ANSI_NULLS ON
GO
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[bi_ent_dds].[FactAccounting]', @param2=@primarykey_text, @param3=13233
			End
			Else
