/* CreateDate: 01/08/2021 15:21:53.733 , ModifyDate: 01/08/2021 15:21:53.733 */
GO
create procedure [sp_MSupd_bi_ent_ddsDimEthnicity]
		@c1 int = NULL,
		@c2 int = NULL,
		@c3 nvarchar(50) = NULL,
		@c4 nvarchar(10) = NULL,
...
update [bi_ent_dds].[DimEthnicity] set
		[EthnicitySSID] = case substring(@bitmap,1,1) & 2 when 2 then @c2 else [EthnicitySSID] end,
		[EthnicityDescription] = case substring(@bitmap,1,1) & 4 when 4 then @c3 else [EthnicityDescription] end,
		[EthnicityDescriptionShort] = case substring(@bitmap,1,1) & 8 when 8 then @c4 else [EthnicityDescriptionShort] end,
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[bi_ent_dds].[DimEthnicity]', @param2=@primarykey_text, @param3=13233
			End
			Else
