/* CreateDate: 01/08/2021 15:21:53.770 , ModifyDate: 01/08/2021 15:21:53.770 */
GO
create procedure [sp_MSupd_bi_ent_ddsDimGender]
		@c1 int = NULL,
		@c2 nvarchar(10) = NULL,
		@c3 nvarchar(50) = NULL,
		@c4 nvarchar(10) = NULL,
...
update [bi_ent_dds].[DimGender] set
		[GenderSSID] = case substring(@bitmap,1,1) & 2 when 2 then @c2 else [GenderSSID] end,
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				set @primarykey_text = @primarykey_text + '[GenderKey] = ' + convert(nvarchar(100),@pkc1,1)
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[bi_ent_dds].[DimGender]', @param2=@primarykey_text, @param3=13233
			End
			Else
