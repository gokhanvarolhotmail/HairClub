/* CreateDate: 01/08/2021 15:21:53.603 , ModifyDate: 01/08/2021 15:21:53.603 */
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create procedure [sp_MSupd_bi_ent_ddsDimCenterType]
		@c1 int = NULL,
		@c2 int = NULL,
		@c3 nvarchar(50) = NULL,
		@c4 nvarchar(10) = NULL,
...
update [bi_ent_dds].[DimCenterType] set
		[CenterTypeSSID] = case substring(@bitmap,1,1) & 2 when 2 then @c2 else [CenterTypeSSID] end,
    ...
    if @@microsoftversion>0x07320000
		Begin
			...
			Begin
				...
				exec sp_MSreplraiserror @errorid=20598, @param1=N'[bi_ent_dds].[DimCenterType]', @param2=@primarykey_text, @param3=13233
			End
			Else
