/* CreateDate: 05/03/2016 09:55:41.453 , ModifyDate: 05/03/2016 11:33:25.603 */
GO
/***********************************************************************
VIEW:					[vwd_AdvertisingLatency_ShowsPercent]
...
SELECT * FROM [vwd_AdvertisingLatency_ShowsPercent] order by YearMonthNumber

***********************************************************************/
CREATE VIEW [dbo].[vwd_AdvertisingLatency_ShowsPercent]
AS
