/* CreateDate: 05/02/2016 15:54:12.220 , ModifyDate: 05/03/2016 09:44:08.637 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
VIEW:					[vwd_AdvertisingLatency_Percent]
...
SELECT * FROM [vwd_AdvertisingLatency_Percent] order by YearMonthNumber

***********************************************************************/
CREATE VIEW [dbo].[vwd_AdvertisingLatency_Percent]
AS
