/* CreateDate: 05/02/2016 15:52:09.680 , ModifyDate: 05/02/2016 15:52:09.680 */
GO
SET ANSI_NULLS ON
GO
...
GO
/***********************************************************************
VIEW:					[vwd_AdvertisingLatency_Totals]
...
SELECT * FROM [vwd_AdvertisingLatency_Totals] order by YearMonthNumber

***********************************************************************/
CREATE VIEW [dbo].[vwd_AdvertisingLatency_Totals]
AS
