/* CreateDate: 05/03/2016 11:45:29.360 , ModifyDate: 05/03/2016 11:45:29.360 */
GO
/***********************************************************************
VIEW:					[vwd_AdvertisingLatency_SaleShowDiffPercent]
...
SELECT * FROM [vwd_AdvertisingLatency_SaleShowDiffPercent] order by YearMonthNumber

***********************************************************************/
CREATE VIEW [dbo].[vwd_AdvertisingLatency_SaleShowDiffPercent]
AS
...
--,	CAST(HalfMonthShowPercent AS DECIMAL(18,4)) AS 'Half Mo'
...
--,	CAST(MoreThanOneYearShowPercent AS DECIMAL(18,4)) AS 'Year+'

--,	CAST(HalfMonthSalePercent AS DECIMAL(18,4)) AS 'HalfMonthSalePercent'
--,	CAST(OneMonthSalePercent AS DECIMAL(18,4)) AS 'OneMonthSalePercent'
--,	CAST(TwoMonthsSalePercent AS DECIMAL(18,4)) AS 'TwoMonthsSalePercent'
--,	CAST(ThreeMonthsSalePercent AS DECIMAL(18,4)) AS 'ThreeMonthsSalePercent'
--,	CAST(FourMonthsSalePercent AS DECIMAL(18,4)) AS 'FourMonthsSalePercent'
--,	CAST(SevenMonthsSalePercent AS DECIMAL(18,4)) AS 'SevenMonthsSalePercent'
--,	CAST(MoreThanOneYearSalePercent AS DECIMAL(18,4)) AS 'MoreThanOneYearSalePercent'

,	CAST(HalfMonthSaleShowDiffPercent AS DECIMAL(18,4)) AS 'Half Mo'
,	CAST(OneMonthSaleShowDiffPercent AS DECIMAL(18,4)) AS '1 Mo'
,	CAST(TwoMonthsSaleShowDiffPercent AS DECIMAL(18,4)) AS '2 Mos'
,	CAST(ThreeMonthsSaleShowDiffPercent AS DECIMAL(18,4)) AS '3 Mos'
,	CAST(FourMonthsSaleShowDiffPercent AS DECIMAL(18,4)) AS '4-6 Mos'
,	CAST(SevenMonthsSaleShowDiffPercent AS DECIMAL(18,4)) AS '7-12 Mos'
,	CAST(MoreThanOneYearSaleShowDiffPercent  AS DECIMAL(18,4)) AS 'Year+'
FROM  [Percentage]
GO
