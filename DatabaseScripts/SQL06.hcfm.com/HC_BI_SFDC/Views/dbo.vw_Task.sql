/* CreateDate: 10/15/2019 08:10:35.637 , ModifyDate: 02/11/2021 17:05:12.893 */
GO
/*
NOTES
...
,	    CASE WHEN Result__c IN ('Show Sale') THEN 1
		...
		ctrtype.CenterTypeDescription AS 'CenterType__c',
		ISNULL(ISNULL(src.OwnerType,C.[type]),'Unknown') AS 'OwnerType'
